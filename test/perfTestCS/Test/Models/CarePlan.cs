  ...
  public class CarePlanActivityDetail : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (DailyAmount != null)
      {
        ...
        DailyAmount.SerializeJson(ref writer, options);
      }
      ...
      if (ProductCodeableConcept != null)
      {
        ...
        ProductCodeableConcept.SerializeJson(ref writer, options);
      }

      if (ProductReference != null)
      {
        writer.WritePropertyName("productReference");
        ProductReference.SerializeJson(ref writer, options);
      }
      ...
      if (ScheduledTiming != null)
      {
        ...
        ScheduledTiming.SerializeJson(ref writer, options);
      }

      if (ScheduledPeriod != null)
      {
        writer.WritePropertyName("scheduledPeriod");
        ScheduledPeriod.SerializeJson(ref writer, options);
      }

      writer.WriteString("scheduledString", ScheduledString);

      if (_ScheduledString != null)
      {
        writer.WritePropertyName("_scheduledString");
        _ScheduledString.SerializeJson(ref writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "dailyAmount":
          DailyAmount = new Fhir.R4.Models.Quantity();
        ...
        case "goal":
          ...
          {
            Fhir.R4.Models.Reference objGoal = new Fhir.R4.Models.Reference();
        ...
        case "scheduledTiming":
          ScheduledTiming = new Fhir.R4.Models.Timing();
          ScheduledTiming.DeserializeJson(ref reader, options);
          break;

        case "scheduledPeriod":
          ScheduledPeriod = new Fhir.R4.Models.Period();
        ...
        case "_scheduledString":
          _ScheduledString = new Fhir.R4.Models.Element();
  ...
  public class CarePlanActivity : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((OutcomeCodeableConcept != null) && (OutcomeCodeableConcept.Count != 0))
      {
        ...
        {
          valOutcomeCodeableConcept.SerializeJson(ref writer, options, true);
        }
      ...
      if ((Progress != null) && (Progress.Count != 0))
      {
        ...
        {
          valProgress.SerializeJson(ref writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "detail":
          Detail = new Fhir.R4.Models.CarePlanActivityDetail();
        ...
        case "outcomeCodeableConcept":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.CodeableConcept objOutcomeCodeableConcept = new Fhir.R4.Models.CodeableConcept();
        ...
        case "progress":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.Annotation objProgress = new Fhir.R4.Models.Annotation();
  ...
  public class CarePlan : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((Activity != null) && (Activity.Count != 0))
      {
        ...
        {
          valActivity.SerializeJson(ref writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "activity":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.CarePlanActivity objActivity = new Fhir.R4.Models.CarePlanActivity();
        ...
        case "careTeam":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.Reference objCareTeam = new Fhir.R4.Models.Reference();
