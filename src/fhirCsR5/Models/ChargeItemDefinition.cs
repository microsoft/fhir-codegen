...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ChargeItemDefinitionPropertyGroupPriceComponent>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "priceComponent":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.ChargeItemDefinitionPropertyGroupPriceComponent objPriceComponent = new fhirCsR5.Models.ChargeItemDefinitionPropertyGroupPriceComponent();
