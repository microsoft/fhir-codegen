...
public partial class FhirCoreComparer
{
    ...
    public void Compare(Common.Models.FhirArtifactClassEnum? artifactFilter = null)
    {
        ...
        {
            case Common.Models.FhirArtifactClassEnum.ValueSet:
                compareAllValueSets();
                break;

            // types are grouped together in maps, so always update both
            case Common.Models.FhirArtifactClassEnum.PrimitiveType:
            case Common.Models.FhirArtifactClassEnum.ComplexType:
                compareAllPrimitiveTypes();
                compareAllComplexTypes();
                break;

            // resources need all 'lower' types updated
            case Common.Models.FhirArtifactClassEnum.Resource:
            default:
                compareAllValueSets();
                compareAllPrimitiveTypes();
                compareAllComplexTypes();
                checkOverviewMaps(Common.Models.FhirArtifactClassEnum.Resource);
                break;
        }
    }
    ...
    public void Save(Common.Models.FhirArtifactClassEnum? artifactFilter = null)
    {
        if ((artifactFilter == null) ||
            (artifactFilter == Common.Models.FhirArtifactClassEnum.ValueSet) ||
            (artifactFilter == Common.Models.FhirArtifactClassEnum.Resource))
        {
            saveValueSetMaps();
        }

        if ((artifactFilter == null) ||
            (artifactFilter == Common.Models.FhirArtifactClassEnum.PrimitiveType) ||
            (artifactFilter == Common.Models.FhirArtifactClassEnum.ComplexType))
        {
            saveTypeMaps();
        }
    }
