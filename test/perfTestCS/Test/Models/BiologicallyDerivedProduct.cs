...
namespace Fhir.R4.Models
{
  ...
  public class BiologicallyDerivedProduct : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "collection":
          Collection = new Fhir.R4.Models.BiologicallyDerivedProductCollection();
        ...
        case "manipulation":
          Manipulation = new Fhir.R4.Models.BiologicallyDerivedProductManipulation();
        ...
        case "processing":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.BiologicallyDerivedProductProcessing objProcessing = new Fhir.R4.Models.BiologicallyDerivedProductProcessing();
        ...
        case "_productCategory":
          _ProductCategory = new Fhir.R4.Models.Element();
          _ProductCategory.DeserializeJson(ref reader, options);
          break;

        case "productCode":
          ProductCode = new Fhir.R4.Models.CodeableConcept();
        ...
        case "storage":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.BiologicallyDerivedProductStorage objStorage = new Fhir.R4.Models.BiologicallyDerivedProductStorage();
