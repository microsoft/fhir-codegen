...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ConceptMapGroupElementTargetDependsOn>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ConceptMapGroupElementTarget>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "dependsOn":
          ...
          {
            fhirCsR5.Models.ConceptMapGroupElementTargetDependsOn objDependsOn = new fhirCsR5.Models.ConceptMapGroupElementTargetDependsOn();
        ...
        case "product":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.ConceptMapGroupElementTargetDependsOn objProduct = new fhirCsR5.Models.ConceptMapGroupElementTargetDependsOn();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ConceptMapGroupElement>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "target":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.ConceptMapGroupElementTarget objTarget = new fhirCsR5.Models.ConceptMapGroupElementTarget();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ConceptMapGroupUnmapped>))]
  public class ConceptMapGroupUnmapped : BackboneElement,  IFhirJsonSerializable {
    ...
    /// </summary>
    public string OtherMap { get; set; }
    /// <summary>
    /// Extension container element for OtherMap
    /// </summary>
    public Element _OtherMap { get; set; }
    /// <summary>
    /// This element is labeled as a modifier because it may indicate that there is no mapping.
    /// </summary>
    public string Relationship { get; set; }
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (!string.IsNullOrEmpty(OtherMap))
      {
        writer.WriteString("otherMap", (string)OtherMap!);
      }

      if (_OtherMap != null)
      {
        writer.WritePropertyName("_otherMap");
        _OtherMap.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "otherMap":
          OtherMap = reader.GetString();
          break;

        case "_otherMap":
          _OtherMap = new fhirCsR5.Models.Element();
          _OtherMap.DeserializeJson(ref reader, options);
          break;
  ...
  public static class ConceptMapGroupUnmappedModeCodes {
    public const string USE_SOURCE_CODE = "use-source-code";
  ...
  /// <summary>
  /// Code Values for the ConceptMap.group.unmapped.relationship field
  /// </summary>
  public static class ConceptMapGroupUnmappedRelationshipCodes {
    public const string RELATED_TO = "related-to";
    public const string EQUIVALENT = "equivalent";
    public const string SOURCE_IS_NARROWER_THAN_TARGET = "source-is-narrower-than-target";
    public const string SOURCE_IS_BROADER_THAN_TARGET = "source-is-broader-than-target";
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ConceptMapGroup>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "element":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.ConceptMapGroupElement objElement = new fhirCsR5.Models.ConceptMapGroupElement();
        ...
        case "unmapped":
          Unmapped = new fhirCsR5.Models.ConceptMapGroupUnmapped();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ConceptMap>))]
  public class ConceptMap : DomainResource,  IFhirJsonSerializable {
    ...
    /// </summary>
    public string SourceScopeUri { get; set; }
    /// <summary>
    /// Extension container element for SourceScopeUri
    /// </summary>
    public Element _SourceScopeUri { get; set; }
    /// <summary>
    /// Should be a version specific reference. URIs SHOULD be absolute. If there is no sourceScope or targetScope value set, there is no specified context for the map (not recommended).  The sourceScope value set may select codes from either an explicit (standard or local) or implicit code system.
    /// </summary>
    public string SourceScopeCanonical { get; set; }
    /// <summary>
    /// Extension container element for SourceScopeCanonical
    /// </summary>
    public Element _SourceScopeCanonical { get; set; }
    /// <summary>
    /// Allows filtering of concept maps that are appropriate for use versus not.
    /// </summary>
    ...
    /// </summary>
    public string TargetScopeUri { get; set; }
    /// <summary>
    /// Extension container element for TargetScopeUri
    /// </summary>
    public Element _TargetScopeUri { get; set; }
    /// <summary>
    /// Should be a version specific reference. URIs SHOULD be absolute. If there is no sourceScope or targetScope value set, there is no specified context for the map (not recommended).  The targetScope value set may select codes from either an explicit (standard or local) or implicit code system.
    /// </summary>
    public string TargetScopeCanonical { get; set; }
    /// <summary>
    /// Extension container element for TargetScopeCanonical
    /// </summary>
    public Element _TargetScopeCanonical { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (!string.IsNullOrEmpty(SourceScopeUri))
      {
        writer.WriteString("sourceScopeUri", (string)SourceScopeUri!);
      }

      if (_SourceScopeUri != null)
      {
        writer.WritePropertyName("_sourceScopeUri");
        _SourceScopeUri.SerializeJson(writer, options);
      }

      if (!string.IsNullOrEmpty(SourceScopeCanonical))
      {
        writer.WriteString("sourceScopeCanonical", (string)SourceScopeCanonical!);
      }

      if (_SourceScopeCanonical != null)
      {
        writer.WritePropertyName("_sourceScopeCanonical");
        _SourceScopeCanonical.SerializeJson(writer, options);
      }

      if (!string.IsNullOrEmpty(TargetScopeUri))
      {
        writer.WriteString("targetScopeUri", (string)TargetScopeUri!);
      }

      if (_TargetScopeUri != null)
      {
        writer.WritePropertyName("_targetScopeUri");
        _TargetScopeUri.SerializeJson(writer, options);
      }

      if (!string.IsNullOrEmpty(TargetScopeCanonical))
      {
        writer.WriteString("targetScopeCanonical", (string)TargetScopeCanonical!);
      }

      if (_TargetScopeCanonical != null)
      {
        writer.WritePropertyName("_targetScopeCanonical");
        _TargetScopeCanonical.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "group":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.ConceptMapGroup objGroup = new fhirCsR5.Models.ConceptMapGroup();
        ...
        case "sourceScopeUri":
          SourceScopeUri = reader.GetString();
          break;

        case "_sourceScopeUri":
          _SourceScopeUri = new fhirCsR5.Models.Element();
          _SourceScopeUri.DeserializeJson(ref reader, options);
          break;

        case "sourceScopeCanonical":
          SourceScopeCanonical = reader.GetString();
          break;

        case "_sourceScopeCanonical":
          _SourceScopeCanonical = new fhirCsR5.Models.Element();
          _SourceScopeCanonical.DeserializeJson(ref reader, options);
          break;
        ...
        case "targetScopeUri":
          TargetScopeUri = reader.GetString();
          break;

        case "_targetScopeUri":
          _TargetScopeUri = new fhirCsR5.Models.Element();
          _TargetScopeUri.DeserializeJson(ref reader, options);
          break;

        case "targetScopeCanonical":
          TargetScopeCanonical = reader.GetString();
          break;

        case "_targetScopeCanonical":
          _TargetScopeCanonical = new fhirCsR5.Models.Element();
          _TargetScopeCanonical.DeserializeJson(ref reader, options);
          break;
