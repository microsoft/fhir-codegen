...
namespace fhirCsR3.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<SpecimenCollection>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_collectedDateTime":
          _CollectedDateTime = new fhirCsR3.Models.Element();
          _CollectedDateTime.DeserializeJson(ref reader, options);
          break;

        case "collectedPeriod":
          CollectedPeriod = new fhirCsR3.Models.Period();
          CollectedPeriod.DeserializeJson(ref reader, options);
          break;

        case "collector":
          Collector = new fhirCsR3.Models.Reference();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<SpecimenProcessing>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "additive":
          ...
          {
            fhirCsR3.Models.Reference objAdditive = new fhirCsR3.Models.Reference();
        ...
        case "procedure":
          Procedure = new fhirCsR3.Models.CodeableConcept();
        ...
        case "_timeDateTime":
          _TimeDateTime = new fhirCsR3.Models.Element();
          _TimeDateTime.DeserializeJson(ref reader, options);
          break;

        case "timePeriod":
          TimePeriod = new fhirCsR3.Models.Period();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<SpecimenContainer>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "additiveCodeableConcept":
          AdditiveCodeableConcept = new fhirCsR3.Models.CodeableConcept();
          AdditiveCodeableConcept.DeserializeJson(ref reader, options);
          break;

        case "additiveReference":
          AdditiveReference = new fhirCsR3.Models.Reference();
          AdditiveReference.DeserializeJson(ref reader, options);
          break;

        case "capacity":
          Capacity = new fhirCsR3.Models.Quantity();
        ...
        case "specimenQuantity":
          SpecimenQuantity = new fhirCsR3.Models.Quantity();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<Specimen>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "accessionIdentifier":
          AccessionIdentifier = new fhirCsR3.Models.Identifier();
          AccessionIdentifier.DeserializeJson(ref reader, options);
          break;

        case "collection":
          Collection = new fhirCsR3.Models.SpecimenCollection();
        ...
        case "container":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.SpecimenContainer objContainer = new fhirCsR3.Models.SpecimenContainer();
        ...
        case "processing":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.SpecimenProcessing objProcessing = new fhirCsR3.Models.SpecimenProcessing();
        ...
        case "_receivedTime":
          _ReceivedTime = new fhirCsR3.Models.Element();
        ...
        case "request":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.Reference objRequest = new fhirCsR3.Models.Reference();
