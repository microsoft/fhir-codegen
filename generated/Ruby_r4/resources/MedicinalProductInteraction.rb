module FHIR
  ...
  class MedicinalProductInteraction < FHIR::Model
    ...
    METADATA = {
      ...
      'subject' => {
        'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/MedicinalProduct', 'http://hl7.org/fhir/StructureDefinition/Medication', 'http://hl7.org/fhir/StructureDefinition/Substance'],
        'type'=>'Reference',
      ...
      'interactant' => {
        'type'=>'MedicinalProductInteraction::Interactant',
    ...
    class Interactant < FHIR::Model
      ...
      METADATA = {
        ...
        'modifierExtension' => {
          'type'=>'Extension',
          'path'=>'Interactant.modifierExtension',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
        ...
        # The specific medication, food or laboratory test that interacts.
        'itemReference' => {
          'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/MedicinalProduct', 'http://hl7.org/fhir/StructureDefinition/Medication', 'http://hl7.org/fhir/StructureDefinition/Substance', 'http://hl7.org/fhir/StructureDefinition/ObservationDefinition'],
          'type'=>'Reference',
          'path'=>'Interactant.item[x]',
          'min'=>1,
          'max'=>1
      ...
      ##
      # The specific medication, food or laboratory test that interacts.
      attr_accessor :itemReference                  # 1-1 Reference(http://hl7.org/fhir/StructureDefinition/MedicinalProduct|http://hl7.org/fhir/StructureDefinition/Medication|http://hl7.org/fhir/StructureDefinition/Substance|http://hl7.org/fhir/StructureDefinition/ObservationDefinition)
    end
    ##
    # Logical id of this artifact
    # The logical id of the resource, as used in the URL for the resource. Once assigned, this value never changes.
    ...
    ##
    # The medication for which this is a described interaction.
    attr_accessor :subject                        # 0-* [ Reference(http://hl7.org/fhir/StructureDefinition/MedicinalProduct|http://hl7.org/fhir/StructureDefinition/Medication|http://hl7.org/fhir/StructureDefinition/Substance) ]
    ##
    # The interaction described.
