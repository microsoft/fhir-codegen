...
namespace fhirCsR5.Models
{
  ...
  public class MessageHeader : DomainResource,  IFhirJsonSerializable {
    ...
    /// The time of the event will be found in the focus resource. The time of the message will be found in [Bundle.timestamp](bundle-definitions.html#Bundle.timestamp).
    /// </summary>
    public string EventCanonical { get; set; }
    /// <summary>
    /// Extension container element for EventCanonical
    /// </summary>
    public Element _EventCanonical { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (!string.IsNullOrEmpty(EventCanonical))
      {
        writer.WriteString("eventCanonical", (string)EventCanonical!);
      }

      if (_EventCanonical != null)
      {
        writer.WritePropertyName("_eventCanonical");
        _EventCanonical.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "eventCanonical":
          EventCanonical = reader.GetString();
          break;

        case "_eventCanonical":
          _EventCanonical = new fhirCsR5.Models.Element();
          _EventCanonical.DeserializeJson(ref reader, options);
          break;
