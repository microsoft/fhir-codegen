module FHIR
  ...
  class SubstanceNucleicAcid < FHIR::Model
    ...
    METADATA = {
      ...
      'subunit' => {
        'type'=>'SubstanceNucleicAcid::Subunit',
    ...
    class Subunit < FHIR::Model
      ...
      METADATA = {
        ...
        'modifierExtension' => {
          'type'=>'Extension',
          'path'=>'Subunit.modifierExtension',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
        ...
        'sequenceAttachment' => {
          'type'=>'Attachment',
          'path'=>'Subunit.sequenceAttachment',
          'min'=>0,
          'max'=>1
        },
        ##
        ...
        'linkage' => {
          'type'=>'SubstanceNucleicAcid::Subunit::Linkage',
          'path'=>'Subunit.linkage',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
        ...
        'sugar' => {
          'type'=>'SubstanceNucleicAcid::Subunit::Sugar',
          'path'=>'Subunit.sugar',
          'min'=>0,
          'max'=>Float::INFINITY
        }
