module FHIR
  ...
  class TerminologyCapabilities < FHIR::Model
    ...
    SEARCH_PARAMS = ['context-quantity', 'context-type-quantity', 'context-type-value', 'context-type', 'context', 'date', 'description', 'jurisdiction', 'name', 'publisher', 'status', 'title', 'url', 'version']
    METADATA = {
      ##
      ...
      'software' => {
        'type'=>'TerminologyCapabilities::Software',
      ...
      'implementation' => {
        'type'=>'TerminologyCapabilities::Implementation',
      ...
      'codeSearch' => {
        'valid_codes'=>{
          'http://hl7.org/fhir/code-search-support'=>[ 'explicit', 'all' ]
        },
        'type'=>'code',
        'path'=>'TerminologyCapabilities.codeSearch',
        'min'=>0,
        'max'=>1,
        'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/code-search-support'}
      },
      ##
    ...
    class CodeSystem < FHIR::Model
      ...
      METADATA = {
        ...
        'version' => {
          'type'=>'TerminologyCapabilities::CodeSystem::Version',
      ...
      class Version < FHIR::Model
        ...
        METADATA = {
          ...
          'filter' => {
            'type'=>'TerminologyCapabilities::CodeSystem::Version::Filter',
            'path'=>'Version.filter',
            'min'=>0,
            'max'=>Float::INFINITY
          },
      ...
      ##
      # URI for the Code System.
      attr_accessor :uri                            # 0-1 canonical(http://hl7.org/fhir/StructureDefinition/CodeSystem)
      ##
      # Version of Code System supported
      # For the code system, a list of versions that are supported by the server.
      # Language translations might not be available for all codes.
    ...
    class Expansion < FHIR::Model
      ...
      METADATA = {
        ...
        'parameter' => {
          'type'=>'TerminologyCapabilities::Expansion::Parameter',
    ...
    class ValidateCode < FHIR::Model
      ...
      METADATA = {
        ...
        'modifierExtension' => {
          'type'=>'Extension',
          'path'=>'ValidateCode.modifierExtension',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
        ...
        'translations' => {
          'type'=>'boolean',
          'path'=>'ValidateCode.translations',
          'min'=>1,
          'max'=>1
        }
      }
    ...
    class Translation < FHIR::Model
      ...
      METADATA = {
        ...
        'modifierExtension' => {
          'type'=>'Extension',
          'path'=>'Translation.modifierExtension',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
    ...
    class Closure < FHIR::Model
      ...
      METADATA = {
        ...
        'modifierExtension' => {
          'type'=>'Extension',
          'path'=>'Closure.modifierExtension',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
