...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<MedicationKnowledgeIngredient>))]
  public class MedicationKnowledgeIngredient : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
    /// Indication of whether this ingredient affects the therapeutic action of the drug.
    /// </summary>
    public CodeableConcept IsActive { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (IsActive != null)
      {
        ...
        IsActive.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "isActive":
          IsActive = new fhirCsR5.Models.CodeableConcept();
          IsActive.DeserializeJson(ref reader, options);
          break;
  ...
  public class MedicationKnowledgePackaging : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "cost":
          Cost = new fhirCsR5.Models.MedicationKnowledgeCost();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<MedicationKnowledgeDrugCharacteristic>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<MedicationKnowledgeKineticCharacteristic>))]
  public class MedicationKnowledgeKineticCharacteristic : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  public class MedicationKnowledge : DomainResource,  IFhirJsonSerializable {
    ...
    /// </summary>
    public Reference AssociatedDefinition { get; set; }
    /// <summary>
    ...
    /// The time course of drug absorption, distribution, metabolism and excretion of a medication from the body.
    /// </summary>
    public List<MedicationKnowledgeKineticCharacteristic> KineticCharacteristic { get; set; }
    /// <summary>
    /// Categorization of the medication within a formulary or classification system.
    /// </summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WritePropertyName("associatedDefinition");
        AssociatedDefinition.SerializeJson(writer, options);
      }
      ...
      if ((KineticCharacteristic != null) && (KineticCharacteristic.Count != 0))
      {
        writer.WritePropertyName("kineticCharacteristic");
        writer.WriteStartArray();

        foreach (MedicationKnowledgeKineticCharacteristic valKineticCharacteristic in KineticCharacteristic)
        {
          valKineticCharacteristic.SerializeJson(writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "associatedDefinition":
          AssociatedDefinition = new fhirCsR5.Models.Reference();
          AssociatedDefinition.DeserializeJson(ref reader, options);
          break;
        ...
        case "drugCharacteristic":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.MedicationKnowledgeDrugCharacteristic objDrugCharacteristic = new fhirCsR5.Models.MedicationKnowledgeDrugCharacteristic();
        ...
        case "ingredient":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.MedicationKnowledgeIngredient objIngredient = new fhirCsR5.Models.MedicationKnowledgeIngredient();
        ...
        case "kineticCharacteristic":
          ...
          KineticCharacteristic = new List<MedicationKnowledgeKineticCharacteristic>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.MedicationKnowledgeKineticCharacteristic objKineticCharacteristic = new fhirCsR5.Models.MedicationKnowledgeKineticCharacteristic();
            objKineticCharacteristic.DeserializeJson(ref reader, options);
            KineticCharacteristic.Add(objKineticCharacteristic);
          ...
          if (KineticCharacteristic.Count == 0)
          {
            KineticCharacteristic = null;
          }
        ...
        case "_synonym":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Element obj_Synonym = new fhirCsR5.Models.Element();
