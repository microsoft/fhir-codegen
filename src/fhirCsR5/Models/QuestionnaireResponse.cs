...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<QuestionnaireResponseItemAnswer>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "item":
          ...
          {
            fhirCsR5.Models.QuestionnaireResponseItem objItem = new fhirCsR5.Models.QuestionnaireResponseItem();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<QuestionnaireResponseItem>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "answer":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.QuestionnaireResponseItemAnswer objAnswer = new fhirCsR5.Models.QuestionnaireResponseItemAnswer();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<QuestionnaireResponse>))]
  public class QuestionnaireResponse : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_authored":
          _Authored = new fhirCsR5.Models.Element();
        ...
        case "_questionnaire":
          _Questionnaire = new fhirCsR5.Models.Element();
