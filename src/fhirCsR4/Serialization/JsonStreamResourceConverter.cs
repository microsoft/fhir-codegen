    ...
    public override void Write(Utf8JsonWriter writer, Resource resource, JsonSerializerOptions options)
    {
      switch (resource)
      {
        ...
        case fhirCsR4.Models.DocumentReference typedDocumentReference:
          ...
          break;
        case fhirCsR4.Models.EffectEvidenceSynthesis typedEffectEvidenceSynthesis:
        ...
        case fhirCsR4.Models.MedicationStatement typedMedicationStatement:
          ...
          break;
        case fhirCsR4.Models.MedicinalProduct typedMedicinalProduct:
          typedMedicinalProduct.SerializeJson(writer, options, true);
          break;
        case fhirCsR4.Models.MedicinalProductAuthorization typedMedicinalProductAuthorization:
          typedMedicinalProductAuthorization.SerializeJson(writer, options, true);
          break;
        case fhirCsR4.Models.MedicinalProductContraindication typedMedicinalProductContraindication:
          typedMedicinalProductContraindication.SerializeJson(writer, options, true);
          break;
        case fhirCsR4.Models.MedicinalProductIndication typedMedicinalProductIndication:
          typedMedicinalProductIndication.SerializeJson(writer, options, true);
          break;
        case fhirCsR4.Models.MedicinalProductIngredient typedMedicinalProductIngredient:
          typedMedicinalProductIngredient.SerializeJson(writer, options, true);
          break;
        case fhirCsR4.Models.MedicinalProductInteraction typedMedicinalProductInteraction:
          typedMedicinalProductInteraction.SerializeJson(writer, options, true);
          break;
        case fhirCsR4.Models.MedicinalProductManufactured typedMedicinalProductManufactured:
          typedMedicinalProductManufactured.SerializeJson(writer, options, true);
          break;
        case fhirCsR4.Models.MedicinalProductPackaged typedMedicinalProductPackaged:
          typedMedicinalProductPackaged.SerializeJson(writer, options, true);
          break;
        case fhirCsR4.Models.MedicinalProductPharmaceutical typedMedicinalProductPharmaceutical:
          typedMedicinalProductPharmaceutical.SerializeJson(writer, options, true);
          break;
        case fhirCsR4.Models.MedicinalProductUndesirableEffect typedMedicinalProductUndesirableEffect:
        ...
        case fhirCsR4.Models.RiskAssessment typedRiskAssessment:
          ...
          break;
        case fhirCsR4.Models.RiskEvidenceSynthesis typedRiskEvidenceSynthesis:
        ...
        case fhirCsR4.Models.Substance typedSubstance:
          ...
          break;
        case fhirCsR4.Models.SubstanceNucleicAcid typedSubstanceNucleicAcid:
          typedSubstanceNucleicAcid.SerializeJson(writer, options, true);
          break;
        case fhirCsR4.Models.SubstancePolymer typedSubstancePolymer:
          typedSubstancePolymer.SerializeJson(writer, options, true);
          break;
        case fhirCsR4.Models.SubstanceProtein typedSubstanceProtein:
          typedSubstanceProtein.SerializeJson(writer, options, true);
          break;
        case fhirCsR4.Models.SubstanceReferenceInformation typedSubstanceReferenceInformation:
          typedSubstanceReferenceInformation.SerializeJson(writer, options, true);
          break;
        case fhirCsR4.Models.SubstanceSourceMaterial typedSubstanceSourceMaterial:
          typedSubstanceSourceMaterial.SerializeJson(writer, options, true);
          break;
        case fhirCsR4.Models.SubstanceSpecification typedSubstanceSpecification:
