module FHIR
  ...
  class OrganizationAffiliation < FHIR::Model
    ...
    METADATA = {
      ...
      'code' => {
        'valid_codes'=>{
          'http://hl7.org/fhir/organization-role'=>[ 'provider', 'agency', 'research', 'payer', 'diagnostics', 'supplier', 'HIE/HIO', 'member' ]
        },
        'type'=>'CodeableConcept',
        'path'=>'OrganizationAffiliation.code',
        'min'=>0,
        'max'=>Float::INFINITY,
        'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/organization-role'}
      },
      ##
    ...
    # Organization that provides/performs the role (e.g. providing services or is a member of)
    # The Participating Organization provides/performs the role(s) defined by the code to the Primary Organization (e.g. providing services or is a member of).
    attr_accessor :participatingOrganization      # 0-1 Reference(http://hl7.org/fhir/StructureDefinition/Organization)
    ##
    # Health insurance provider network in which the participatingOrganization provides the role's services (if defined) at the indicated locations (if defined).
