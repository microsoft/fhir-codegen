...
namespace fhirCsR3.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<Quantity>))]
  public class Quantity : Element,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_comparator":
          _Comparator = new fhirCsR3.Models.Element();
        ...
        case "_unit":
          _Unit = new fhirCsR3.Models.Element();
