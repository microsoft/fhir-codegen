...
public class SearchParameter_20_50 : ICrossVersionProcessor<SearchParameter>, ICrossVersionExtractor<SearchParameter>
{
	private Converter_20_50 _converter;
	internal SearchParameter_20_50(Converter_20_50 converter)
	{
	...
	public void Process(ISourceNode node, SearchParameter current)
	{
		switch (node.Name)
		{
			...
			case "component":
				current.Component.Add(Extract20SearchParameterComponentComponent(node));
				break;
	...
	private SearchParameter.ComponentComponent Extract20SearchParameterComponentComponent(ISourceNode parent)
	{
