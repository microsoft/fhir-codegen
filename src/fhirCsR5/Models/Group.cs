...
namespace fhirCsR5.Models
{
  ...
  public class Group : DomainResource,  IFhirJsonSerializable {
    ...
    /// <summary>
    /// Extension container element for Membership
    /// </summary>
    public Element _Membership { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WriteString("membership", (string)Membership!);
      }

      if (_Membership != null)
      {
        writer.WritePropertyName("_membership");
        _Membership.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "membership":
          Membership = reader.GetString();
          break;

        case "_membership":
          _Membership = new fhirCsR5.Models.Element();
          _Membership.DeserializeJson(ref reader, options);
          break;
  ...
  /// <summary>
  /// Code Values for the Group.membership field
  /// </summary>
  public static class GroupMembershipCodes {
