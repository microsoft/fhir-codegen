...
namespace fhirCsR3.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<TaskRequester>))]
  public class TaskRequester : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<TaskRestriction>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<TaskInput>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<TaskOutput>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<Task>))]
  public class Task : DomainResource,  IFhirJsonSerializable {
    ...
    /// The creator of the task.
    /// </summary>
    public TaskRequester Requester { get; set; }
    /// <summary>
    /// If the Task.focus is a request resource and the task is seeking fulfillment (i.e is asking for the request to be actioned), this element identifies any limitations on what parts of the referenced request should be actioned.
    /// </summary>
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "businessStatus":
          BusinessStatus = new fhirCsR3.Models.CodeableConcept();
        ...
        case "_definitionUri":
          _DefinitionUri = new fhirCsR3.Models.Element();
          _DefinitionUri.DeserializeJson(ref reader, options);
          break;

        case "definitionReference":
          DefinitionReference = new fhirCsR3.Models.Reference();
        ...
        case "executionPeriod":
          ExecutionPeriod = new fhirCsR3.Models.Period();
          ExecutionPeriod.DeserializeJson(ref reader, options);
          break;

        case "focus":
          Focus = new fhirCsR3.Models.Reference();
          Focus.DeserializeJson(ref reader, options);
          break;

        case "for":
          For = new fhirCsR3.Models.Reference();
        ...
        case "input":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.TaskInput objInput = new fhirCsR3.Models.TaskInput();
        ...
        case "output":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.TaskOutput objOutput = new fhirCsR3.Models.TaskOutput();
        ...
        case "performerType":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.CodeableConcept objPerformerType = new fhirCsR3.Models.CodeableConcept();
        ...
        case "requester":
          Requester = new fhirCsR3.Models.TaskRequester();
          Requester.DeserializeJson(ref reader, options);
          break;

        case "restriction":
          Restriction = new fhirCsR3.Models.TaskRestriction();
        ...
        case "statusReason":
          StatusReason = new fhirCsR3.Models.CodeableConcept();
