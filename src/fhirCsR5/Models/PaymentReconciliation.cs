...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<PaymentReconciliationDetail>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "detail":
          ...
          {
            fhirCsR5.Models.PaymentReconciliationDetail objDetail = new fhirCsR5.Models.PaymentReconciliationDetail();
        ...
        case "paymentAmount":
          PaymentAmount = new fhirCsR5.Models.Money();
