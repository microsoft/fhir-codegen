...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<EpisodeOfCareStatusHistory>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<EpisodeOfCareDiagnosis>))]
  public class EpisodeOfCareDiagnosis : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "condition":
          Condition = new fhirCsR5.Models.CodeableReference();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<EpisodeOfCare>))]
  public class EpisodeOfCare : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "careManager":
          CareManager = new fhirCsR5.Models.Reference();
        ...
        case "diagnosis":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.EpisodeOfCareDiagnosis objDiagnosis = new fhirCsR5.Models.EpisodeOfCareDiagnosis();
        ...
        case "referralRequest":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Reference objReferralRequest = new fhirCsR5.Models.Reference();
        ...
        case "statusHistory":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.EpisodeOfCareStatusHistory objStatusHistory = new fhirCsR5.Models.EpisodeOfCareStatusHistory();
