...
namespace fhirCsR4.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<RiskEvidenceSynthesisSampleSize>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<RiskEvidenceSynthesisRiskEstimatePrecisionEstimate>))]
  public class RiskEvidenceSynthesisRiskEstimatePrecisionEstimate : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_from":
          _From = new fhirCsR4.Models.Element();
        ...
        case "_to":
          _To = new fhirCsR4.Models.Element();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<RiskEvidenceSynthesisRiskEstimate>))]
  public class RiskEvidenceSynthesisRiskEstimate : BackboneElement,  IFhirJsonSerializable {
    ...
    /// A description of the precision of the estimate for the effect.
    /// </summary>
    public List<RiskEvidenceSynthesisRiskEstimatePrecisionEstimate> PrecisionEstimate { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((PrecisionEstimate != null) && (PrecisionEstimate.Count != 0))
      {
        ...
        foreach (RiskEvidenceSynthesisRiskEstimatePrecisionEstimate valPrecisionEstimate in PrecisionEstimate)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "precisionEstimate":
          ...
          PrecisionEstimate = new List<RiskEvidenceSynthesisRiskEstimatePrecisionEstimate>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4.Models.RiskEvidenceSynthesisRiskEstimatePrecisionEstimate objPrecisionEstimate = new fhirCsR4.Models.RiskEvidenceSynthesisRiskEstimatePrecisionEstimate();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<RiskEvidenceSynthesisCertaintyCertaintySubcomponent>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "rating":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4.Models.CodeableConcept objRating = new fhirCsR4.Models.CodeableConcept();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<RiskEvidenceSynthesisCertainty>))]
  public class RiskEvidenceSynthesisCertainty : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
    /// A description of a component of the overall certainty.
    /// </summary>
    public List<RiskEvidenceSynthesisCertaintyCertaintySubcomponent> CertaintySubcomponent { get; set; }
    /// <summary>
    /// A human-readable string to clarify or explain concepts about the resource.
    /// </summary>
    public List<Annotation> Note { get; set; }
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((CertaintySubcomponent != null) && (CertaintySubcomponent.Count != 0))
      {
        ...
        foreach (RiskEvidenceSynthesisCertaintyCertaintySubcomponent valCertaintySubcomponent in CertaintySubcomponent)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "certaintySubcomponent":
          ...
          CertaintySubcomponent = new List<RiskEvidenceSynthesisCertaintyCertaintySubcomponent>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4.Models.RiskEvidenceSynthesisCertaintyCertaintySubcomponent objCertaintySubcomponent = new fhirCsR4.Models.RiskEvidenceSynthesisCertaintyCertaintySubcomponent();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<RiskEvidenceSynthesis>))]
  public class RiskEvidenceSynthesis : DomainResource,  IFhirJsonSerializable {
    /// <summary>
    /// Resource Type Name
    /// </summary>
    public string ResourceType => "RiskEvidenceSynthesis";
    /// <summary>
    ...
    /// A description of the certainty of the risk estimate.
    /// </summary>
    public List<RiskEvidenceSynthesisCertainty> Certainty { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (RiskEstimate != null)
      {
        ...
        RiskEstimate.SerializeJson(writer, options);
      }
      ...
      if ((Certainty != null) && (Certainty.Count != 0))
      {
        ...
        foreach (RiskEvidenceSynthesisCertainty valCertainty in Certainty)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "certainty":
          ...
          Certainty = new List<RiskEvidenceSynthesisCertainty>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4.Models.RiskEvidenceSynthesisCertainty objCertainty = new fhirCsR4.Models.RiskEvidenceSynthesisCertainty();
        ...
        case "riskEstimate":
          RiskEstimate = new fhirCsR4.Models.RiskEvidenceSynthesisRiskEstimate();
          RiskEstimate.DeserializeJson(ref reader, options);
          break;

        case "sampleSize":
          SampleSize = new fhirCsR4.Models.RiskEvidenceSynthesisSampleSize();
  ...
  /// </summary>
  public static class RiskEvidenceSynthesisStatusCodes {
