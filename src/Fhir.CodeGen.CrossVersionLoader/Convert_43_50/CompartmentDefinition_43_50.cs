...
public class CompartmentDefinition_43_50 : ICrossVersionProcessor<CompartmentDefinition>, ICrossVersionExtractor<CompartmentDefinition>
{
	private Converter_43_50 _converter;
	internal CompartmentDefinition_43_50(Converter_43_50 converter)
	{
	...
	public void Process(ISourceNode node, CompartmentDefinition current)
	{
		switch (node.Name)
		{
			...
			case "resource":
				current.Resource.Add(Extract43CompartmentDefinitionResourceComponent(node));
				break;
	...
	private CompartmentDefinition.ResourceComponent Extract43CompartmentDefinitionResourceComponent(ISourceNode parent)
	{
