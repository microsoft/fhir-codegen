...
namespace fhirCsR4B.Models
{
  ...
  public class CitationSummary : ContactDetail,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      ((fhirCsR4B.Models.ContactDetail)this).SerializeJson(writer, options, false);
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        default:
          ((fhirCsR4B.Models.ContactDetail)this).DeserializeJsonProperty(ref reader, options, propertyName);
          break;
      }
    }
