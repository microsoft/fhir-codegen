...
public class CapabilityStatement_20_50 : ICrossVersionProcessor<CapabilityStatement>, ICrossVersionExtractor<CapabilityStatement>
{
	private Converter_20_50 _converter;
	internal CapabilityStatement_20_50(Converter_20_50 converter)
	{
	...
	public void Process(ISourceNode node, CapabilityStatement current)
	{
		switch (node.Name)
		{
			...
			case "software":
				current.Software = Extract20CapabilityStatementSoftwareComponent(node);
				break;

			case "implementation":
				current.Implementation = Extract20CapabilityStatementImplementationComponent(node);
				break;
			...
			case "rest":
				current.Rest.Add(Extract20CapabilityStatementRestComponent(node));
				break;

			case "messaging":
				current.Messaging.Add(Extract20CapabilityStatementMessagingComponent(node));
				break;

			case "document":
				current.Document.Add(Extract20CapabilityStatementDocumentComponent(node));
				break;
	...
	private CapabilityStatement.SoftwareComponent Extract20CapabilityStatementSoftwareComponent(ISourceNode parent)
	{
	...
	private CapabilityStatement.ImplementationComponent Extract20CapabilityStatementImplementationComponent(ISourceNode parent)
	{
	...
	private CapabilityStatement.RestComponent Extract20CapabilityStatementRestComponent(ISourceNode parent)
	{
		...
		foreach (ISourceNode node in parent.Children())
		{
			switch (node.Name)
			{
				...
				case "security":
					current.Security = Extract20CapabilityStatementSecurityComponent(node);
					break;

				case "resource":
					current.Resource.Add(Extract20CapabilityStatementResourceComponent(node));
					break;

				case "interaction":
					current.Interaction.Add(Extract20CapabilityStatementSystemInteractionComponent(node));
					break;

				case "searchParam":
					current.SearchParam.Add(Extract20CapabilityStatementSearchParamComponent(node));
					break;
	...
	private CapabilityStatement.SecurityComponent Extract20CapabilityStatementSecurityComponent(ISourceNode parent)
	{
	...
	private CapabilityStatement.CertificateComponent Extract20CapabilityStatementCertificateComponent(ISourceNode parent)
	{
	...
	*/
	...
	private CapabilityStatement.ResourceComponent Extract20CapabilityStatementResourceComponent(ISourceNode parent)
	{
		...
		foreach (ISourceNode node in parent.Children())
		{
			switch (node.Name)
			{
				...
				case "interaction":
					current.Interaction.Add(Extract20CapabilityStatementResourceInteractionComponent(node));
					break;
	...
	private CapabilityStatement.ResourceInteractionComponent Extract20CapabilityStatementResourceInteractionComponent(ISourceNode parent)
	{
	...
	private CapabilityStatement.SearchParamComponent Extract20CapabilityStatementSearchParamComponent(ISourceNode parent)
	{
	...
	private CapabilityStatement.SystemInteractionComponent Extract20CapabilityStatementSystemInteractionComponent(ISourceNode parent)
	{
	...
	private CapabilityStatement.OperationComponent Extract20CapabilityStatementOperationComponent(ISourceNode parent)
	{
	...
	*/
	...
	private CapabilityStatement.MessagingComponent Extract20CapabilityStatementMessagingComponent(ISourceNode parent)
	{
		...
		foreach (ISourceNode node in parent.Children())
		{
			...
			{
				case "endpoint":
					current.Endpoint.Add(Extract20CapabilityStatementEndpointComponent(node));
					break;
				...
				case "supportedMessage":
					current.SupportedMessage.Add(Extract20CapabilityStatementSupportedMessageComponent(node));
					break;
	...
	private CapabilityStatement.EndpointComponent Extract20CapabilityStatementEndpointComponent(ISourceNode parent)
	{
	...
	private CapabilityStatement.SupportedMessageComponent Extract20CapabilityStatementSupportedMessageComponent(ISourceNode parent)
	{
	...
	private CapabilityStatement.EventComponent Extract20CapabilityStatementEventComponent(ISourceNode parent)
	{
	...
	*/
	...
	private CapabilityStatement.DocumentComponent Extract20CapabilityStatementDocumentComponent(ISourceNode parent)
	{
