...
namespace fhirCsR5.Models
{
  ...
  public class CitationSummary : ContactDetail,  IFhirJsonSerializable {
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      ((fhirCsR5.Models.ContactDetail)this).SerializeJson(writer, options, false);
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        default:
          ((fhirCsR5.Models.ContactDetail)this).DeserializeJsonProperty(ref reader, options, propertyName);
          break;
      }
    }
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<CitationRelatesTo>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "targetIdentifier":
          TargetIdentifier = new fhirCsR5.Models.Identifier();
          TargetIdentifier.DeserializeJson(ref reader, options);
          break;

        case "targetReference":
          TargetReference = new fhirCsR5.Models.Reference();
          TargetReference.DeserializeJson(ref reader, options);
          break;

        case "targetAttachment":
          TargetAttachment = new fhirCsR5.Models.Attachment();
        ...
        case "targetClassifier":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.CodeableConcept objTargetClassifier = new fhirCsR5.Models.CodeableConcept();
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "relatesTo":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.CitationRelatesTo objRelatesTo = new fhirCsR5.Models.CitationRelatesTo();
            objRelatesTo.DeserializeJson(ref reader, options);
            RelatesTo.Add(objRelatesTo);
