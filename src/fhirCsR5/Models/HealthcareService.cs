...
namespace fhirCsR5.Models
{
  ...
  public class HealthcareService : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((OfferedIn != null) && (OfferedIn.Count != 0))
      {
        writer.WritePropertyName("offeredIn");
        writer.WriteStartArray();

        foreach (Reference valOfferedIn in OfferedIn)
        {
          valOfferedIn.SerializeJson(writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "offeredIn":
          ...
          OfferedIn = new List<Reference>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Reference objOfferedIn = new fhirCsR5.Models.Reference();
            objOfferedIn.DeserializeJson(ref reader, options);
            OfferedIn.Add(objOfferedIn);
