...
namespace fhirCsR5.Models
{
  ...
  public class MessageDefinition : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WriteString("graph", (string)Graph!);
      }

      if (_Graph != null)
      {
        writer.WritePropertyName("_graph");
        _Graph.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "graph":
          Graph = reader.GetString();
          break;

        case "_graph":
          _Graph = new fhirCsR5.Models.Element();
          _Graph.DeserializeJson(ref reader, options);
          break;
