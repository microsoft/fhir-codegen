...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<NutritionProductCharacteristic>))]
  public class NutritionProductCharacteristic : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  public class NutritionProduct : DomainResource,  IFhirJsonSerializable {
    ...
    /// Specifies descriptive properties of the nutrition product.
    /// </summary>
    public List<NutritionProductCharacteristic> Characteristic { get; set; }
    /// <summary>
    ...
    /// Conveys instance-level information about this product item. One or several physical, countable instances or occurrences of the product.
    /// </summary>
    public List<NutritionProductInstance> Instance { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((Characteristic != null) && (Characteristic.Count != 0))
      {
        ...
        foreach (NutritionProductCharacteristic valCharacteristic in Characteristic)
        {
      ...
      if ((Instance != null) && (Instance.Count != 0))
      {
        ...
        foreach (NutritionProductInstance valInstance in Instance)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "characteristic":
          ...
          Characteristic = new List<NutritionProductCharacteristic>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.NutritionProductCharacteristic objCharacteristic = new fhirCsR5.Models.NutritionProductCharacteristic();
        ...
        case "instance":
          ...
          Instance = new List<NutritionProductInstance>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.NutritionProductInstance objInstance = new fhirCsR5.Models.NutritionProductInstance();
