...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<DeviceDefinitionRegulatoryIdentifier>))]
  public class DeviceDefinitionRegulatoryIdentifier : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  /// <summary>
  /// Code Values for the DeviceDefinition.regulatoryIdentifier.type field
  /// </summary>
  ...
  public class DeviceDefinition : DomainResource,  IFhirJsonSerializable {
    ...
    /// This should not be used for regulatory authorization numbers which are to be captured elsewhere.
    /// </summary>
    public List<DeviceDefinitionRegulatoryIdentifier> RegulatoryIdentifier { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((RegulatoryIdentifier != null) && (RegulatoryIdentifier.Count != 0))
      {
        writer.WritePropertyName("regulatoryIdentifier");
        writer.WriteStartArray();

        foreach (DeviceDefinitionRegulatoryIdentifier valRegulatoryIdentifier in RegulatoryIdentifier)
        {
          valRegulatoryIdentifier.SerializeJson(writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "regulatoryIdentifier":
          ...
          RegulatoryIdentifier = new List<DeviceDefinitionRegulatoryIdentifier>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.DeviceDefinitionRegulatoryIdentifier objRegulatoryIdentifier = new fhirCsR5.Models.DeviceDefinitionRegulatoryIdentifier();
            objRegulatoryIdentifier.DeserializeJson(ref reader, options);
            RegulatoryIdentifier.Add(objRegulatoryIdentifier);
          ...
          if (RegulatoryIdentifier.Count == 0)
          {
            RegulatoryIdentifier = null;
          }
