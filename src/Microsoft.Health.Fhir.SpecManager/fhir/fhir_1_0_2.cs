...
namespace Microsoft.Health.Fhir.SpecManager.fhir.r2
{
	...
	public class Base
	{
		//[JsonProperty(PropertyName ="fhir_comments")]
		//public string[] _SerailizerComments { get; set; }
	}
	///<summary>
	...
	public class ConceptMap : DomainResource
	{
		...
		///<summary>May contain extended information for property: 'SourceReference'</summary>
		[JsonProperty(PropertyName = "_sourceReference")]
		...
		[JsonProperty(PropertyName = "targetReference")]
		public Reference TargetReference { get; set; }
		///<summary>May contain extended information for property: 'TargetReference'</summary>
		[JsonProperty(PropertyName = "_targetReference")]
	...
	///</summary>
	///<source-file>c:/git/fhir\publish\conceptmap.profile.canonical.json</source-file>
	public class ConceptMapElement : Element
	{
		...
		[JsonProperty(PropertyName="_codeSystem")]
	...
	///</summary>
	///<source-file>c:/git/fhir\publish\conceptmap.profile.canonical.json</source-file>
	public class ConceptMapElementTarget : Element
	{
		...
		[JsonProperty(PropertyName ="equivalence")]
		public string Equivalence { get; set; }
		[JsonProperty(PropertyName="_equivalence")]
		...
		[JsonProperty(PropertyName = "_comments")]
	...
	///</summary>
	///<source-file>c:/git/fhir\publish\conceptmap.profile.canonical.json</source-file>
	public class ConceptMapElementTargetDependsOn : Element
	{
	...
	///</summary>
	///<source-file>c:/git/fhir\publish\capabilitystatement.profile.canonical.json</source-file>
	public class ConformanceDocument : Element
	{
	...
	///</summary>
	///<source-file>c:/git/fhir\publish\capabilitystatement.profile.canonical.json</source-file>
	public class ConformanceImplementation : Element
	{
	...
	public class ConformanceMessagingEvent : Element
	{
		[JsonProperty(PropertyName = "code")]
	...
	///</summary>
	///<source-file>c:/git/fhir\publish\capabilitystatement.profile.canonical.json</source-file>
	public class ConformanceMessaging : Element
	{
	...
	///</summary>
	///<source-file>c:/git/fhir\publish\capabilitystatement.profile.canonical.json</source-file>
	public class ConformanceRest : Element
	{
	...
	///</summary>
	///<source-file>c:/git/fhir\publish\capabilitystatement.profile.canonical.json</source-file>
	public class ConformanceRestInteraction : Element
	{
	...
	///</summary>
	///<source-file>c:/git/fhir\publish\capabilitystatement.profile.canonical.json</source-file>
	public class ConformanceRestResource : Element
	{
	...
	///</summary>
	///<source-file>c:/git/fhir\publish\capabilitystatement.profile.canonical.json</source-file>
	public class ConformanceRestResourceSearchParam : Element
	{
	...
	///</summary>
	///<source-file>c:/git/fhir\publish\capabilitystatement.profile.canonical.json</source-file>
	public class ConformanceRestSecurity : Element
	{
	...
	public class ElementDefinition : BackboneType
	{
		...
		///<summary>May contain extended information for property: 'Comments'</summary>
		[JsonProperty(PropertyName = "_comments")]
		...
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleBase64Binary")]
		public string ExampleBase64Binary { get; set; }
		///<summary>May contain extended information for property: 'ExampleBase64Binary'</summary>
		[JsonProperty(PropertyName = "_exampleBase64Binary")]
		public Element _ExampleBase64Binary { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleBoolean")]
		public bool? ExampleBoolean { get; set; }
		///<summary>May contain extended information for property: 'ExampleBoolean'</summary>
		[JsonProperty(PropertyName = "_exampleBoolean")]
		public Element _ExampleBoolean { get; set; }
		///<summary>Specifying a default value means that the property can never been unknown - it must always have a value. Further, the default value can never be changed, or changed in constraints on content models. Defining default values creates many difficulties in implementation (e.g. when is a value missing?). For these reasons, default values are (and should be) used extremely sparingly.
		///
		/// No default values are ever defined in the FHIR specification, nor can they be defined in constraints ("profiles") on data types or resources. This element only exists so that default values may be defined in logical models.</summary>
		[JsonProperty(PropertyName = "exampleCode")]
		public string ExampleCode { get; set; }
		///<summary>May contain extended information for property: 'ExampleCode'</summary>
		[JsonProperty(PropertyName = "_exampleCode")]
		public Element _ExampleCode { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleCodeableConcept")]
		public CodeableConcept ExampleCodeableConcept { get; set; }
		///<summary>May contain extended information for property: 'ExampleCodeableConcept'</summary>
		[JsonProperty(PropertyName = "_exampleCodeableConcept")]
		public Element _ExampleCodeableConcept { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleCoding")]
		public Coding ExampleCoding { get; set; }
		///<summary>May contain extended information for property: 'ExampleCoding'</summary>
		[JsonProperty(PropertyName = "_exampleCoding")]
		public Element _ExampleCoding { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleContactPoint")]
		public ContactPoint ExampleContactPoint { get; set; }
		///<summary>May contain extended information for property: 'ExampleContactPoint'</summary>
		[JsonProperty(PropertyName = "_exampleContactPoint")]
		public Element _ExampleContactPoint { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleDate")]
		public string ExampleDate { get; set; }
		///<summary>May contain extended information for property: 'ExampleDate'</summary>
		[JsonProperty(PropertyName = "_exampleDate")]
		public Element _ExampleDate { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleDateTime")]
		public string ExampleDateTime { get; set; }
		///<summary>May contain extended information for property: 'ExampleDateTime'</summary>
		[JsonProperty(PropertyName = "_exampleDateTime")]
		public Element _ExampleDateTime { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleDecimal")]
		public decimal? ExampleDecimal { get; set; }
		///<summary>May contain extended information for property: 'ExampleDecimal'</summary>
		[JsonProperty(PropertyName = "_exampleDecimal")]
		public Element _ExampleDecimal { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleDistance")]
		public Distance ExampleDistance { get; set; }
		///<summary>May contain extended information for property: 'ExampleDistance'</summary>
		[JsonProperty(PropertyName = "_exampleDistance")]
		public Element _ExampleDistance { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleHumanName")]
		public HumanName ExampleHumanName { get; set; }
		///<summary>May contain extended information for property: 'ExampleHumanName'</summary>
		[JsonProperty(PropertyName = "_exampleHumanName")]
		public Element _ExampleHumanName { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleId")]
		public string ExampleId { get; set; }
		///<summary>May contain extended information for property: 'ExampleId'</summary>
		[JsonProperty(PropertyName = "_exampleId")]
		public Element _ExampleId { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleIdentifier")]
		public Identifier ExampleIdentifier { get; set; }
		///<summary>May contain extended information for property: 'ExampleIdentifier'</summary>
		[JsonProperty(PropertyName = "_exampleIdentifier")]
		public Element _ExampleIdentifier { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleInstant")]
		public string ExampleInstant { get; set; }
		///<summary>May contain extended information for property: 'ExampleInstant'</summary>
		[JsonProperty(PropertyName = "_exampleInstant")]
		public Element _ExampleInstant { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleInteger")]
		public int? ExampleInteger { get; set; }
		///<summary>May contain extended information for property: 'ExampleInteger'</summary>
		[JsonProperty(PropertyName = "_exampleInteger")]
		public Element _ExampleInteger { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleMeta")]
		public Meta ExampleMeta { get; set; }
		///<summary>May contain extended information for property: 'ExampleMeta'</summary>
		[JsonProperty(PropertyName = "_exampleMeta")]
		public Element _ExampleMeta { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleOid")]
		public string ExampleOid { get; set; }
		///<summary>May contain extended information for property: 'ExampleOid'</summary>
		[JsonProperty(PropertyName = "_exampleOid")]
		public Element _ExampleOid { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "examplePeriod")]
		public Period ExamplePeriod { get; set; }
		///<summary>May contain extended information for property: 'ExamplePeriod'</summary>
		[JsonProperty(PropertyName = "_examplePeriod")]
		public Element _ExamplePeriod { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "examplePositiveInt")]
		public uint? ExamplePositiveInt { get; set; }
		///<summary>May contain extended information for property: 'ExamplePositiveInt'</summary>
		[JsonProperty(PropertyName = "_examplePositiveInt")]
		public Element _ExamplePositiveInt { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleQuantity")]
		public Quantity ExampleQuantity { get; set; }
		///<summary>May contain extended information for property: 'ExampleQuantity'</summary>
		[JsonProperty(PropertyName = "_exampleQuantity")]
		public Element _ExampleQuantity { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleRange")]
		public Range ExampleRange { get; set; }
		///<summary>May contain extended information for property: 'ExampleRange'</summary>
		[JsonProperty(PropertyName = "_exampleRange")]
		public Element _ExampleRange { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleRatio")]
		public Ratio ExampleRatio { get; set; }
		///<summary>May contain extended information for property: 'ExampleRatio'</summary>
		[JsonProperty(PropertyName = "_exampleRatio")]
		public Element _ExampleRatio { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleReference")]
		public Reference ExampleReference { get; set; }
		///<summary>May contain extended information for property: 'ExampleReference'</summary>
		[JsonProperty(PropertyName = "_exampleReference")]
		public Element _ExampleReference { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleSampledData")]
		public SampledData ExampleSampledData { get; set; }
		///<summary>May contain extended information for property: 'ExampleSampledData'</summary>
		[JsonProperty(PropertyName = "_exampleSampledData")]
		public Element _ExampleSampledData { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleSignature")]
		public Signature ExampleSignature { get; set; }
		///<summary>May contain extended information for property: 'ExampleSignature'</summary>
		[JsonProperty(PropertyName = "_exampleSignature")]
		public Element _ExampleSignature { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleString")]
		public string ExampleString { get; set; }
		///<summary>May contain extended information for property: 'ExampleString'</summary>
		[JsonProperty(PropertyName = "_exampleString")]
		public Element _ExampleString { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleTime")]
		public string ExampleTime { get; set; }
		///<summary>May contain extended information for property: 'ExampleTime'</summary>
		[JsonProperty(PropertyName = "_exampleTime")]
		public Element _ExampleTime { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleTiming")]
		public Timing ExampleTiming { get; set; }
		///<summary>May contain extended information for property: 'ExampleTiming'</summary>
		[JsonProperty(PropertyName = "_exampleTiming")]
		public Element _ExampleTiming { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleUnsignedInt")]
		public uint? ExampleUnsignedInt { get; set; }
		///<summary>May contain extended information for property: 'ExampleUnsignedInt'</summary>
		[JsonProperty(PropertyName = "_exampleUnsignedInt")]
		public Element _ExampleUnsignedInt { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleUri")]
		public string ExampleUri { get; set; }
		///<summary>May contain extended information for property: 'ExampleUri'</summary>
		[JsonProperty(PropertyName = "_exampleUri")]
		public Element _ExampleUri { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleUrl")]
		public string ExampleUrl { get; set; }
		///<summary>May contain extended information for property: 'ExampleUrl'</summary>
		[JsonProperty(PropertyName = "_exampleUrl")]
		public Element _ExampleUrl { get; set; }
		///<summary>The value that should be used if there is no value stated in the instance (e.g. 'if not otherwise specified, the abstract is false').</summary>
		[JsonProperty(PropertyName = "exampleUuid")]
		public Guid? ExampleUuid { get; set; }
		///<summary>May contain extended information for property: 'ExampleUuid'</summary>
		[JsonProperty(PropertyName = "_exampleUuid")]
		public Element _ExampleUuid { get; set; }
		...
		[JsonProperty(PropertyName = "nameReference")]
		public string NameReference { get; set; }
		///<summary>May contain extended information for property: 'NameReference'</summary>
		[JsonProperty(PropertyName = "_nameReference")]
	...
	public class StructureDefinition : DomainResource
	{
		...
		[JsonProperty(PropertyName = "constrainedType")]
		public string ConstrainedType { get; set; }
		///<summary>May contain extended information for property: 'ConstrainedType'</summary>
		[JsonProperty(PropertyName = "_constrainedType")]
	...
	public class TimingRepeat : Element
	{
		...
		///<summary>Either a duration for the length of the timing schedule, a range of possible length, or outer bounds for start and/or end limits of the timing schedule.</summary>
		[JsonProperty(PropertyName = "boundsQuantity")]
		public Quantity BoundsQuantity { get; set; }
		///<summary>May contain extended information for property: 'BoundsQuantity'</summary>
		[JsonProperty(PropertyName = "_boundsQuantity")]
		public Element _BoundsQuantity { get; set; }
		///<summary>Either a duration for the length of the timing schedule, a range of possible length, or outer bounds for start and/or end limits of the timing schedule.</summary>
	...
	public class ValueSetCodeSystemConcept : Element
	{
		[JsonProperty(PropertyName = "code")]
		public string Code { get; set; }
		[JsonProperty(PropertyName = "abstract")]
	...
	public class ValueSetCodeSystem : Element
	{
		[JsonProperty(PropertyName = "system")]
		public string System { get; set; }
		[JsonProperty(PropertyName = "version")]
