...
namespace fhirCsR5.Models
{
  ...
  public class DeviceUdiCarrier : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (CarrierAIDC != null)
      {
        writer.WriteBase64String("carrierAIDC", (byte[])CarrierAIDC!);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "carrierAIDC":
          CarrierAIDC = reader.GetBytesFromBase64();
          break;
  ...
  public class Device : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "definition":
          Definition = new fhirCsR5.Models.Reference();
        ...
        case "_distinctIdentifier":
          _DistinctIdentifier = new fhirCsR5.Models.Element();
