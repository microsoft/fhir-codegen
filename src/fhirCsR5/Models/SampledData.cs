...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<SampledData>))]
  public class SampledData : DataType,  IFhirJsonSerializable {
    /// <summary>
    ...
    /// <summary>
    /// Extension container element for Interval
    /// </summary>
    ...
    /// <summary>
    /// Extension container element for IntervalUnit
    /// </summary>
    public Element _IntervalUnit { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (_Interval != null)
      {
        writer.WritePropertyName("_interval");
        _Interval.SerializeJson(writer, options);
      }

      if (!string.IsNullOrEmpty(IntervalUnit))
      {
        writer.WriteString("intervalUnit", (string)IntervalUnit!);
      }

      if (_IntervalUnit != null)
      {
        writer.WritePropertyName("_intervalUnit");
        _IntervalUnit.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_data":
          _Data = new fhirCsR5.Models.Element();
        ...
        case "interval":
          Interval = reader.GetDecimal();
          break;

        case "_interval":
          _Interval = new fhirCsR5.Models.Element();
          _Interval.DeserializeJson(ref reader, options);
          break;

        case "intervalUnit":
          IntervalUnit = reader.GetString();
          break;

        case "_intervalUnit":
          _IntervalUnit = new fhirCsR5.Models.Element();
          _IntervalUnit.DeserializeJson(ref reader, options);
          break;
        ...
        case "_lowerLimit":
          _LowerLimit = new fhirCsR5.Models.Element();
          _LowerLimit.DeserializeJson(ref reader, options);
          break;

        case "origin":
          Origin = new fhirCsR5.Models.Quantity();
        ...
        case "_upperLimit":
          _UpperLimit = new fhirCsR5.Models.Element();
