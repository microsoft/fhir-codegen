...
namespace fhirCsR5.ValueSets
{
  ...
  public static class UsageContextTypeCodes
  {
    ...
    /// </summary>
    public static readonly Coding AgreementAcope = new Coding
    {
      Code = "agreement-scope",
      Display = "Agreement Acope",
      System = "http://terminology.hl7.org/CodeSystem/usage-context-type"
    };
    /// <summary>
    ...
    /// <summary>
    /// Literal for code: AgreementAcope
    /// </summary>
    public const string LiteralAgreementAcope = "agreement-scope";

    /// <summary>
    /// Literal for code: UsageContextTypeAgreementAcope
    /// </summary>
    public const string LiteralUsageContextTypeAgreementAcope = "http://terminology.hl7.org/CodeSystem/usage-context-type#agreement-scope";
    ...
    public static Dictionary<string, Coding> Values = new Dictionary<string, Coding>() {
      ...
      { "agreement-scope", AgreementAcope }, 
      { "http://terminology.hl7.org/CodeSystem/usage-context-type#agreement-scope", AgreementAcope }, 
      { "focus", ClinicalFocus }, 
