...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<MarketingStatus>))]
  public class MarketingStatus : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "dateRange":
          DateRange = new fhirCsR4B.Models.Period();
        ...
        case "_restoreDate":
          _RestoreDate = new fhirCsR4B.Models.Element();
