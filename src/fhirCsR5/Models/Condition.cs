...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ConditionParticipant>))]
  public class ConditionParticipant : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  public class Condition : DomainResource,  IFhirJsonSerializable {
    ...
    /// Indicates who or what participated in the activities related to the condition and how they were involved.
    /// </summary>
    public List<ConditionParticipant> Participant { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((Participant != null) && (Participant.Count != 0))
      {
        ...
        foreach (ConditionParticipant valParticipant in Participant)
        {
      ...
      if ((Evidence != null) && (Evidence.Count != 0))
      {
        ...
        foreach (CodeableReference valEvidence in Evidence)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "evidence":
          ...
          Evidence = new List<CodeableReference>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.CodeableReference objEvidence = new fhirCsR5.Models.CodeableReference();
        ...
        case "participant":
          ...
          Participant = new List<ConditionParticipant>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.ConditionParticipant objParticipant = new fhirCsR5.Models.ConditionParticipant();
