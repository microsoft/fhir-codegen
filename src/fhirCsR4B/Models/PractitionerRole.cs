...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<PractitionerRoleAvailableTime>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<PractitionerRoleNotAvailable>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<PractitionerRole>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "availableTime":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.PractitionerRoleAvailableTime objAvailableTime = new fhirCsR4B.Models.PractitionerRoleAvailableTime();
        ...
        case "healthcareService":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Reference objHealthcareService = new fhirCsR4B.Models.Reference();
        ...
        case "notAvailable":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.PractitionerRoleNotAvailable objNotAvailable = new fhirCsR4B.Models.PractitionerRoleNotAvailable();
        ...
        case "practitioner":
          Practitioner = new fhirCsR4B.Models.Reference();
