...
namespace fhirCsR5.Models
{
  ...
  public class MedicationDispense : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WritePropertyName("notPerformedReason");
        NotPerformedReason.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "notPerformedReason":
          NotPerformedReason = new fhirCsR5.Models.CodeableReference();
          NotPerformedReason.DeserializeJson(ref reader, options);
          break;
