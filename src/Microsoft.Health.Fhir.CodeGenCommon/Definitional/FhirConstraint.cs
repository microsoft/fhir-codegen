...
using static Microsoft.Health.Fhir.CodeGenCommon.Definitional.FhirComplex;
...
public record class FhirConstraint : ICloneable
{
    ...
    private string _severityLiteral = string.Empty;
    ...
    protected FhirConstraint(FhirConstraint other)
    {
        ...
        SeverityLiteral = other.SeverityLiteral;
    ...
    public required string SeverityLiteral
    {
        get => _severityLiteral;
        init
        {
            _severityLiteral = value;
            _severity = value.ToEnum<FhirConstraintSeverityCodes>() ?? FhirConstraintSeverityCodes.Error;
        }
    }
