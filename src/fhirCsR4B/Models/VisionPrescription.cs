...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<VisionPrescriptionLensSpecificationPrism>))]
  public class VisionPrescriptionLensSpecificationPrism : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_amount":
          _Amount = new fhirCsR4B.Models.Element();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<VisionPrescriptionLensSpecification>))]
  public class VisionPrescriptionLensSpecification : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_add":
          _Add = new fhirCsR4B.Models.Element();
        ...
        case "_axis":
          _Axis = new fhirCsR4B.Models.Element();
        ...
        case "_backCurve":
          _BackCurve = new fhirCsR4B.Models.Element();
        ...
        case "_brand":
          _Brand = new fhirCsR4B.Models.Element();
        ...
        case "_cylinder":
          _Cylinder = new fhirCsR4B.Models.Element();
        ...
        case "_diameter":
          _Diameter = new fhirCsR4B.Models.Element();
        ...
        case "_eye":
          _Eye = new fhirCsR4B.Models.Element();
        ...
        case "_power":
          _Power = new fhirCsR4B.Models.Element();
        ...
        case "prism":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.VisionPrescriptionLensSpecificationPrism objPrism = new fhirCsR4B.Models.VisionPrescriptionLensSpecificationPrism();
        ...
        case "product":
          Product = new fhirCsR4B.Models.CodeableConcept();
        ...
        case "_sphere":
          _Sphere = new fhirCsR4B.Models.Element();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<VisionPrescription>))]
  public class VisionPrescription : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_dateWritten":
          _DateWritten = new fhirCsR4B.Models.Element();
        ...
        case "lensSpecification":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.VisionPrescriptionLensSpecification objLensSpecification = new fhirCsR4B.Models.VisionPrescriptionLensSpecification();
        ...
        case "prescriber":
          Prescriber = new fhirCsR4B.Models.Reference();
