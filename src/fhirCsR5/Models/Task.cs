  ...
  public class Task : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (RequestedPeriod != null)
      {
        ...
        RequestedPeriod.SerializeJson(writer, options);
      }
      ...
      if ((RequestedPerformer != null) && (RequestedPerformer.Count != 0))
      {
        writer.WritePropertyName("requestedPerformer");
        writer.WriteStartArray();

        foreach (CodeableReference valRequestedPerformer in RequestedPerformer)
        {
          valRequestedPerformer.SerializeJson(writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "requestedPerformer":
          ...
          RequestedPerformer = new List<CodeableReference>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.CodeableReference objRequestedPerformer = new fhirCsR5.Models.CodeableReference();
            objRequestedPerformer.DeserializeJson(ref reader, options);
            RequestedPerformer.Add(objRequestedPerformer);
        ...
        case "requestedPeriod":
          RequestedPeriod = new fhirCsR5.Models.Period();
          RequestedPeriod.DeserializeJson(ref reader, options);
          break;
