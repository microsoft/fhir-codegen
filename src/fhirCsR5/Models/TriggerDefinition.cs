...
namespace fhirCsR5.Models
{
  ...
  public class TriggerDefinition : DataType,  IFhirJsonSerializable {
    ...
    /// <summary>
    /// Extension container element for SubscriptionTopic
    /// </summary>
    public Element _SubscriptionTopic { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WriteString("subscriptionTopic", (string)SubscriptionTopic!);
      }

      if (_SubscriptionTopic != null)
      {
        writer.WritePropertyName("_subscriptionTopic");
        _SubscriptionTopic.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "subscriptionTopic":
          SubscriptionTopic = reader.GetString();
          break;

        case "_subscriptionTopic":
          _SubscriptionTopic = new fhirCsR5.Models.Element();
          _SubscriptionTopic.DeserializeJson(ref reader, options);
          break;
