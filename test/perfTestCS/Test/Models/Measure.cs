...
namespace Fhir.R4.Models
{
  ...
  public class MeasureGroupPopulation : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      Criteria.SerializeJson(ref writer, options);
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "criteria":
          Criteria = new Fhir.R4.Models.Expression();
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "component":
          ...
          {
            Fhir.R4.Models.MeasureGroupStratifierComponent objComponent = new Fhir.R4.Models.MeasureGroupStratifierComponent();
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "population":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.MeasureGroupPopulation objPopulation = new Fhir.R4.Models.MeasureGroupPopulation();
        ...
        case "stratifier":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.MeasureGroupStratifier objStratifier = new Fhir.R4.Models.MeasureGroupStratifier();
  ...
  public class MeasureSupplementalData : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((Usage != null) && (Usage.Count != 0))
      {
        ...
        {
          valUsage.SerializeJson(ref writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "usage":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.CodeableConcept objUsage = new Fhir.R4.Models.CodeableConcept();
  ...
  public class Measure : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      writer.WriteString("clinicalRecommendationStatement", ClinicalRecommendationStatement);

      if (_ClinicalRecommendationStatement != null)
      {
        writer.WritePropertyName("_clinicalRecommendationStatement");
        _ClinicalRecommendationStatement.SerializeJson(ref writer, options);
      }

      if (CompositeScoring != null)
      {
        writer.WritePropertyName("compositeScoring");
        CompositeScoring.SerializeJson(ref writer, options);
      }
      ...
      if ((_Definition != null) && (_Definition.Count != 0))
      {
        ...
        {
          val_Definition.SerializeJson(ref writer, options, true);
        }
      ...
      writer.WriteString("disclaimer", Disclaimer);

      if (_Disclaimer != null)
      {
        writer.WritePropertyName("_disclaimer");
        _Disclaimer.SerializeJson(ref writer, options);
      }
      ...
      writer.WriteString("guidance", Guidance);

      if (_Guidance != null)
      {
        writer.WritePropertyName("_guidance");
        _Guidance.SerializeJson(ref writer, options);
      }
      ...
      writer.WriteString("rateAggregation", RateAggregation);

      if (_RateAggregation != null)
      {
        writer.WritePropertyName("_rateAggregation");
        _RateAggregation.SerializeJson(ref writer, options);
      }
      ...
      if (_Rationale != null)
      {
        ...
        _Rationale.SerializeJson(ref writer, options);
      }
      ...
      writer.WriteString("riskAdjustment", RiskAdjustment);

      if (_RiskAdjustment != null)
      {
        writer.WritePropertyName("_riskAdjustment");
        _RiskAdjustment.SerializeJson(ref writer, options);
      }
      ...
      if ((SupplementalData != null) && (SupplementalData.Count != 0))
      {
        ...
        {
          valSupplementalData.SerializeJson(ref writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_clinicalRecommendationStatement":
          _ClinicalRecommendationStatement = new Fhir.R4.Models.Element();
          _ClinicalRecommendationStatement.DeserializeJson(ref reader, options);
          break;

        case "compositeScoring":
          CompositeScoring = new Fhir.R4.Models.CodeableConcept();
        ...
        case "_definition":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.Element obj_Definition = new Fhir.R4.Models.Element();
        ...
        case "_disclaimer":
          _Disclaimer = new Fhir.R4.Models.Element();
        ...
        case "group":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.MeasureGroup objGroup = new Fhir.R4.Models.MeasureGroup();
        ...
        case "_guidance":
          _Guidance = new Fhir.R4.Models.Element();
        ...
        case "_rateAggregation":
          _RateAggregation = new Fhir.R4.Models.Element();
        ...
        case "_riskAdjustment":
          _RiskAdjustment = new Fhir.R4.Models.Element();
        ...
        case "supplementalData":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.MeasureSupplementalData objSupplementalData = new Fhir.R4.Models.MeasureSupplementalData();
