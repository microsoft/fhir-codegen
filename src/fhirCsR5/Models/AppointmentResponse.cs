...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<AppointmentResponse>))]
  public class AppointmentResponse : DomainResource,  IFhirJsonSerializable {
    ...
    /// </summary>
    public Element _OccurrenceDate { get; set; }
    /// <summary>
    ...
    /// <summary>
    /// Extension container element for ProposedNewTime
    /// </summary>
    public Element _ProposedNewTime { get; set; }
    /// <summary>
    ...
    /// <summary>
    /// Extension container element for Recurring
    /// </summary>
    public Element _Recurring { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WriteBoolean("proposedNewTime", (bool)ProposedNewTime!);
      }

      if (_ProposedNewTime != null)
      {
        writer.WritePropertyName("_proposedNewTime");
        _ProposedNewTime.SerializeJson(writer, options);
      }
      ...
      if (Recurring != null)
      {
        writer.WriteBoolean("recurring", (bool)Recurring!);
      }

      if (_Recurring != null)
      {
        writer.WritePropertyName("_recurring");
        _Recurring.SerializeJson(writer, options);
      }

      if (!string.IsNullOrEmpty(OccurrenceDate))
      {
        writer.WriteString("occurrenceDate", (string)OccurrenceDate!);
      }

      if (_OccurrenceDate != null)
      {
        writer.WritePropertyName("_occurrenceDate");
        _OccurrenceDate.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "appointment":
          Appointment = new fhirCsR5.Models.Reference();
        ...
        case "occurrenceDate":
          OccurrenceDate = reader.GetString();
          break;

        case "_occurrenceDate":
          _OccurrenceDate = new fhirCsR5.Models.Element();
          _OccurrenceDate.DeserializeJson(ref reader, options);
          break;
        ...
        case "_participantStatus":
          _ParticipantStatus = new fhirCsR5.Models.Element();
        ...
        case "participantType":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.CodeableConcept objParticipantType = new fhirCsR5.Models.CodeableConcept();
        ...
        case "proposedNewTime":
          ProposedNewTime = reader.GetBoolean();
          break;

        case "_proposedNewTime":
          _ProposedNewTime = new fhirCsR5.Models.Element();
          _ProposedNewTime.DeserializeJson(ref reader, options);
          break;
        ...
        case "recurring":
          Recurring = reader.GetBoolean();
          break;

        case "_recurring":
          _Recurring = new fhirCsR5.Models.Element();
          _Recurring.DeserializeJson(ref reader, options);
          break;
