...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<DataRequirementValueFilter>))]
  public class DataRequirementValueFilter : Element,  IFhirJsonSerializable {
    /// <summary>
  ...
  /// <summary>
  /// Code Values for the DataRequirement.valueFilter.comparator field
  /// </summary>
  public static class DataRequirementValueFilterComparatorCodes {
  ...
  public class DataRequirement : DataType,  IFhirJsonSerializable {
    ...
    /// Value filters specify additional constraints on the data for elements other than code-valued or date-valued. Each value filter specifies an additional constraint on the data (i.e. valueFilters are AND'ed, not OR'ed).
    /// </summary>
    public List<DataRequirementValueFilter> ValueFilter { get; set; }
    /// <summary>
    /// Serialize to a JSON object
    /// </summary>
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((ValueFilter != null) && (ValueFilter.Count != 0))
      {
        ...
        foreach (DataRequirementValueFilter valValueFilter in ValueFilter)
        {
          valValueFilter.SerializeJson(writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "valueFilter":
          ...
          ValueFilter = new List<DataRequirementValueFilter>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.DataRequirementValueFilter objValueFilter = new fhirCsR5.Models.DataRequirementValueFilter();
            objValueFilter.DeserializeJson(ref reader, options);
            ValueFilter.Add(objValueFilter);
