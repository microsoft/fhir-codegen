...
public record class FhirSearchParam : FhirCanonicalBase, ICloneable
{
...
#pragma warning restore CA1720 // Identifier contains type name
    ...
    public required string SearchTypeLiteral
    {
        ...
        init
        {
            ...
            _searchType = value.ToEnum<SearchParameterTypeCodes>() ?? SearchParameterTypeCodes.Special;
        }
    }
