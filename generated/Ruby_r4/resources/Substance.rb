module FHIR
  ...
  class Substance < FHIR::Model
    ...
    METADATA = {
      ...
      'status' => {
        'valid_codes'=>{
          'http://hl7.org/fhir/substance-status'=>[ 'active', 'inactive', 'entered-in-error' ]
        },
        'type'=>'code',
        'path'=>'Substance.status',
        'min'=>0,
        'max'=>1,
        'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/substance-status'}
      },
      ##
      ...
      'category' => {
        'valid_codes'=>{
          'http://terminology.hl7.org/CodeSystem/substance-category'=>[ 'allergen', 'biological', 'body', 'chemical', 'food', 'drug', 'material' ]
        },
        'type'=>'CodeableConcept',
        'path'=>'Substance.category',
        'min'=>0,
        'max'=>Float::INFINITY,
        'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/substance-category'}
      },
      ##
    ...
    class Ingredient < FHIR::Model
      ...
      # A component of the substance
      # Another substance that is a component of this substance.
      attr_accessor :substanceReference             # 1-1 Reference(http://hl7.org/fhir/StructureDefinition/Substance)
    end
    ##
    # Logical id of this artifact
    # The logical id of the resource, as used in the URL for the resource. Once assigned, this value never changes.
