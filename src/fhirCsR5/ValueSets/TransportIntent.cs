...
namespace fhirCsR5.ValueSets
{
  ...
  public static class TransportIntentCodes
  {
    ...
    /// </summary>
    public static readonly Coding Unknown_transport_intent = new Coding
    {
      Code = "unknown",
      Display = "Unknown",
    ...
    /// <summary>
    /// Literal for code: Unknown_transport_intent
    /// </summary>
    public const string LiteralUnknown_transport_intent = "unknown";

    /// <summary>
    /// Literal for code: TransportIntentUnknown_transport_intent
    /// </summary>
    public const string LiteralTransportIntentUnknown_transport_intent = "http://hl7.org/fhir/transport-intent#unknown";

    /// <summary>
    /// Dictionary for looking up TransportIntent Codings based on Codes
    /// </summary>
    public static Dictionary<string, Coding> Values = new Dictionary<string, Coding>() {
      ...
      { "unknown", Unknown_transport_intent }, 
      { "http://hl7.org/fhir/transport-intent#unknown", Unknown_transport_intent }, 
    };
  };
}
