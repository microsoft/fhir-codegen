module FHIR
  ...
  class CompartmentDefinition < FHIR::Model
    ...
    SEARCH_PARAMS = ['code', 'context-quantity', 'context-type-quantity', 'context-type-value', 'context-type', 'context', 'date', 'description', 'name', 'publisher', 'resource', 'status', 'url', 'version']
    METADATA = {
      ##
