  ...
  public class MessageHeaderDestination : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (Receiver != null)
      {
        ...
        Receiver.SerializeJson(ref writer, options);
      }
  ...
  public class MessageHeaderSource : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (Contact != null)
      {
        ...
        Contact.SerializeJson(ref writer, options);
      }
      ...
      if (_Software != null)
      {
        ...
        _Software.SerializeJson(ref writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "contact":
          Contact = new Fhir.R4.Models.ContactPoint();
        ...
        case "_software":
          _Software = new Fhir.R4.Models.Element();
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "destination":
          ...
          {
            Fhir.R4.Models.MessageHeaderDestination objDestination = new Fhir.R4.Models.MessageHeaderDestination();
        ...
        case "response":
          Response = new Fhir.R4.Models.MessageHeaderResponse();
        ...
        case "source":
          Source = new Fhir.R4.Models.MessageHeaderSource();
