...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<MeasureTerm>))]
  public class MeasureTerm : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  public class Measure : DomainResource,  IFhirJsonSerializable {
    ...
    /// Provides a description of an individual term used within the measure.
    /// </summary>
    public List<MeasureTerm> Term { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((Term != null) && (Term.Count != 0))
      {
        ...
        foreach (MeasureTerm valTerm in Term)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "term":
          ...
          Term = new List<MeasureTerm>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.MeasureTerm objTerm = new fhirCsR5.Models.MeasureTerm();
