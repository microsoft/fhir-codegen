...
namespace fhirCsR5.Models
{
  ...
  public class TestReport : DomainResource,  IFhirJsonSerializable {
    ...
    /// <summary>
    /// Extension container element for TestScript
    /// </summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WriteString("testScript", (string)TestScript!);
      }

      if (_TestScript != null)
      {
        writer.WritePropertyName("_testScript");
        _TestScript.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "testScript":
          TestScript = reader.GetString();
          break;

        case "_testScript":
          _TestScript = new fhirCsR5.Models.Element();
          _TestScript.DeserializeJson(ref reader, options);
          break;
