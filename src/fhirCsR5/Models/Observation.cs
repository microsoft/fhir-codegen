...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ObservationTriggeredBy>))]
  public class ObservationTriggeredBy : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (Observation != null)
      {
        ...
        Observation.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "observation":
          Observation = new fhirCsR5.Models.Reference();
          Observation.DeserializeJson(ref reader, options);
          break;
  ...
  public class ObservationReferenceRange : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (NormalValue != null)
      {
        writer.WritePropertyName("normalValue");
        NormalValue.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "normalValue":
          NormalValue = new fhirCsR5.Models.CodeableConcept();
          NormalValue.DeserializeJson(ref reader, options);
          break;
  ...
  public class Observation : DomainResource,  IFhirJsonSerializable {
    ...
    /// Identifies the observation(s) that triggered the performance of this observation.
    /// </summary>
    public List<ObservationTriggeredBy> TriggeredBy { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((TriggeredBy != null) && (TriggeredBy.Count != 0))
      {
        writer.WritePropertyName("triggeredBy");
        writer.WriteStartArray();

        foreach (ObservationTriggeredBy valTriggeredBy in TriggeredBy)
        {
          valTriggeredBy.SerializeJson(writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "bodyStructure":
          BodyStructure = new fhirCsR5.Models.Reference();
        ...
        case "triggeredBy":
          ...
          TriggeredBy = new List<ObservationTriggeredBy>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.ObservationTriggeredBy objTriggeredBy = new fhirCsR5.Models.ObservationTriggeredBy();
            objTriggeredBy.DeserializeJson(ref reader, options);
            TriggeredBy.Add(objTriggeredBy);
