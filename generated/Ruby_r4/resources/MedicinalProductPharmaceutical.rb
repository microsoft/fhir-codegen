module FHIR
  ...
  class MedicinalProductPharmaceutical < FHIR::Model
    ...
    METADATA = {
      ...
      # Ingredient.
      'ingredient' => {
        'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/MedicinalProductIngredient'],
        'type'=>'Reference',
      ...
      'routeOfAdministration' => {
        'type'=>'MedicinalProductPharmaceutical::RouteOfAdministration',
    ...
    class Characteristics < FHIR::Model
      ...
      METADATA = {
        ...
        'extension' => {
          'type'=>'Extension',
          'path'=>'Characteristics.extension',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
        ...
        'modifierExtension' => {
          'type'=>'Extension',
          'path'=>'Characteristics.modifierExtension',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
    ...
    class RouteOfAdministration < FHIR::Model
      ...
      METADATA = {
        ...
        'extension' => {
          'type'=>'Extension',
          'path'=>'RouteOfAdministration.extension',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
        ...
        'modifierExtension' => {
          'type'=>'Extension',
          'path'=>'RouteOfAdministration.modifierExtension',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
        ...
        'code' => {
          'type'=>'CodeableConcept',
          'path'=>'RouteOfAdministration.code',
          'min'=>1,
          'max'=>1
        },
        ##
        ...
        'firstDose' => {
          'type'=>'Quantity',
          'path'=>'RouteOfAdministration.firstDose',
          'min'=>0,
          'max'=>1
        },
        ##
        ...
        'maxSingleDose' => {
          'type'=>'Quantity',
          'path'=>'RouteOfAdministration.maxSingleDose',
          'min'=>0,
          'max'=>1
        },
        ##
        ...
        'maxDosePerDay' => {
          'type'=>'Quantity',
          'path'=>'RouteOfAdministration.maxDosePerDay',
          'min'=>0,
          'max'=>1
        },
        ##
        ...
        'maxDosePerTreatmentPeriod' => {
          'type'=>'Ratio',
          'path'=>'RouteOfAdministration.maxDosePerTreatmentPeriod',
          'min'=>0,
          'max'=>1
        },
        ##
        ...
        'maxTreatmentPeriod' => {
          'type'=>'Duration',
          'path'=>'RouteOfAdministration.maxTreatmentPeriod',
          'min'=>0,
          'max'=>1
        },
        ##
        ...
        'targetSpecies' => {
          'type'=>'MedicinalProductPharmaceutical::RouteOfAdministration::TargetSpecies',
          'path'=>'RouteOfAdministration.targetSpecies',
          'min'=>0,
          'max'=>Float::INFINITY
        }
      }
      ...
      class TargetSpecies < FHIR::Model
        ...
        METADATA = {
          ...
          'modifierExtension' => {
            'type'=>'Extension',
            'path'=>'TargetSpecies.modifierExtension',
            'min'=>0,
            'max'=>Float::INFINITY
          },
          ##
          ...
          'withdrawalPeriod' => {
            'type'=>'MedicinalProductPharmaceutical::RouteOfAdministration::TargetSpecies::WithdrawalPeriod',
            'path'=>'TargetSpecies.withdrawalPeriod',
            'min'=>0,
            'max'=>Float::INFINITY
          }
        }
        ...
        class WithdrawalPeriod < FHIR::Model
          ...
          METADATA = {
            ...
            'extension' => {
              'type'=>'Extension',
              'path'=>'WithdrawalPeriod.extension',
              'min'=>0,
              'max'=>Float::INFINITY
            },
            ##
            ...
            'modifierExtension' => {
              'type'=>'Extension',
              'path'=>'WithdrawalPeriod.modifierExtension',
              'min'=>0,
              'max'=>Float::INFINITY
            },
            ##
            ...
            'supportingInformation' => {
              'type'=>'string',
              'path'=>'WithdrawalPeriod.supportingInformation',
              'min'=>0,
              'max'=>1
            }
          }
    ...
    ##
    # Ingredient.
    attr_accessor :ingredient                     # 0-* [ Reference(http://hl7.org/fhir/StructureDefinition/MedicinalProductIngredient) ]
    ##
    # Accompanying device.
