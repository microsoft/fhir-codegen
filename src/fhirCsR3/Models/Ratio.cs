...
namespace fhirCsR3.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<Ratio>))]
  public class Ratio : Element,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "denominator":
          Denominator = new fhirCsR3.Models.Quantity();
          Denominator.DeserializeJson(ref reader, options);
          break;

        case "numerator":
          Numerator = new fhirCsR3.Models.Quantity();
