  ...
  public class RelatedPerson : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((Photo != null) && (Photo.Count != 0))
      {
        ...
        {
          valPhoto.SerializeJson(ref writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "communication":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.RelatedPersonCommunication objCommunication = new Fhir.R4.Models.RelatedPersonCommunication();
        ...
        case "relationship":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.CodeableConcept objRelationship = new Fhir.R4.Models.CodeableConcept();
