...
namespace fhirCsR3.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<ListEntry>))]
  public class ListEntry : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_deleted":
          _Deleted = new fhirCsR3.Models.Element();
          _Deleted.DeserializeJson(ref reader, options);
          break;

        case "flag":
          Flag = new fhirCsR3.Models.CodeableConcept();
          Flag.DeserializeJson(ref reader, options);
          break;

        case "item":
          Item = new fhirCsR3.Models.Reference();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<List>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "entry":
          ...
          {
            fhirCsR3.Models.ListEntry objEntry = new fhirCsR3.Models.ListEntry();
