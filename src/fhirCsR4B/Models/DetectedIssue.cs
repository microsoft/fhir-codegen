...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<DetectedIssueEvidence>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<DetectedIssueMitigation>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<DetectedIssue>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "evidence":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.DetectedIssueEvidence objEvidence = new fhirCsR4B.Models.DetectedIssueEvidence();
        ...
        case "_identifiedDateTime":
          _IdentifiedDateTime = new fhirCsR4B.Models.Element();
          _IdentifiedDateTime.DeserializeJson(ref reader, options);
          break;

        case "identifiedPeriod":
          IdentifiedPeriod = new fhirCsR4B.Models.Period();
        ...
        case "implicated":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Reference objImplicated = new fhirCsR4B.Models.Reference();
        ...
        case "mitigation":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.DetectedIssueMitigation objMitigation = new fhirCsR4B.Models.DetectedIssueMitigation();
