...
namespace fhirCsR5.Models
{
  ...
  public class SubstanceDefinitionMoiety : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WritePropertyName("measurementType");
        MeasurementType.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "measurementType":
          MeasurementType = new fhirCsR5.Models.CodeableConcept();
          MeasurementType.DeserializeJson(ref reader, options);
          break;
  ...
  public class SubstanceDefinitionRelationship : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WritePropertyName("ratioHighLimitAmount");
        RatioHighLimitAmount.SerializeJson(writer, options);
      }

      if (Comparator != null)
      {
        writer.WritePropertyName("comparator");
        Comparator.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "comparator":
          Comparator = new fhirCsR5.Models.CodeableConcept();
          Comparator.DeserializeJson(ref reader, options);
          break;
        ...
        case "ratioHighLimitAmount":
          RatioHighLimitAmount = new fhirCsR5.Models.Ratio();
          RatioHighLimitAmount.DeserializeJson(ref reader, options);
          break;
