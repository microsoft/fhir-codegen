...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<QuestionnaireItemEnableWhen>))]
  public class QuestionnaireItemEnableWhen : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_answerBoolean":
          _AnswerBoolean = new fhirCsR4B.Models.Element();
        ...
        case "_answerDecimal":
          _AnswerDecimal = new fhirCsR4B.Models.Element();
        ...
        case "_answerInteger":
          _AnswerInteger = new fhirCsR4B.Models.Element();
        ...
        case "_answerDate":
          _AnswerDate = new fhirCsR4B.Models.Element();
        ...
        case "_answerDateTime":
          _AnswerDateTime = new fhirCsR4B.Models.Element();
        ...
        case "_answerTime":
          _AnswerTime = new fhirCsR4B.Models.Element();
        ...
        case "_answerString":
          _AnswerString = new fhirCsR4B.Models.Element();
          _AnswerString.DeserializeJson(ref reader, options);
          break;

        case "answerCoding":
          AnswerCoding = new fhirCsR4B.Models.Coding();
          AnswerCoding.DeserializeJson(ref reader, options);
          break;

        case "answerQuantity":
          AnswerQuantity = new fhirCsR4B.Models.Quantity();
          AnswerQuantity.DeserializeJson(ref reader, options);
          break;

        case "answerReference":
          AnswerReference = new fhirCsR4B.Models.Reference();
        ...
        case "_question":
          _Question = new fhirCsR4B.Models.Element();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<QuestionnaireItemAnswerOption>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_initialSelected":
          _InitialSelected = new fhirCsR4B.Models.Element();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<QuestionnaireItemInitial>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<QuestionnaireItem>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "answerOption":
          ...
          {
            fhirCsR4B.Models.QuestionnaireItemAnswerOption objAnswerOption = new fhirCsR4B.Models.QuestionnaireItemAnswerOption();
        ...
        case "_answerValueSet":
          _AnswerValueSet = new fhirCsR4B.Models.Element();
        ...
        case "_enableBehavior":
          _EnableBehavior = new fhirCsR4B.Models.Element();
        ...
        case "enableWhen":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.QuestionnaireItemEnableWhen objEnableWhen = new fhirCsR4B.Models.QuestionnaireItemEnableWhen();
        ...
        case "initial":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.QuestionnaireItemInitial objInitial = new fhirCsR4B.Models.QuestionnaireItemInitial();
        ...
        case "item":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.QuestionnaireItem objItem = new fhirCsR4B.Models.QuestionnaireItem();
        ...
        case "_readOnly":
          _ReadOnly = new fhirCsR4B.Models.Element();
        ...
        case "_repeats":
          _Repeats = new fhirCsR4B.Models.Element();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<Questionnaire>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_subjectType":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Element obj_SubjectType = new fhirCsR4B.Models.Element();
