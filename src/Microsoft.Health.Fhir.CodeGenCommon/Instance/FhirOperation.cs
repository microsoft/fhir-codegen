...
public record class FhirOperation : FhirCanonicalBase, ICloneable
{
    private OperationKindCodes _kind;
    private string _kindLiteral = string.Empty;
    ...
    public OperationKindCodes Kind { get => _kind; }

    /// <summary>Gets or initializes the kind literal.</summary>
    public required string KindLiteral
    {
        get => _kindLiteral;
        init
        {
            _kindLiteral = value;
            _kind = value.ToEnum<OperationKindCodes>() ?? OperationKindCodes.Operation;
        }
    }
