...
namespace fhirCsR3.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<BundleLink>))]
  public class BundleLink : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_relation":
          _Relation = new fhirCsR3.Models.Element();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<BundleEntrySearch>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<BundleEntryRequest>))]
  public class BundleEntryRequest : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_ifMatch":
          _IfMatch = new fhirCsR3.Models.Element();
        ...
        case "_ifModifiedSince":
          _IfModifiedSince = new fhirCsR3.Models.Element();
        ...
        case "_ifNoneExist":
          _IfNoneExist = new fhirCsR3.Models.Element();
        ...
        case "_ifNoneMatch":
          _IfNoneMatch = new fhirCsR3.Models.Element();
        ...
        case "_method":
          _Method = new fhirCsR3.Models.Element();
  ...
  /// Additional information about how this entry should be processed as part of a transaction.
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<BundleEntryResponse>))]
  public class BundleEntryResponse : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (Outcome != null)
      {
        ...
        JsonSerializer.Serialize<fhirCsR3.Models.Resource>(writer, (fhirCsR3.Models.Resource)Outcome, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_etag":
          _Etag = new fhirCsR3.Models.Element();
        ...
        case "_lastModified":
          _LastModified = new fhirCsR3.Models.Element();
        ...
        case "_location":
          _Location = new fhirCsR3.Models.Element();
          _Location.DeserializeJson(ref reader, options);
          break;

        case "outcome":
          Outcome = JsonSerializer.Deserialize<fhirCsR3.Models.Resource>(ref reader, options);
          break;
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<BundleEntry>))]
  public class BundleEntry : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_fullUrl":
          _FullUrl = new fhirCsR3.Models.Element();
        ...
        case "link":
          ...
          {
            fhirCsR3.Models.BundleLink objLink = new fhirCsR3.Models.BundleLink();
        ...
        case "request":
          Request = new fhirCsR3.Models.BundleEntryRequest();
        ...
        case "response":
          Response = new fhirCsR3.Models.BundleEntryResponse();
          Response.DeserializeJson(ref reader, options);
          break;

        case "search":
          Search = new fhirCsR3.Models.BundleEntrySearch();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<Bundle>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "entry":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.BundleEntry objEntry = new fhirCsR3.Models.BundleEntry();
        ...
        case "signature":
          Signature = new fhirCsR3.Models.Signature();
