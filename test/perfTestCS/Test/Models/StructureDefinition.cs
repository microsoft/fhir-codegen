    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "element":
          ...
          {
            Fhir.R4.Models.ElementDefinition objElement = new Fhir.R4.Models.ElementDefinition();
  ...
  public class StructureDefinition : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (_BaseDefinition != null)
      {
        ...
        _BaseDefinition.SerializeJson(ref writer, options);
      }
      ...
      if ((_ContextInvariant != null) && (_ContextInvariant.Count != 0))
      {
        ...
        {
          val_ContextInvariant.SerializeJson(ref writer, options, true);
        }
      ...
      if (_Derivation != null)
      {
        ...
        _Derivation.SerializeJson(ref writer, options);
      }
      ...
      if (Differential != null)
      {
        ...
        Differential.SerializeJson(ref writer, options);
      }
      ...
      if ((Keyword != null) && (Keyword.Count != 0))
      {
        ...
        {
          valKeyword.SerializeJson(ref writer, options, true);
        }
      ...
      if (Snapshot != null)
      {
        ...
        Snapshot.SerializeJson(ref writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_baseDefinition":
          _BaseDefinition = new Fhir.R4.Models.Element();
        ...
        case "context":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.StructureDefinitionContext objContext = new Fhir.R4.Models.StructureDefinitionContext();
        ...
        case "_contextInvariant":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.Element obj_ContextInvariant = new Fhir.R4.Models.Element();
        ...
        case "_derivation":
          _Derivation = new Fhir.R4.Models.Element();
        ...
        case "differential":
          Differential = new Fhir.R4.Models.StructureDefinitionDifferential();
        ...
        case "keyword":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.Coding objKeyword = new Fhir.R4.Models.Coding();
        ...
        case "mapping":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.StructureDefinitionMapping objMapping = new Fhir.R4.Models.StructureDefinitionMapping();
        ...
        case "snapshot":
          Snapshot = new Fhir.R4.Models.StructureDefinitionSnapshot();
