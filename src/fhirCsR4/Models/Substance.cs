...
namespace fhirCsR4.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<SubstanceInstance>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "instance":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4.Models.SubstanceInstance objInstance = new fhirCsR4.Models.SubstanceInstance();
