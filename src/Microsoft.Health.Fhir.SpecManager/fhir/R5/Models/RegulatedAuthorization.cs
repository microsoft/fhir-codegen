...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<RegulatedAuthorizationRelatedDate>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "relatedDate":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.RegulatedAuthorizationRelatedDate objRelatedDate = new fhirCsR5.Models.RegulatedAuthorizationRelatedDate();
