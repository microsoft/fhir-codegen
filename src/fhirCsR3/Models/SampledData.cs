...
namespace fhirCsR3.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<SampledData>))]
  public class SampledData : Element,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_data":
          _Data = new fhirCsR3.Models.Element();
        ...
        case "_lowerLimit":
          _LowerLimit = new fhirCsR3.Models.Element();
          _LowerLimit.DeserializeJson(ref reader, options);
          break;

        case "origin":
          Origin = new fhirCsR3.Models.Quantity();
        ...
        case "_upperLimit":
          _UpperLimit = new fhirCsR3.Models.Element();
