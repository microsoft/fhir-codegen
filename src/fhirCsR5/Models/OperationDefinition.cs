...
namespace fhirCsR5.Models
{
  ...
  public class OperationDefinitionParameter : BackboneElement,  IFhirJsonSerializable {
    ...
    /// <summary>
    /// Extension container element for AllowedType
    /// </summary>
    public List<Element> _AllowedType { get; set; }
    /// <summary>
    /// Binds to a value set if this parameter is coded (code, Coding, CodeableConcept).
    /// </summary>
    ...
    /// </summary>
    public List<Element> _Scope { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((Scope != null) && (Scope.Count != 0))
      {
        ...
        foreach (string valScope in Scope)
        {
          writer.WriteStringValue(valScope);
        }
      ...
      if ((_Scope != null) && (_Scope.Count != 0))
      {
        ...
        foreach (Element val_Scope in _Scope)
        {
          val_Scope.SerializeJson(writer, options, true);
        }
      ...
      if ((AllowedType != null) && (AllowedType.Count != 0))
      {
        writer.WritePropertyName("allowedType");
        writer.WriteStartArray();

        foreach (string valAllowedType in AllowedType)
        {
          writer.WriteStringValue(valAllowedType);
        }

        writer.WriteEndArray();
      }

      if ((_AllowedType != null) && (_AllowedType.Count != 0))
      {
        writer.WritePropertyName("_allowedType");
        writer.WriteStartArray();

        foreach (Element val_AllowedType in _AllowedType)
        {
          val_AllowedType.SerializeJson(writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "allowedType":
          ...
          {
            AllowedType.Add(reader.GetString());
        ...
        case "_allowedType":
          ...
          _AllowedType = new List<Element>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Element obj_AllowedType = new fhirCsR5.Models.Element();
            obj_AllowedType.DeserializeJson(ref reader, options);
            _AllowedType.Add(obj_AllowedType);
        ...
        case "_scope":
          ...
          _Scope = new List<Element>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Element obj_Scope = new fhirCsR5.Models.Element();
            obj_Scope.DeserializeJson(ref reader, options);
            _Scope.Add(obj_Scope);
  ...
  /// <summary>
  /// Code Values for the OperationDefinition.parameter.scope field
  /// </summary>
  public static class OperationDefinitionParameterScopeCodes {
