...
namespace fhirCsR3.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<Endpoint>))]
  public class Endpoint : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "connectionType":
          ConnectionType = new fhirCsR3.Models.Coding();
        ...
        case "_payloadMimeType":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.Element obj_PayloadMimeType = new fhirCsR3.Models.Element();
        ...
        case "payloadType":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.CodeableConcept objPayloadType = new fhirCsR3.Models.CodeableConcept();
