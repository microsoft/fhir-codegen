...
public class Timing_30_50 : ICrossVersionProcessor<Timing>, ICrossVersionExtractor<Timing>
{
	private Converter_30_50 _converter;
	internal Timing_30_50(Converter_30_50 converter)
	{
	...
	public void Process(ISourceNode node, Timing current)
	{
		switch (node.Name)
		{
			...
			case "repeat":
				current.Repeat = Extract30TimingRepeatComponent(node);
				break;
	...
	private Timing.RepeatComponent Extract30TimingRepeatComponent(ISourceNode parent)
	{
