...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<MessageDefinitionFocus>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<MessageDefinitionAllowedResponse>))]
  public class MessageDefinitionAllowedResponse : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_situation":
          _Situation = new fhirCsR4B.Models.Element();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<MessageDefinition>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "allowedResponse":
          ...
          {
            fhirCsR4B.Models.MessageDefinitionAllowedResponse objAllowedResponse = new fhirCsR4B.Models.MessageDefinitionAllowedResponse();
        ...
        case "focus":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.MessageDefinitionFocus objFocus = new fhirCsR4B.Models.MessageDefinitionFocus();
        ...
        case "_graph":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Element obj_Graph = new fhirCsR4B.Models.Element();
        ...
        case "_parent":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Element obj_Parent = new fhirCsR4B.Models.Element();
        ...
        case "_responseRequired":
          _ResponseRequired = new fhirCsR4B.Models.Element();
