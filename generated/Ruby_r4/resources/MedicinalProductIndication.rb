module FHIR
  ...
  class MedicinalProductIndication < FHIR::Model
    ...
    METADATA = {
      ...
      'otherTherapy' => {
        'type'=>'MedicinalProductIndication::OtherTherapy',
      ...
      'undesirableEffect' => {
        'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/MedicinalProductUndesirableEffect'],
        'type'=>'Reference',
    ...
    ##
    # Describe the undesirable effects of the medicinal product.
    attr_accessor :undesirableEffect              # 0-* [ Reference(http://hl7.org/fhir/StructureDefinition/MedicinalProductUndesirableEffect) ]
    ##
    # The population group to which this applies.
