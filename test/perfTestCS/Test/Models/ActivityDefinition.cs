  ...
  public class ActivityDefinition : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((ObservationRequirement != null) && (ObservationRequirement.Count != 0))
      {
        ...
        {
          valObservationRequirement.SerializeJson(ref writer, options, true);
        }
      ...
      if ((ObservationResultRequirement != null) && (ObservationResultRequirement.Count != 0))
      {
        ...
        {
          valObservationResultRequirement.SerializeJson(ref writer, options, true);
        }
      ...
      if ((SpecimenRequirement != null) && (SpecimenRequirement.Count != 0))
      {
        ...
        {
          valSpecimenRequirement.SerializeJson(ref writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "dynamicValue":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.ActivityDefinitionDynamicValue objDynamicValue = new Fhir.R4.Models.ActivityDefinitionDynamicValue();
        ...
        case "observationRequirement":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.Reference objObservationRequirement = new Fhir.R4.Models.Reference();
        ...
        case "observationResultRequirement":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.Reference objObservationResultRequirement = new Fhir.R4.Models.Reference();
        ...
        case "participant":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.ActivityDefinitionParticipant objParticipant = new Fhir.R4.Models.ActivityDefinitionParticipant();
        ...
        case "specimenRequirement":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.Reference objSpecimenRequirement = new Fhir.R4.Models.Reference();
