  ...
  public class ImagingStudySeries : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "modality":
          Modality = new fhirCsR5.Models.CodeableConcept();
  ...
  public class ImagingStudy : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((Modality != null) && (Modality.Count != 0))
      {
        ...
        foreach (CodeableConcept valModality in Modality)
        {
      ...
      if ((Procedure != null) && (Procedure.Count != 0))
      {
        ...
        foreach (CodeableReference valProcedure in Procedure)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "modality":
          ...
          Modality = new List<CodeableConcept>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.CodeableConcept objModality = new fhirCsR5.Models.CodeableConcept();
        ...
        case "procedure":
          ...
          Procedure = new List<CodeableReference>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.CodeableReference objProcedure = new fhirCsR5.Models.CodeableReference();
