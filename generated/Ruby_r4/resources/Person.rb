module FHIR
  ...
  class Person < FHIR::Model
    ...
    SEARCH_PARAMS = ['address-city', 'address-country', 'address-postalcode', 'address-state', 'address-use', 'address', 'birthdate', 'email', 'gender', 'identifier', 'link', 'name', 'organization', 'patient', 'phone', 'phonetic', 'practitioner', 'relatedperson', 'telecom']
    METADATA = {
      ##
    ...
    class Link < FHIR::Model
      ...
      METADATA = {
        ...
        'target' => {
          'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Patient', 'http://hl7.org/fhir/StructureDefinition/Practitioner', 'http://hl7.org/fhir/StructureDefinition/RelatedPerson', 'http://hl7.org/fhir/StructureDefinition/Person'],
          'type'=>'Reference',
          'path'=>'Link.target',
          'min'=>1,
          'max'=>1
        ...
        'assurance' => {
          ...
          'min'=>0,
          'max'=>1,
          'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/identity-assuranceLevel'}
        }
      }
      ##
      # Unique id for inter-element referencing
      ...
      ##
      # The resource to which this actual person is associated.
      attr_accessor :target                         # 1-1 Reference(http://hl7.org/fhir/StructureDefinition/Patient|http://hl7.org/fhir/StructureDefinition/Practitioner|http://hl7.org/fhir/StructureDefinition/RelatedPerson|http://hl7.org/fhir/StructureDefinition/Person)
      ##
      # level1 | level2 | level3 | level4
      # Level of assurance that this link is associated with the target resource.
