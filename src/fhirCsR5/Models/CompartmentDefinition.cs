...
namespace fhirCsR5.Models
{
  ...
  public class CompartmentDefinitionResource : BackboneElement,  IFhirJsonSerializable {
    ...
    /// <summary>
    /// Extension container element for EndParam
    /// </summary>
    public Element _EndParam { get; set; }
    /// <summary>
    ...
    /// <summary>
    /// Extension container element for StartParam
    /// </summary>
    public Element _StartParam { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WriteString("startParam", (string)StartParam!);
      }

      if (_StartParam != null)
      {
        writer.WritePropertyName("_startParam");
        _StartParam.SerializeJson(writer, options);
      }

      if (!string.IsNullOrEmpty(EndParam))
      {
        writer.WriteString("endParam", (string)EndParam!);
      }

      if (_EndParam != null)
      {
        writer.WritePropertyName("_endParam");
        _EndParam.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "endParam":
          EndParam = reader.GetString();
          break;

        case "_endParam":
          _EndParam = new fhirCsR5.Models.Element();
          _EndParam.DeserializeJson(ref reader, options);
          break;
        ...
        case "startParam":
          StartParam = reader.GetString();
          break;

        case "_startParam":
          _StartParam = new fhirCsR5.Models.Element();
          _StartParam.DeserializeJson(ref reader, options);
          break;
