...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<InvoiceParticipant>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<InvoiceLineItemPriceComponent>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<InvoiceLineItem>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "chargeItemReference":
          ChargeItemReference = new fhirCsR4B.Models.Reference();
          ChargeItemReference.DeserializeJson(ref reader, options);
          break;

        case "chargeItemCodeableConcept":
          ChargeItemCodeableConcept = new fhirCsR4B.Models.CodeableConcept();
        ...
        case "priceComponent":
          ...
          {
            fhirCsR4B.Models.InvoiceLineItemPriceComponent objPriceComponent = new fhirCsR4B.Models.InvoiceLineItemPriceComponent();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<Invoice>))]
  public class Invoice : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "account":
          Account = new fhirCsR4B.Models.Reference();
        ...
        case "_cancelledReason":
          _CancelledReason = new fhirCsR4B.Models.Element();
        ...
        case "issuer":
          Issuer = new fhirCsR4B.Models.Reference();
        ...
        case "lineItem":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.InvoiceLineItem objLineItem = new fhirCsR4B.Models.InvoiceLineItem();
        ...
        case "participant":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.InvoiceParticipant objParticipant = new fhirCsR4B.Models.InvoiceParticipant();
        ...
        case "_paymentTerms":
          _PaymentTerms = new fhirCsR4B.Models.Element();
        ...
        case "totalGross":
          TotalGross = new fhirCsR4B.Models.Money();
          TotalGross.DeserializeJson(ref reader, options);
          break;

        case "totalNet":
          TotalNet = new fhirCsR4B.Models.Money();
        ...
        case "totalPriceComponent":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.InvoiceLineItemPriceComponent objTotalPriceComponent = new fhirCsR4B.Models.InvoiceLineItemPriceComponent();
