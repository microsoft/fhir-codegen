    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "additionalInstruction":
          ...
          {
            Fhir.R4.Models.CodeableConcept objAdditionalInstruction = new Fhir.R4.Models.CodeableConcept();
        ...
        case "doseAndRate":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.DosageDoseAndRate objDoseAndRate = new Fhir.R4.Models.DosageDoseAndRate();
        ...
        case "maxDosePerAdministration":
          MaxDosePerAdministration = new Fhir.R4.Models.Quantity();
          MaxDosePerAdministration.DeserializeJson(ref reader, options);
          break;

        case "maxDosePerLifetime":
          MaxDosePerLifetime = new Fhir.R4.Models.Quantity();
          MaxDosePerLifetime.DeserializeJson(ref reader, options);
          break;

        case "maxDosePerPeriod":
          MaxDosePerPeriod = new Fhir.R4.Models.Ratio();
        ...
        case "timing":
          Timing = new Fhir.R4.Models.Timing();
