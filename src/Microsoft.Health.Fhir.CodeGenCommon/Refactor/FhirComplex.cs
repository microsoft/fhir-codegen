...
public record class FhirComplex : FhirDefinitionBase
{
    ...
    public record class ExtensionContext
    {
        ...
        public required string FhirContextType
        {
            get => _fhirContextType;
            init
            {
                _fhirContextType = value;
                if (_fhirContextType.TryFhirEnum(out ExtensionContextTypeCodes v))
                {
                    _extensionContextType = v;
                }
            }
        }
