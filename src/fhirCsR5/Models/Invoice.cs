...
namespace fhirCsR5.Models
{
  ...
  public class InvoiceLineItem : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((PriceComponent != null) && (PriceComponent.Count != 0))
      {
        ...
        foreach (MonetaryComponent valPriceComponent in PriceComponent)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "priceComponent":
          ...
          PriceComponent = new List<MonetaryComponent>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.MonetaryComponent objPriceComponent = new fhirCsR5.Models.MonetaryComponent();
  ...
  public class Invoice : DomainResource,  IFhirJsonSerializable {
    ...
    /// <summary>
    /// Extension container element for PeriodDate
    /// </summary>
    public Element _PeriodDate { get; set; }
    /// <summary>
    /// Date/time(s) range of services included in this invoice.
    /// </summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WriteString("periodDate", (string)PeriodDate!);
      }

      if (_PeriodDate != null)
      {
        writer.WritePropertyName("_periodDate");
        _PeriodDate.SerializeJson(writer, options);
      }

      if (PeriodPeriod != null)
      {
        writer.WritePropertyName("periodPeriod");
        PeriodPeriod.SerializeJson(writer, options);
      }
      ...
      if ((TotalPriceComponent != null) && (TotalPriceComponent.Count != 0))
      {
        ...
        foreach (MonetaryComponent valTotalPriceComponent in TotalPriceComponent)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "periodDate":
          PeriodDate = reader.GetString();
          break;

        case "_periodDate":
          _PeriodDate = new fhirCsR5.Models.Element();
          _PeriodDate.DeserializeJson(ref reader, options);
          break;

        case "periodPeriod":
          PeriodPeriod = new fhirCsR5.Models.Period();
          PeriodPeriod.DeserializeJson(ref reader, options);
          break;
        ...
        case "totalPriceComponent":
          ...
          TotalPriceComponent = new List<MonetaryComponent>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.MonetaryComponent objTotalPriceComponent = new fhirCsR5.Models.MonetaryComponent();
