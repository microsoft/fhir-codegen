...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ConsentPolicyBasis>))]
  public class ConsentPolicyBasis : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  public class Consent : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((RegulatoryBasis != null) && (RegulatoryBasis.Count != 0))
      {
        writer.WritePropertyName("regulatoryBasis");
        writer.WriteStartArray();

        foreach (CodeableConcept valRegulatoryBasis in RegulatoryBasis)
        {
          valRegulatoryBasis.SerializeJson(writer, options, true);
        }
      ...
      if (PolicyBasis != null)
      {
        writer.WritePropertyName("policyBasis");
        PolicyBasis.SerializeJson(writer, options);
      }

      if ((PolicyText != null) && (PolicyText.Count != 0))
      {
        writer.WritePropertyName("policyText");
        writer.WriteStartArray();

        foreach (Reference valPolicyText in PolicyText)
        {
          valPolicyText.SerializeJson(writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "policyBasis":
          PolicyBasis = new fhirCsR5.Models.ConsentPolicyBasis();
          PolicyBasis.DeserializeJson(ref reader, options);
          break;
        ...
        case "policyText":
          ...
          PolicyText = new List<Reference>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Reference objPolicyText = new fhirCsR5.Models.Reference();
            objPolicyText.DeserializeJson(ref reader, options);
            PolicyText.Add(objPolicyText);
        ...
        case "regulatoryBasis":
          ...
          RegulatoryBasis = new List<CodeableConcept>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.CodeableConcept objRegulatoryBasis = new fhirCsR5.Models.CodeableConcept();
            objRegulatoryBasis.DeserializeJson(ref reader, options);
            RegulatoryBasis.Add(objRegulatoryBasis);
