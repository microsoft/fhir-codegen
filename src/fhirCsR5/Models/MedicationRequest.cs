...
namespace fhirCsR5.Models
{
  ...
  public class MedicationRequestDose : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WritePropertyName("effectiveDosePeriod");
        EffectiveDosePeriod.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "effectiveDosePeriod":
          EffectiveDosePeriod = new fhirCsR5.Models.Period();
          EffectiveDosePeriod.DeserializeJson(ref reader, options);
          break;
