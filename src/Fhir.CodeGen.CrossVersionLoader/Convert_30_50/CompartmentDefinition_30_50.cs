...
public class CompartmentDefinition_30_50 : ICrossVersionProcessor<CompartmentDefinition>, ICrossVersionExtractor<CompartmentDefinition>
{
	private Converter_30_50 _converter;
	internal CompartmentDefinition_30_50(Converter_30_50 converter)
	{
	...
	public void Process(ISourceNode node, CompartmentDefinition current)
	{
		switch (node.Name)
		{
			...
			case "resource":
				current.Resource.Add(Extract30CompartmentDefinitionResourceComponent(node));
				break;
	...
	private CompartmentDefinition.ResourceComponent Extract30CompartmentDefinitionResourceComponent(ISourceNode parent)
	{
