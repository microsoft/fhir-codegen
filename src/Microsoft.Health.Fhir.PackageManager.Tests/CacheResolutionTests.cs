...
public class CacheResolutionTests : IClassFixture<CacheResolutionTestFixture>
{
    ...
    [InlineData("hl7.fhir.r4.core#dev", true, "hl7.fhir.r4.core#current")]
    [InlineData("hl7.fhir.r5#dev", true, "hl7.fhir.r5.core#current")]
    [InlineData("hl7.fhir.r5.core#current", true, "hl7.fhir.r5.core#current")]     // core builds are not in QAS
    [InlineData("hl7.fhir.r5#current", true, "hl7.fhir.r5.core#current")]
    [InlineData("hl7.fhir.r5.core#current$branch", true, "hl7.fhir.r5.core#current$branch")]
    [InlineData("hl7.fhir.r5.core#current$notExistantbranch", false)]
    [InlineData("hl7.fhir.r5#current$branch", true, "hl7.fhir.r5.core#current$branch")]
