...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<CoverageClass>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<CoverageCostToBeneficiaryException>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<CoverageCostToBeneficiary>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "exception":
          ...
          {
            fhirCsR4B.Models.CoverageCostToBeneficiaryException objException = new fhirCsR4B.Models.CoverageCostToBeneficiaryException();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<Coverage>))]
  public class Coverage : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "beneficiary":
          Beneficiary = new fhirCsR4B.Models.Reference();
        ...
        case "class":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.CoverageClass objClass = new fhirCsR4B.Models.CoverageClass();
        ...
        case "contract":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Reference objContract = new fhirCsR4B.Models.Reference();
        ...
        case "costToBeneficiary":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.CoverageCostToBeneficiary objCostToBeneficiary = new fhirCsR4B.Models.CoverageCostToBeneficiary();
        ...
        case "_dependent":
          _Dependent = new fhirCsR4B.Models.Element();
        ...
        case "_network":
          _Network = new fhirCsR4B.Models.Element();
        ...
        case "payor":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Reference objPayor = new fhirCsR4B.Models.Reference();
        ...
        case "policyHolder":
          PolicyHolder = new fhirCsR4B.Models.Reference();
        ...
        case "_subrogation":
          _Subrogation = new fhirCsR4B.Models.Element();
          _Subrogation.DeserializeJson(ref reader, options);
          break;

        case "subscriber":
          Subscriber = new fhirCsR4B.Models.Reference();
        ...
        case "_subscriberId":
          _SubscriberId = new fhirCsR4B.Models.Element();
