...
public class DataRequirement_30_50 : ICrossVersionProcessor<DataRequirement>, ICrossVersionExtractor<DataRequirement>
{
	private Converter_30_50 _converter;
	internal DataRequirement_30_50(Converter_30_50 converter)
	{
	...
	public void Process(ISourceNode node, DataRequirement current)
	{
		switch (node.Name)
		{
			...
			case "codeFilter":
				current.CodeFilter.Add(Extract30DataRequirementCodeFilterComponent(node));
				break;

			case "dateFilter":
				current.DateFilter.Add(Extract30DataRequirementDateFilterComponent(node));
				break;
	...
	private DataRequirement.CodeFilterComponent Extract30DataRequirementCodeFilterComponent(ISourceNode parent)
	{
	...
	private DataRequirement.DateFilterComponent Extract30DataRequirementDateFilterComponent(ISourceNode parent)
	{
