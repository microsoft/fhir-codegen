...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<AllergyIntoleranceParticipant>))]
  public class AllergyIntoleranceParticipant : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  public class AllergyIntolerance : DomainResource,  IFhirJsonSerializable {
    ...
    /// Indicates who or what participated in the activities related to the allergy or intolerance and how they were involved.
    /// </summary>
    public List<AllergyIntoleranceParticipant> Participant { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((Participant != null) && (Participant.Count != 0))
      {
        ...
        foreach (AllergyIntoleranceParticipant valParticipant in Participant)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "participant":
          ...
          Participant = new List<AllergyIntoleranceParticipant>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.AllergyIntoleranceParticipant objParticipant = new fhirCsR5.Models.AllergyIntoleranceParticipant();
