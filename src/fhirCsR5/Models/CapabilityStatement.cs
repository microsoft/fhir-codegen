...
namespace fhirCsR5.Models
{
  ...
  public class CapabilityStatementRestResource : BackboneElement,  IFhirJsonSerializable {
    ...
    /// </summary>
    public bool? ConditionalPatch { get; set; }
    /// <summary>
    /// Extension container element for ConditionalPatch
    /// </summary>
    public Element _ConditionalPatch { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WriteBoolean("conditionalPatch", (bool)ConditionalPatch!);
      }

      if (_ConditionalPatch != null)
      {
        writer.WritePropertyName("_conditionalPatch");
        _ConditionalPatch.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "conditionalPatch":
          ConditionalPatch = reader.GetBoolean();
          break;

        case "_conditionalPatch":
          _ConditionalPatch = new fhirCsR5.Models.Element();
          _ConditionalPatch.DeserializeJson(ref reader, options);
          break;
  ...
  public class CapabilityStatement : DomainResource,  IFhirJsonSerializable {
    ...
    /// <summary>
    /// In general, if a server gets a request with an Accept-Language that it doesn't support, it should still reutrn the resource, just in it's default language for the resource.
    /// </summary>
    public List<string> AcceptLanguage { get; set; }
    /// <summary>
    /// Extension container element for AcceptLanguage
    /// </summary>
    public List<Element> _AcceptLanguage { get; set; }
    /// <summary>
    ...
    /// <summary>
    /// Note: this is primarily only relevant in terms of ImplementationGuides that don't define specific CapabilityStatements declaring the expectation of distinct roles.  (E.g. generic IGs that establish privacy policies.)  If CapabilityStatements are defined by the IG, then it is better to use CapabilityStatement.instantiates to identify the specific role(s) supported.
    /// </summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((AcceptLanguage != null) && (AcceptLanguage.Count != 0))
      {
        ...
        foreach (string valAcceptLanguage in AcceptLanguage)
        {
          writer.WriteStringValue(valAcceptLanguage);
        }

        writer.WriteEndArray();
      }

      if ((_AcceptLanguage != null) && (_AcceptLanguage.Count != 0))
      {
        writer.WritePropertyName("_acceptLanguage");
        writer.WriteStartArray();

        foreach (Element val_AcceptLanguage in _AcceptLanguage)
        {
          val_AcceptLanguage.SerializeJson(writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "acceptLanguage":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            AcceptLanguage.Add(reader.GetString());
        ...
        case "_acceptLanguage":
          ...
          _AcceptLanguage = new List<Element>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Element obj_AcceptLanguage = new fhirCsR5.Models.Element();
            obj_AcceptLanguage.DeserializeJson(ref reader, options);
            _AcceptLanguage.Add(obj_AcceptLanguage);
  ...
  public static class CapabilityStatementFormatCodes {
    ...
    public const string APPLICATION_FHIR_PLUS_JSON = "application/fhir+json";
    public const string APPLICATION_FHIR_PLUS_XML = "application/fhir+xml";
    public const string APPLICATION_FHIR_PLUS_TTL = "application/fhir+ttl";
    public static HashSet<string> Values = new HashSet<string>() {
      "xml",
      "json",
      "ttl",
