...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<HumanName>))]
  public class HumanName : Element,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_family":
          _Family = new fhirCsR4B.Models.Element();
        ...
        case "_given":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Element obj_Given = new fhirCsR4B.Models.Element();
        ...
        case "_prefix":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Element obj_Prefix = new fhirCsR4B.Models.Element();
        ...
        case "_suffix":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Element obj_Suffix = new fhirCsR4B.Models.Element();
