  ...
  public class Bundle : Resource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (Issues != null)
      {
        ...
        JsonSerializer.Serialize<fhirCsR5.Models.Resource>(writer, (fhirCsR5.Models.Resource)Issues, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "issues":
          Issues = JsonSerializer.Deserialize<fhirCsR5.Models.Resource>(ref reader, options);
          break;
