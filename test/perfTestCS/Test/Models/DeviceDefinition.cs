...
namespace Fhir.R4.Models
{
  ...
  public class DeviceDefinitionSpecialization : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      writer.WriteString("systemType", SystemType);

      if (_SystemType != null)
      {
        writer.WritePropertyName("_systemType");
        _SystemType.SerializeJson(ref writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_systemType":
          _SystemType = new Fhir.R4.Models.Element();
  ...
  public class DeviceDefinitionCapability : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((Description != null) && (Description.Count != 0))
      {
        ...
        {
          valDescription.SerializeJson(ref writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "description":
          ...
          {
            Fhir.R4.Models.CodeableConcept objDescription = new Fhir.R4.Models.CodeableConcept();
  ...
  public class DeviceDefinition : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((LanguageCode != null) && (LanguageCode.Count != 0))
      {
        ...
        {
          valLanguageCode.SerializeJson(ref writer, options, true);
        }

        writer.WriteEndArray();
      }

      writer.WriteString("manufacturerString", ManufacturerString);

      if (_ManufacturerString != null)
      {
        writer.WritePropertyName("_manufacturerString");
        _ManufacturerString.SerializeJson(ref writer, options);
      }

      if (ManufacturerReference != null)
      {
        writer.WritePropertyName("manufacturerReference");
        ManufacturerReference.SerializeJson(ref writer, options);
      }
      ...
      writer.WriteString("onlineInformation", OnlineInformation);

      if (_OnlineInformation != null)
      {
        writer.WritePropertyName("_onlineInformation");
        _OnlineInformation.SerializeJson(ref writer, options);
      }
      ...
      if (ParentDevice != null)
      {
        ...
        ParentDevice.SerializeJson(ref writer, options);
      }
      ...
      if ((UdiDeviceIdentifier != null) && (UdiDeviceIdentifier.Count != 0))
      {
        ...
        {
          valUdiDeviceIdentifier.SerializeJson(ref writer, options, true);
        }
      ...
      if ((_Version != null) && (_Version.Count != 0))
      {
        ...
        {
          val_Version.SerializeJson(ref writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "capability":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.DeviceDefinitionCapability objCapability = new Fhir.R4.Models.DeviceDefinitionCapability();
        ...
        case "deviceName":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.DeviceDefinitionDeviceName objDeviceName = new Fhir.R4.Models.DeviceDefinitionDeviceName();
        ...
        case "languageCode":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.CodeableConcept objLanguageCode = new Fhir.R4.Models.CodeableConcept();
        ...
        case "_manufacturerString":
          _ManufacturerString = new Fhir.R4.Models.Element();
          _ManufacturerString.DeserializeJson(ref reader, options);
          break;

        case "manufacturerReference":
          ManufacturerReference = new Fhir.R4.Models.Reference();
        ...
        case "material":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.DeviceDefinitionMaterial objMaterial = new Fhir.R4.Models.DeviceDefinitionMaterial();
        ...
        case "_onlineInformation":
          _OnlineInformation = new Fhir.R4.Models.Element();
        ...
        case "parentDevice":
          ParentDevice = new Fhir.R4.Models.Reference();
        ...
        case "property":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.DeviceDefinitionProperty objProperty = new Fhir.R4.Models.DeviceDefinitionProperty();
        ...
        case "specialization":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.DeviceDefinitionSpecialization objSpecialization = new Fhir.R4.Models.DeviceDefinitionSpecialization();
        ...
        case "udiDeviceIdentifier":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.DeviceDefinitionUdiDeviceIdentifier objUdiDeviceIdentifier = new Fhir.R4.Models.DeviceDefinitionUdiDeviceIdentifier();
        ...
        case "_version":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.Element obj_Version = new Fhir.R4.Models.Element();
