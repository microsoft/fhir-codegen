...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<Library>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "content":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Attachment objContent = new fhirCsR4B.Models.Attachment();
        ...
        case "parameter":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.ParameterDefinition objParameter = new fhirCsR4B.Models.ParameterDefinition();
