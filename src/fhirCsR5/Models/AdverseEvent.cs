...
namespace fhirCsR5.Models
{
  ...
  public class AdverseEvent : DomainResource,  IFhirJsonSerializable {
    ...
    /// </summary>
    public bool? ExpectedInResearchStudy { get; set; }
    /// <summary>
    /// Extension container element for ExpectedInResearchStudy
    /// </summary>
    public Element _ExpectedInResearchStudy { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WriteBoolean("expectedInResearchStudy", (bool)ExpectedInResearchStudy!);
      }

      if (_ExpectedInResearchStudy != null)
      {
        writer.WritePropertyName("_expectedInResearchStudy");
        _ExpectedInResearchStudy.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "expectedInResearchStudy":
          ExpectedInResearchStudy = reader.GetBoolean();
          break;

        case "_expectedInResearchStudy":
          _ExpectedInResearchStudy = new fhirCsR5.Models.Element();
          _ExpectedInResearchStudy.DeserializeJson(ref reader, options);
          break;
