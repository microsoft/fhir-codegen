module FHIR
  ...
  class EnrollmentRequest < FHIR::Model
    ...
    # The subject to be enrolled
    # Patient Resource.
    attr_accessor :candidate                      # 0-1 Reference(http://hl7.org/fhir/StructureDefinition/Patient)
    ##
    # Insurance information
    # Reference to the program or plan identification, underwriter or payor.
    attr_accessor :coverage                       # 0-1 Reference(http://hl7.org/fhir/StructureDefinition/Coverage)
