...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<Address>))]
  public class Address : Element,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_city":
          _City = new fhirCsR4B.Models.Element();
        ...
        case "_country":
          _Country = new fhirCsR4B.Models.Element();
        ...
        case "_district":
          _District = new fhirCsR4B.Models.Element();
        ...
        case "_line":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Element obj_Line = new fhirCsR4B.Models.Element();
        ...
        case "_postalCode":
          _PostalCode = new fhirCsR4B.Models.Element();
