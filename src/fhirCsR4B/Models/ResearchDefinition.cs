...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<ResearchDefinition>))]
  public class ResearchDefinition : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "exposure":
          Exposure = new fhirCsR4B.Models.Reference();
          Exposure.DeserializeJson(ref reader, options);
          break;

        case "exposureAlternative":
          ExposureAlternative = new fhirCsR4B.Models.Reference();
        ...
        case "outcome":
          Outcome = new fhirCsR4B.Models.Reference();
          Outcome.DeserializeJson(ref reader, options);
          break;

        case "population":
          Population = new fhirCsR4B.Models.Reference();
