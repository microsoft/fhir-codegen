...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<BiologicallyDerivedProductProcessing>))]
  public class BiologicallyDerivedProductProcessing : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "additive":
          Additive = new fhirCsR5.Models.Reference();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<BiologicallyDerivedProductManipulation>))]
  ...
  /// Product storage.
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<BiologicallyDerivedProductStorage>))]
  public class BiologicallyDerivedProductStorage : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "duration":
          Duration = new fhirCsR5.Models.Period();
        ...
        case "_scale":
          _Scale = new fhirCsR5.Models.Element();
        ...
        case "_temperature":
          _Temperature = new fhirCsR5.Models.Element();
  ...
  public class BiologicallyDerivedProduct : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "manipulation":
          Manipulation = new fhirCsR5.Models.BiologicallyDerivedProductManipulation();
        ...
        case "processing":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.BiologicallyDerivedProductProcessing objProcessing = new fhirCsR5.Models.BiologicallyDerivedProductProcessing();
        ...
        case "storage":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.BiologicallyDerivedProductStorage objStorage = new fhirCsR5.Models.BiologicallyDerivedProductStorage();
