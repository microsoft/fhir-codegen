...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<DiagnosticReportSupportingInfo>))]
  public class DiagnosticReportSupportingInfo : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  public class DiagnosticReport : DomainResource,  IFhirJsonSerializable {
    ...
    /// This backbone element contains supporting information that was used in the creation of the report not included in the results already included in the report.
    /// </summary>
    public List<DiagnosticReportSupportingInfo> SupportingInfo { get; set; }
    /// <summary>
    /// Serialize to a JSON object
    /// </summary>
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((SupportingInfo != null) && (SupportingInfo.Count != 0))
      {
        ...
        foreach (DiagnosticReportSupportingInfo valSupportingInfo in SupportingInfo)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "supportingInfo":
          ...
          SupportingInfo = new List<DiagnosticReportSupportingInfo>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.DiagnosticReportSupportingInfo objSupportingInfo = new fhirCsR5.Models.DiagnosticReportSupportingInfo();
