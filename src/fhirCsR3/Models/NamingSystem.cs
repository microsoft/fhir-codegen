...
namespace fhirCsR3.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<NamingSystemUniqueId>))]
  public class NamingSystemUniqueId : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_preferred":
          _Preferred = new fhirCsR3.Models.Element();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<NamingSystem>))]
  public class NamingSystem : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "replacedBy":
          ReplacedBy = new fhirCsR3.Models.Reference();
        ...
        case "uniqueId":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.NamingSystemUniqueId objUniqueId = new fhirCsR3.Models.NamingSystemUniqueId();
