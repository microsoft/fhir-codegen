...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ServiceRequest>))]
  public class ServiceRequest : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((Location != null) && (Location.Count != 0))
      {
        ...
        foreach (CodeableReference valLocation in Location)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "location":
          ...
          Location = new List<CodeableReference>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.CodeableReference objLocation = new fhirCsR5.Models.CodeableReference();
        ...
        case "orderDetail":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.CodeableConcept objOrderDetail = new fhirCsR5.Models.CodeableConcept();
        ...
        case "quantityQuantity":
          QuantityQuantity = new fhirCsR5.Models.Quantity();
          QuantityQuantity.DeserializeJson(ref reader, options);
          break;

        case "quantityRatio":
          QuantityRatio = new fhirCsR5.Models.Ratio();
          QuantityRatio.DeserializeJson(ref reader, options);
          break;

        case "quantityRange":
          QuantityRange = new fhirCsR5.Models.Range();
        ...
        case "requisition":
          Requisition = new fhirCsR5.Models.Identifier();
