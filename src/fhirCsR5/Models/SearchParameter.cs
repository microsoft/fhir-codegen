...
namespace fhirCsR5.Models
{
  ...
  public class SearchParameter : DomainResource,  IFhirJsonSerializable {
    ...
    /// <summary>
    /// Extension container element for Constraint
    /// </summary>
    ...
    /// <summary>
    /// Extension container element for ProcessingMode
    /// </summary>
    public Element _ProcessingMode { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WriteString("processingMode", (string)ProcessingMode!);
      }

      if (_ProcessingMode != null)
      {
        writer.WritePropertyName("_processingMode");
        _ProcessingMode.SerializeJson(writer, options);
      }

      if (!string.IsNullOrEmpty(Constraint))
      {
        writer.WriteString("constraint", (string)Constraint!);
      }

      if (_Constraint != null)
      {
        writer.WritePropertyName("_constraint");
        _Constraint.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "constraint":
          Constraint = reader.GetString();
          break;

        case "_constraint":
          _Constraint = new fhirCsR5.Models.Element();
          _Constraint.DeserializeJson(ref reader, options);
          break;
        ...
        case "processingMode":
          ProcessingMode = reader.GetString();
          break;

        case "_processingMode":
          _ProcessingMode = new fhirCsR5.Models.Element();
          _ProcessingMode.DeserializeJson(ref reader, options);
          break;
  ...
  public static class SearchParameterModifierCodes {
    ...
    public const string CODE_TEXT = "code-text";
    public const string TEXT_ADVANCED = "text-advanced";
  ...
  /// <summary>
  /// Code Values for the SearchParameter.processingMode field
  /// </summary>
  public static class SearchParameterProcessingModeCodes {
