...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<ProdCharacteristic>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_color":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Element obj_Color = new fhirCsR4B.Models.Element();
        ...
        case "depth":
          Depth = new fhirCsR4B.Models.Quantity();
          Depth.DeserializeJson(ref reader, options);
          break;

        case "externalDiameter":
          ExternalDiameter = new fhirCsR4B.Models.Quantity();
          ExternalDiameter.DeserializeJson(ref reader, options);
          break;

        case "height":
          Height = new fhirCsR4B.Models.Quantity();
        ...
        case "_imprint":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Element obj_Imprint = new fhirCsR4B.Models.Element();
        ...
        case "nominalVolume":
          NominalVolume = new fhirCsR4B.Models.Quantity();
        ...
        case "_shape":
          _Shape = new fhirCsR4B.Models.Element();
          _Shape.DeserializeJson(ref reader, options);
          break;

        case "weight":
          Weight = new fhirCsR4B.Models.Quantity();
          Weight.DeserializeJson(ref reader, options);
          break;

        case "width":
          Width = new fhirCsR4B.Models.Quantity();
