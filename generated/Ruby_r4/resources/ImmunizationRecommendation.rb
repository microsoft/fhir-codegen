  ...
  class ImmunizationRecommendation < FHIR::Model
    ...
    class Recommendation < FHIR::Model
      ...
      METADATA = {
        ...
        'modifierExtension' => {
          'type'=>'Extension',
          'path'=>'Recommendation.modifierExtension',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
        ...
        'contraindicatedVaccineCode' => {
          'type'=>'CodeableConcept',
          'path'=>'Recommendation.contraindicatedVaccineCode',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
        ...
        'forecastStatus' => {
          'valid_codes'=>{
            'http://terminology.hl7.org/CodeSystem/immunization-recommendation-status'=>[ 'due', 'overdue', 'immune', 'contraindicated', 'complete' ]
          },
          'type'=>'CodeableConcept',
          'path'=>'Recommendation.forecastStatus',
          'min'=>1,
          'max'=>1,
          'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/immunization-recommendation-status'}
        },
        ##
        ...
        'forecastReason' => {
          'type'=>'CodeableConcept',
          'path'=>'Recommendation.forecastReason',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
        ...
        'dateCriterion' => {
          'type'=>'ImmunizationRecommendation::Recommendation::DateCriterion',
          'path'=>'Recommendation.dateCriterion',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
        ...
        'description' => {
          'type'=>'string',
          'path'=>'Recommendation.description',
          'min'=>0,
          'max'=>1
        },
        ##
        ...
        'doseNumberPositiveInt' => {
          'type'=>'PositiveInt',
          'path'=>'Recommendation.doseNumber[x]',
          'min'=>0,
          'max'=>1
        },
        ##
        ...
        'seriesDosesPositiveInt' => {
          'type'=>'PositiveInt',
          'path'=>'Recommendation.seriesDoses[x]',
          'min'=>0,
          'max'=>1
        },
        ##
        ...
        'supportingImmunization' => {
          ...
          'type'=>'Reference',
          'path'=>'Recommendation.supportingImmunization',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
        ...
        'supportingPatientInformation' => {
          ...
          'type'=>'Reference',
          'path'=>'Recommendation.supportingPatientInformation',
          'min'=>0,
          'max'=>Float::INFINITY
        }
      }
      ...
      class DateCriterion < FHIR::Model
        ...
        METADATA = {
          ...
          'modifierExtension' => {
            'type'=>'Extension',
            'path'=>'DateCriterion.modifierExtension',
            'min'=>0,
            'max'=>Float::INFINITY
          },
          ##
      ...
      # Past immunizations supporting recommendation
      # Immunization event history and/or evaluation that supports the status and recommendation.
      attr_accessor :supportingImmunization         # 0-* [ Reference(http://hl7.org/fhir/StructureDefinition/Immunization|http://hl7.org/fhir/StructureDefinition/ImmunizationEvaluation) ]
      ##
      # Patient observations supporting recommendation
      # Patient Information that supports the status and recommendation.  This includes patient observations, adverse reactions and allergy/intolerance information.
      attr_accessor :supportingPatientInformation   # 0-* [ Reference(http://hl7.org/fhir/StructureDefinition/Resource) ]
    end
    ##
    # Logical id of this artifact
    # The logical id of the resource, as used in the URL for the resource. Once assigned, this value never changes.
