...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ChargeItemPerformer>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ChargeItem>))]
  public class ChargeItem : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WritePropertyName("unitPriceComponent");
        UnitPriceComponent.SerializeJson(writer, options);
      }

      if (TotalPriceComponent != null)
      {
        writer.WritePropertyName("totalPriceComponent");
        TotalPriceComponent.SerializeJson(writer, options);
      }

      if (OverrideReason != null)
      {
        writer.WritePropertyName("overrideReason");
        OverrideReason.SerializeJson(writer, options);
      }
      ...
      if ((Service != null) && (Service.Count != 0))
      {
        ...
        foreach (CodeableReference valService in Service)
        {
      ...
      if ((Product != null) && (Product.Count != 0))
      {
        ...
        foreach (CodeableReference valProduct in Product)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "costCenter":
          CostCenter = new fhirCsR5.Models.Reference();
        ...
        case "_definitionCanonical":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Element obj_DefinitionCanonical = new fhirCsR5.Models.Element();
        ...
        case "_definitionUri":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Element obj_DefinitionUri = new fhirCsR5.Models.Element();
        ...
        case "_enteredDate":
          _EnteredDate = new fhirCsR5.Models.Element();
        ...
        case "overrideReason":
          OverrideReason = new fhirCsR5.Models.CodeableConcept();
          OverrideReason.DeserializeJson(ref reader, options);
          break;
        ...
        case "performer":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.ChargeItemPerformer objPerformer = new fhirCsR5.Models.ChargeItemPerformer();
        ...
        case "performingOrganization":
          PerformingOrganization = new fhirCsR5.Models.Reference();
        ...
        case "product":
          ...
          Product = new List<CodeableReference>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.CodeableReference objProduct = new fhirCsR5.Models.CodeableReference();
        ...
        case "requestingOrganization":
          RequestingOrganization = new fhirCsR5.Models.Reference();
        ...
        case "service":
          ...
          Service = new List<CodeableReference>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.CodeableReference objService = new fhirCsR5.Models.CodeableReference();
        ...
        case "totalPriceComponent":
          TotalPriceComponent = new fhirCsR5.Models.MonetaryComponent();
          TotalPriceComponent.DeserializeJson(ref reader, options);
          break;

        case "unitPriceComponent":
          UnitPriceComponent = new fhirCsR5.Models.MonetaryComponent();
          UnitPriceComponent.DeserializeJson(ref reader, options);
          break;
