...
namespace fhirCsR3.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<Annotation>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "authorReference":
          AuthorReference = new fhirCsR3.Models.Reference();
        ...
        case "_authorString":
          _AuthorString = new fhirCsR3.Models.Element();
