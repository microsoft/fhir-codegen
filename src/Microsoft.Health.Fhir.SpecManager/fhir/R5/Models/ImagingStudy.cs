...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ImagingStudyProcedure>))]
  public class ImagingStudyProcedure : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ImagingStudySeriesPerformer>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ImagingStudySeriesInstance>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ImagingStudySeries>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "instance":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.ImagingStudySeriesInstance objInstance = new fhirCsR5.Models.ImagingStudySeriesInstance();
        ...
        case "laterality":
          Laterality = new fhirCsR5.Models.Coding();
          Laterality.DeserializeJson(ref reader, options);
          break;

        case "modality":
          Modality = new fhirCsR5.Models.Coding();
        ...
        case "performer":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.ImagingStudySeriesPerformer objPerformer = new fhirCsR5.Models.ImagingStudySeriesPerformer();
        ...
        case "_started":
          _Started = new fhirCsR5.Models.Element();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ImagingStudy>))]
  public class ImagingStudy : DomainResource,  IFhirJsonSerializable {
    ...
    /// The procedure or code from which this ImagingStudy was part of.
    /// </summary>
    public List<ImagingStudyProcedure> Procedure { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((Procedure != null) && (Procedure.Count != 0))
      {
        ...
        foreach (ImagingStudyProcedure valProcedure in Procedure)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "modality":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Coding objModality = new fhirCsR5.Models.Coding();
        ...
        case "procedure":
          ...
          Procedure = new List<ImagingStudyProcedure>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.ImagingStudyProcedure objProcedure = new fhirCsR5.Models.ImagingStudyProcedure();
        ...
        case "series":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.ImagingStudySeries objSeries = new fhirCsR5.Models.ImagingStudySeries();
