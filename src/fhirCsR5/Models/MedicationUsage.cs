...
namespace fhirCsR5.Models
{
  ...
  public class MedicationUsage : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((RelatedClinicalInformation != null) && (RelatedClinicalInformation.Count != 0))
      {
        writer.WritePropertyName("relatedClinicalInformation");
        writer.WriteStartArray();

        foreach (Reference valRelatedClinicalInformation in RelatedClinicalInformation)
        {
          valRelatedClinicalInformation.SerializeJson(writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "relatedClinicalInformation":
          ...
          RelatedClinicalInformation = new List<Reference>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Reference objRelatedClinicalInformation = new fhirCsR5.Models.Reference();
            objRelatedClinicalInformation.DeserializeJson(ref reader, options);
            RelatedClinicalInformation.Add(objRelatedClinicalInformation);
          ...
          if (RelatedClinicalInformation.Count == 0)
          {
            RelatedClinicalInformation = null;
          }
