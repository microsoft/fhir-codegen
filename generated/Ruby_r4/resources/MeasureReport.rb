module FHIR
  ...
  class MeasureReport < FHIR::Model
    ...
    METADATA = {
      ...
      'status' => {
        'valid_codes'=>{
          'http://hl7.org/fhir/measure-report-status'=>[ 'complete', 'pending', 'error' ]
        },
        'type'=>'code',
        'path'=>'MeasureReport.status',
        'min'=>1,
        'max'=>1,
        'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/measure-report-status'}
      },
      ##
      ...
      'type' => {
        'valid_codes'=>{
          'http://hl7.org/fhir/measure-report-type'=>[ 'individual', 'subject-list', 'summary', 'data-collection' ]
        },
        'type'=>'code',
        'path'=>'MeasureReport.type',
        'min'=>1,
        'max'=>1,
        'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/measure-report-type'}
      },
      ##
      # What measure was calculated
      # A reference to the Measure that was calculated to produce this report.
      'measure' => {
        'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Measure'],
        'type'=>'canonical',
      ...
      'subject' => {
        'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Patient', 'http://hl7.org/fhir/StructureDefinition/Practitioner', 'http://hl7.org/fhir/StructureDefinition/PractitionerRole', 'http://hl7.org/fhir/StructureDefinition/Location', 'http://hl7.org/fhir/StructureDefinition/Device', 'http://hl7.org/fhir/StructureDefinition/RelatedPerson', 'http://hl7.org/fhir/StructureDefinition/Group'],
        'type'=>'Reference',
      ...
      'reporter' => {
        'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Practitioner', 'http://hl7.org/fhir/StructureDefinition/PractitionerRole', 'http://hl7.org/fhir/StructureDefinition/Location', 'http://hl7.org/fhir/StructureDefinition/Organization'],
        'type'=>'Reference',
    ...
    class Group < FHIR::Model
      ...
      METADATA = {
        ...
        'population' => {
          'type'=>'MeasureReport::Group::Population',
        ...
        'stratifier' => {
          'type'=>'MeasureReport::Group::Stratifier',
      ...
      class Population < FHIR::Model
        ...
        METADATA = {
          ...
          'subjectResults' => {
            'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/List'],
            'type'=>'Reference',
            'path'=>'Population.subjectResults',
            'min'=>0,
            'max'=>1
          }
        }
        ...
        # For subject-list reports, the subject results in this population
        # This element refers to a List of subject level MeasureReport resources, one for each subject in this population.
        attr_accessor :subjectResults                 # 0-1 Reference(http://hl7.org/fhir/StructureDefinition/List)
      end
      ...
      class Stratifier < FHIR::Model
        ...
        METADATA = {
          ...
          'stratum' => {
            'type'=>'MeasureReport::Group::Stratifier::Stratum',
            'path'=>'Stratifier.stratum',
            'min'=>0,
            'max'=>Float::INFINITY
          }
        }
        ...
        class Stratum < FHIR::Model
          ...
          METADATA = {
            ...
            'modifierExtension' => {
              'type'=>'Extension',
              'path'=>'Stratum.modifierExtension',
              'min'=>0,
              'max'=>Float::INFINITY
            },
            ##
            ...
            'component' => {
              'type'=>'MeasureReport::Group::Stratifier::Stratum::Component',
            ...
            'population' => {
              'type'=>'MeasureReport::Group::Stratifier::Stratum::Population',
              'path'=>'Stratum.population',
              'min'=>0,
              'max'=>Float::INFINITY
            },
            ##
    ...
    # What measure was calculated
    # A reference to the Measure that was calculated to produce this report.
    attr_accessor :measure                        # 1-1 canonical(http://hl7.org/fhir/StructureDefinition/Measure)
    ##
    # What individual(s) the report is for
    # Optional subject identifying the individual or individuals the report is for.
    attr_accessor :subject                        # 0-1 Reference(http://hl7.org/fhir/StructureDefinition/Patient|http://hl7.org/fhir/StructureDefinition/Practitioner|http://hl7.org/fhir/StructureDefinition/PractitionerRole|http://hl7.org/fhir/StructureDefinition/Location|http://hl7.org/fhir/StructureDefinition/Device|http://hl7.org/fhir/StructureDefinition/RelatedPerson|http://hl7.org/fhir/StructureDefinition/Group)
    ##
    # When the report was generated
    # The date this measure report was generated.
    ...
    # Who is reporting the data
    # The individual, location, or organization that is reporting the data.
    attr_accessor :reporter                       # 0-1 Reference(http://hl7.org/fhir/StructureDefinition/Practitioner|http://hl7.org/fhir/StructureDefinition/PractitionerRole|http://hl7.org/fhir/StructureDefinition/Location|http://hl7.org/fhir/StructureDefinition/Organization)
    ##
    # What period the report covers
    # The reporting period for which the report was calculated.
    ...
    # What data was used to calculate the measure score
    # A reference to a Bundle containing the Resources that were used in the calculation of this measure.
    attr_accessor :evaluatedResource              # 0-* [ Reference(http://hl7.org/fhir/StructureDefinition/Resource) ]
