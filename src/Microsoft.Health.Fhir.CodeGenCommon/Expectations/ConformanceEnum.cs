// <copyright file="WithObsEnum.cs" company="Microsoft Corporation">
...
public record class ConformanceEnum<T> : ConformanceAnnotatedBase, ICloneable, IComparable<ConformanceVal<T>>, IComparable<T>, IEqualityComparer<ConformanceVal<T>>
    where T : Enum
{
    /// <summary>Initializes a new instance of the <see cref="ConformanceEnum{T}"/>class.</summary>
    public ConformanceEnum() : base() { }

    /// <summary>Initializes a new instance of the <see cref="ConformanceEnum{T}"/>class.</summary>
    /// <param name="other">The other.</param>
    [SetsRequiredMembers]
    protected ConformanceEnum(ConformanceEnum<T> other)
        : base(other)
    {
        Value = other.Value;
