    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "schedule":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Timing objSchedule = new fhirCsR5.Models.Timing();
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_additiveProductName":
          _AdditiveProductName = new fhirCsR5.Models.Element();
          _AdditiveProductName.DeserializeJson(ref reader, options);
          break;

        case "additiveType":
          AdditiveType = new fhirCsR5.Models.CodeableConcept();
        ...
        case "baseFormulaType":
          BaseFormulaType = new fhirCsR5.Models.CodeableConcept();
