...
public class RelatedArtifact_43_50 : ICrossVersionProcessor<RelatedArtifact>, ICrossVersionExtractor<RelatedArtifact>
{
	private Converter_43_50 _converter;
	internal RelatedArtifact_43_50(Converter_43_50 converter)
	{
	...
	public void Process(ISourceNode node, RelatedArtifact current)
	{
		switch (node.Name)
		{
			...
			case "_resource":
				_converter._element.Process(node, current.ResourceElement);
				break;
