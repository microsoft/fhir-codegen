...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<BundleLink>))]
  public class BundleLink : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_relation":
          _Relation = new fhirCsR4B.Models.Element();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<BundleEntrySearch>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<BundleEntryRequest>))]
  public class BundleEntryRequest : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_ifMatch":
          _IfMatch = new fhirCsR4B.Models.Element();
        ...
        case "_ifModifiedSince":
          _IfModifiedSince = new fhirCsR4B.Models.Element();
        ...
        case "_ifNoneExist":
          _IfNoneExist = new fhirCsR4B.Models.Element();
        ...
        case "_ifNoneMatch":
          _IfNoneMatch = new fhirCsR4B.Models.Element();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<BundleEntryResponse>))]
  public class BundleEntryResponse : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (Outcome != null)
      {
        ...
        JsonSerializer.Serialize<fhirCsR4B.Models.Resource>(writer, (fhirCsR4B.Models.Resource)Outcome, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_etag":
          _Etag = new fhirCsR4B.Models.Element();
        ...
        case "_location":
          _Location = new fhirCsR4B.Models.Element();
          _Location.DeserializeJson(ref reader, options);
          break;

        case "outcome":
          Outcome = JsonSerializer.Deserialize<fhirCsR4B.Models.Resource>(ref reader, options);
          break;
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<BundleEntry>))]
  public class BundleEntry : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_fullUrl":
          _FullUrl = new fhirCsR4B.Models.Element();
        ...
        case "link":
          ...
          {
            fhirCsR4B.Models.BundleLink objLink = new fhirCsR4B.Models.BundleLink();
        ...
        case "request":
          Request = new fhirCsR4B.Models.BundleEntryRequest();
        ...
        case "response":
          Response = new fhirCsR4B.Models.BundleEntryResponse();
          Response.DeserializeJson(ref reader, options);
          break;

        case "search":
          Search = new fhirCsR4B.Models.BundleEntrySearch();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<Bundle>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "entry":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.BundleEntry objEntry = new fhirCsR4B.Models.BundleEntry();
        ...
        case "signature":
          Signature = new fhirCsR4B.Models.Signature();
