  ...
  public class RiskEvidenceSynthesisRiskEstimatePrecisionEstimate : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (_Level != null)
      {
        ...
        _Level.SerializeJson(ref writer, options);
      }
      ...
      if (_From != null)
      {
        ...
        _From.SerializeJson(ref writer, options);
      }
      ...
      if (_To != null)
      {
        ...
        _To.SerializeJson(ref writer, options);
      }
  ...
  public class RiskEvidenceSynthesisRiskEstimate : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((PrecisionEstimate != null) && (PrecisionEstimate.Count != 0))
      {
        ...
        {
          valPrecisionEstimate.SerializeJson(ref writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "precisionEstimate":
          ...
          {
            Fhir.R4.Models.RiskEvidenceSynthesisRiskEstimatePrecisionEstimate objPrecisionEstimate = new Fhir.R4.Models.RiskEvidenceSynthesisRiskEstimatePrecisionEstimate();
  ...
  public class RiskEvidenceSynthesisCertaintyCertaintySubcomponent : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((Rating != null) && (Rating.Count != 0))
      {
        ...
        {
          valRating.SerializeJson(ref writer, options, true);
        }
  ...
  public class RiskEvidenceSynthesisCertainty : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((CertaintySubcomponent != null) && (CertaintySubcomponent.Count != 0))
      {
        ...
        {
          valCertaintySubcomponent.SerializeJson(ref writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "certaintySubcomponent":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.RiskEvidenceSynthesisCertaintyCertaintySubcomponent objCertaintySubcomponent = new Fhir.R4.Models.RiskEvidenceSynthesisCertaintyCertaintySubcomponent();
  ...
  public class RiskEvidenceSynthesis : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (SynthesisType != null)
      {
        ...
        SynthesisType.SerializeJson(ref writer, options);
      }

      if (StudyType != null)
      {
        writer.WritePropertyName("studyType");
        StudyType.SerializeJson(ref writer, options);
      }

      writer.WritePropertyName("population");
      Population.SerializeJson(ref writer, options);

      if (Exposure != null)
      {
        writer.WritePropertyName("exposure");
        Exposure.SerializeJson(ref writer, options);
      }
      ...
      if (SampleSize != null)
      {
        ...
        SampleSize.SerializeJson(ref writer, options);
      }

      if (RiskEstimate != null)
      {
        writer.WritePropertyName("riskEstimate");
        RiskEstimate.SerializeJson(ref writer, options);
      }
      ...
      if ((Certainty != null) && (Certainty.Count != 0))
      {
        ...
        {
          valCertainty.SerializeJson(ref writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "certainty":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.RiskEvidenceSynthesisCertainty objCertainty = new Fhir.R4.Models.RiskEvidenceSynthesisCertainty();
        ...
        case "riskEstimate":
          RiskEstimate = new Fhir.R4.Models.RiskEvidenceSynthesisRiskEstimate();
          RiskEstimate.DeserializeJson(ref reader, options);
          break;

        case "sampleSize":
          SampleSize = new Fhir.R4.Models.RiskEvidenceSynthesisSampleSize();
