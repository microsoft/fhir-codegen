...
namespace fhirCsR5.Models
{
  ...
  public class SubscriptionTopicCanFilterBy : BackboneElement,  IFhirJsonSerializable {
    ...
    /// <summary>
    /// Extension container element for FilterDefinition
    /// </summary>
    public Element _FilterDefinition { get; set; }
    /// <summary>
    /// Chained parameters are allowed (like "patient.gender") - but can not use colons or modifiers.
    /// </summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WriteString("filterDefinition", (string)FilterDefinition!);
      }

      if (_FilterDefinition != null)
      {
        writer.WritePropertyName("_filterDefinition");
        _FilterDefinition.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "filterDefinition":
          FilterDefinition = reader.GetString();
          break;

        case "_filterDefinition":
          _FilterDefinition = new fhirCsR5.Models.Element();
          _FilterDefinition.DeserializeJson(ref reader, options);
          break;
