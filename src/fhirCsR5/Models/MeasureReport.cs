...
namespace fhirCsR5.Models
{
  ...
  public class MeasureReport : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (InputParameters != null)
      {
        ...
        InputParameters.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "inputParameters":
          InputParameters = new fhirCsR5.Models.Reference();
          InputParameters.DeserializeJson(ref reader, options);
          break;
  ...
  public static class MeasureReportTypeCodes {
    ...
    public const string DATA_EXCHANGE = "data-exchange";
    public static HashSet<string> Values = new HashSet<string>() {
      "individual",
      "subject-list",
      "summary",
