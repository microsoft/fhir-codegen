    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "causality":
          ...
          {
            Fhir.R4.Models.AdverseEventSuspectEntityCausality objCausality = new Fhir.R4.Models.AdverseEventSuspectEntityCausality();
        ...
        case "instance":
          Instance = new Fhir.R4.Models.Reference();
