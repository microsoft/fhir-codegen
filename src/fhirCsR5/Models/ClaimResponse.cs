...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ClaimResponseAddItemBodySite>))]
  public class ClaimResponseAddItemBodySite : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  public class ClaimResponseAddItem : BackboneElement,  IFhirJsonSerializable {
    ...
    /// Physical location where the service is performed or applies.
    /// </summary>
    public List<ClaimResponseAddItemBodySite> BodySite { get; set; }
    /// <summary>
    /// The element is used to indicate the current state of the adjudication overall for the claim resource, for example: the request has been held (pended) for adjudication processing, for manual review or other reasons; that it has been processed and will be paid, or the outstanding paid, as submitted (approved); that no amount will be paid (denied); or that some amount between zero and the submitted amoutn will be paid (partial).
    /// </summary>
    public CodeableConcept Decision { get; set; }
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((BodySite != null) && (BodySite.Count != 0))
      {
        ...
        foreach (ClaimResponseAddItemBodySite valBodySite in BodySite)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "bodySite":
          ...
          BodySite = new List<ClaimResponseAddItemBodySite>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.ClaimResponseAddItemBodySite objBodySite = new fhirCsR5.Models.ClaimResponseAddItemBodySite();
