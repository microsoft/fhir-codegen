...
namespace fhirCsR4.ValueSets
{
  ...
  public static class VerificationresultStatusCodes
  {
    ...
    /// </summary>
    public const string LiteralVerificationresultStatusAttested = "http://hl7.org/fhir/CodeSystem/status#attested";
    ...
    /// </summary>
    public const string LiteralVerificationresultStatusInProcess = "http://hl7.org/fhir/CodeSystem/status#in-process";
    ...
    /// </summary>
    public const string LiteralVerificationresultStatusRequiresRevalidation = "http://hl7.org/fhir/CodeSystem/status#req-revalid";
    ...
    /// </summary>
    public const string LiteralVerificationresultStatusReValidationFailed = "http://hl7.org/fhir/CodeSystem/status#reval-fail";
    ...
    /// </summary>
    public const string LiteralVerificationresultStatusValidationFailed = "http://hl7.org/fhir/CodeSystem/status#val-fail";
    ...
    /// </summary>
    public const string LiteralVerificationresultStatusValidated = "http://hl7.org/fhir/CodeSystem/status#validated";
    ...
    public static Dictionary<string, Coding> Values = new Dictionary<string, Coding>() {
      ...
      { "http://hl7.org/fhir/CodeSystem/status#in-process", InProcess }, 
      { "req-revalid", RequiresRevalidation }, 
      { "http://hl7.org/fhir/CodeSystem/status#req-revalid", RequiresRevalidation }, 
      { "reval-fail", ReValidationFailed }, 
      { "http://hl7.org/fhir/CodeSystem/status#reval-fail", ReValidationFailed }, 
      { "val-fail", ValidationFailed }, 
      { "http://hl7.org/fhir/CodeSystem/status#val-fail", ValidationFailed }, 
      { "validated", Validated }, 
