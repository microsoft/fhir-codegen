...
namespace fhirCsR5.Models
{
  ...
  public class SubscriptionFilterBy : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WriteString("modifier", (string)Modifier!);
      }

      if (_Modifier != null)
      {
        writer.WritePropertyName("_modifier");
        _Modifier.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "modifier":
          Modifier = reader.GetString();
          break;

        case "_modifier":
          _Modifier = new fhirCsR5.Models.Element();
          _Modifier.DeserializeJson(ref reader, options);
          break;
  ...
  /// <summary>
  /// Code Values for the Subscription.filterBy.modifier field
  /// </summary>
  public static class SubscriptionFilterByModifierCodes {
