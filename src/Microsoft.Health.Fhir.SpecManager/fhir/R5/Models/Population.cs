...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<Population>))]
  public class Population : BackboneType,  IFhirJsonSerializable {
    /// <summary>
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "ageCodeableConcept":
          AgeCodeableConcept = new fhirCsR5.Models.CodeableConcept();
          AgeCodeableConcept.DeserializeJson(ref reader, options);
          break;

        case "gender":
          Gender = new fhirCsR5.Models.CodeableConcept();
          Gender.DeserializeJson(ref reader, options);
          break;

        case "physiologicalCondition":
          PhysiologicalCondition = new fhirCsR5.Models.CodeableConcept();
          PhysiologicalCondition.DeserializeJson(ref reader, options);
          break;

        case "race":
          Race = new fhirCsR5.Models.CodeableConcept();
