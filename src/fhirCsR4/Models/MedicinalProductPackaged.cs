...
namespace fhirCsR4.Models
{
  ...
  /// Batch numbering.
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<MedicinalProductPackagedBatchIdentifier>))]
  public class MedicinalProductPackagedBatchIdentifier : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (ImmediatePackaging != null)
      {
        ...
        ImmediatePackaging.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "immediatePackaging":
          ImmediatePackaging = new fhirCsR4.Models.Identifier();
          ImmediatePackaging.DeserializeJson(ref reader, options);
          break;

        case "outerPackaging":
          OuterPackaging = new fhirCsR4.Models.Identifier();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<MedicinalProductPackagedPackageItem>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<MedicinalProductPackaged>))]
  public class MedicinalProductPackaged : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((BatchIdentifier != null) && (BatchIdentifier.Count != 0))
      {
        ...
        {
          valBatchIdentifier.SerializeJson(writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "batchIdentifier":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4.Models.MedicinalProductPackagedBatchIdentifier objBatchIdentifier = new fhirCsR4.Models.MedicinalProductPackagedBatchIdentifier();
