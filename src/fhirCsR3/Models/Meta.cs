...
namespace fhirCsR3.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<Meta>))]
  public class Meta : Element,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_lastUpdated":
          _LastUpdated = new fhirCsR3.Models.Element();
        ...
        case "security":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.Coding objSecurity = new fhirCsR3.Models.Coding();
        ...
        case "_versionId":
          _VersionId = new fhirCsR3.Models.Element();
