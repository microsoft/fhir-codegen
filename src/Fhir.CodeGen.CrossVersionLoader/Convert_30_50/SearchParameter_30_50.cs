...
public class SearchParameter_30_50 : ICrossVersionProcessor<SearchParameter>, ICrossVersionExtractor<SearchParameter>
{
	private Converter_30_50 _converter;
	internal SearchParameter_30_50(Converter_30_50 converter)
	{
	...
	public void Process(ISourceNode node, SearchParameter current)
	{
		switch (node.Name)
		{
			...
			case "component":
				current.Component.Add(Extract30SearchParameterComponentComponent(node));
				break;
	...
	private SearchParameter.ComponentComponent Extract30SearchParameterComponentComponent(ISourceNode parent)
	{
