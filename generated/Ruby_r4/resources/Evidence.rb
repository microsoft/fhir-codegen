module FHIR
  ...
  class Evidence < FHIR::Model
    ...
    # What population?
    # A reference to a EvidenceVariable resource that defines the population for the research.
    attr_accessor :exposureBackground             # 1-1 Reference(http://hl7.org/fhir/StructureDefinition/EvidenceVariable)
    ##
    # What exposure?
    # A reference to a EvidenceVariable resource that defines the exposure for the research.
    attr_accessor :exposureVariant                # 0-* [ Reference(http://hl7.org/fhir/StructureDefinition/EvidenceVariable) ]
    ##
    # What outcome?
    # A reference to a EvidenceVariable resomece that defines the outcome for the research.
    attr_accessor :outcome                        # 0-* [ Reference(http://hl7.org/fhir/StructureDefinition/EvidenceVariable) ]
