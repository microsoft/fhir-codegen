...
namespace fhirCsR4.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<MedicinalProductContraindicationOtherTherapy>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<MedicinalProductContraindication>))]
  public class MedicinalProductContraindication : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "disease":
          Disease = new fhirCsR4.Models.CodeableConcept();
        ...
        case "otherTherapy":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4.Models.MedicinalProductContraindicationOtherTherapy objOtherTherapy = new fhirCsR4.Models.MedicinalProductContraindicationOtherTherapy();
        ...
        case "therapeuticIndication":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4.Models.Reference objTherapeuticIndication = new fhirCsR4.Models.Reference();
