...
{
    private string _actorTypeLiteral = string.Empty;
    ...
    protected FhirActor(FhirActor other)
        : base(other)
    {
        ActorTypeLiteral = other.ActorTypeLiteral;
    ...
    public required string ActorTypeLiteral
    {
        get => _actorTypeLiteral;
        init
        {
            _actorTypeLiteral = value;
            _actorType = _actorTypeLiteral.ToEnum<ActorTypeCodes>() ?? ActorTypeCodes.Person;
        }
    }
