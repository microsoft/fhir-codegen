  ...
  public class TerminologyCapabilitiesCodeSystemVersion : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_compositional":
          _Compositional = new fhirCsR4.Models.Element();
        ...
        case "_isDefault":
          _IsDefault = new fhirCsR4.Models.Element();
  ...
  public class TerminologyCapabilitiesCodeSystem : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_subsumption":
          _Subsumption = new fhirCsR4.Models.Element();
  ...
  public class TerminologyCapabilitiesExpansion : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_hierarchical":
          _Hierarchical = new fhirCsR4.Models.Element();
        ...
        case "_incomplete":
          _Incomplete = new fhirCsR4.Models.Element();
        ...
        case "_paging":
          _Paging = new fhirCsR4.Models.Element();
  ...
  public class TerminologyCapabilitiesValidateCode : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_translations":
          _Translations = new fhirCsR4.Models.Element();
  ...
  public class TerminologyCapabilitiesTranslation : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_needsMap":
          _NeedsMap = new fhirCsR4.Models.Element();
  ...
  public class TerminologyCapabilitiesClosure : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_translation":
          _Translation = new fhirCsR4.Models.Element();
