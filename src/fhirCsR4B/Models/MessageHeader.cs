...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<MessageHeaderDestination>))]
  public class MessageHeaderDestination : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "receiver":
          Receiver = new fhirCsR4B.Models.Reference();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<MessageHeaderSource>))]
  public class MessageHeaderSource : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "contact":
          Contact = new fhirCsR4B.Models.ContactPoint();
        ...
        case "_software":
          _Software = new fhirCsR4B.Models.Element();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<MessageHeaderResponse>))]
  public class MessageHeaderResponse : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "details":
          Details = new fhirCsR4B.Models.Reference();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<MessageHeader>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "destination":
          ...
          {
            fhirCsR4B.Models.MessageHeaderDestination objDestination = new fhirCsR4B.Models.MessageHeaderDestination();
        ...
        case "eventCoding":
          EventCoding = new fhirCsR4B.Models.Coding();
        ...
        case "_eventUri":
          _EventUri = new fhirCsR4B.Models.Element();
        ...
        case "response":
          Response = new fhirCsR4B.Models.MessageHeaderResponse();
        ...
        case "source":
          Source = new fhirCsR4B.Models.MessageHeaderSource();
