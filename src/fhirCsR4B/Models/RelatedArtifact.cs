...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<RelatedArtifact>))]
  public class RelatedArtifact : Element,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_citation":
          _Citation = new fhirCsR4B.Models.Element();
        ...
        case "document":
          Document = new fhirCsR4B.Models.Attachment();
