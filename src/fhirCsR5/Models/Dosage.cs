...
namespace fhirCsR5.Models
{
  ...
  public class Dosage : BackboneType,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((AsNeededFor != null) && (AsNeededFor.Count != 0))
      {
        writer.WritePropertyName("asNeededFor");
        writer.WriteStartArray();

        foreach (CodeableConcept valAsNeededFor in AsNeededFor)
        {
          valAsNeededFor.SerializeJson(writer, options, true);
        }
      ...
      if ((MaxDosePerPeriod != null) && (MaxDosePerPeriod.Count != 0))
      {
        writer.WritePropertyName("maxDosePerPeriod");
        writer.WriteStartArray();

        foreach (Ratio valMaxDosePerPeriod in MaxDosePerPeriod)
        {
          valMaxDosePerPeriod.SerializeJson(writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "asNeededFor":
          ...
          AsNeededFor = new List<CodeableConcept>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.CodeableConcept objAsNeededFor = new fhirCsR5.Models.CodeableConcept();
            objAsNeededFor.DeserializeJson(ref reader, options);
            AsNeededFor.Add(objAsNeededFor);
        ...
        case "maxDosePerPeriod":
          ...
          MaxDosePerPeriod = new List<Ratio>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Ratio objMaxDosePerPeriod = new fhirCsR5.Models.Ratio();
            objMaxDosePerPeriod.DeserializeJson(ref reader, options);
            MaxDosePerPeriod.Add(objMaxDosePerPeriod);
