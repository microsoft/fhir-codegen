...
namespace fhirCsR3.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<TimingRepeat>))]
  public class TimingRepeat : Element,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "boundsDuration":
          BoundsDuration = new fhirCsR3.Models.Duration();
          BoundsDuration.DeserializeJson(ref reader, options);
          break;

        case "boundsRange":
          BoundsRange = new fhirCsR3.Models.Range();
          BoundsRange.DeserializeJson(ref reader, options);
          break;

        case "boundsPeriod":
          BoundsPeriod = new fhirCsR3.Models.Period();
        ...
        case "_dayOfWeek":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.Element obj_DayOfWeek = new fhirCsR3.Models.Element();
        ...
        case "_duration":
          _Duration = new fhirCsR3.Models.Element();
        ...
        case "_durationMax":
          _DurationMax = new fhirCsR3.Models.Element();
        ...
        case "_durationUnit":
          _DurationUnit = new fhirCsR3.Models.Element();
        ...
        case "_period":
          _Period = new fhirCsR3.Models.Element();
        ...
        case "_periodMax":
          _PeriodMax = new fhirCsR3.Models.Element();
        ...
        case "_periodUnit":
          _PeriodUnit = new fhirCsR3.Models.Element();
        ...
        case "_timeOfDay":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.Element obj_TimeOfDay = new fhirCsR3.Models.Element();
        ...
        case "_when":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.Element obj_When = new fhirCsR3.Models.Element();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<Timing>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_event":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.Element obj_Event = new fhirCsR3.Models.Element();
        ...
        case "repeat":
          Repeat = new fhirCsR3.Models.TimingRepeat();
