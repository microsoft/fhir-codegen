...
namespace fhirCsR5.Models
{
  ...
  public class ClinicalImpression : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WritePropertyName("changePattern");
        ChangePattern.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "changePattern":
          ChangePattern = new fhirCsR5.Models.CodeableConcept();
          ChangePattern.DeserializeJson(ref reader, options);
          break;
