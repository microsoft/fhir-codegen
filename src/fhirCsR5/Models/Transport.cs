...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<TransportRestriction>))]
  public class TransportRestriction : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<TransportInput>))]
  public class TransportInput : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<TransportOutput>))]
  public class TransportOutput : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<Transport>))]
  public class Transport : DomainResource,  IFhirJsonSerializable {
    /// <summary>
    /// Resource Type Name
    /// </summary>
    ...
    /// <summary>
    /// Extension container element for CompletionTime
    /// </summary>
    public Element _CompletionTime { get; set; }
    /// <summary>
    ...
    /// Additional information that may be needed in the execution of the transport.
    /// </summary>
    public List<TransportInput> Input { get; set; }
    /// <summary>
    ...
    /// Outputs produced by the Transport.
    /// </summary>
    public List<TransportOutput> Output { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WriteString("completionTime", (string)CompletionTime!);
      }

      if (_CompletionTime != null)
      {
        writer.WritePropertyName("_completionTime");
        _CompletionTime.SerializeJson(writer, options);
      }
      ...
      if ((Input != null) && (Input.Count != 0))
      {
        ...
        foreach (TransportInput valInput in Input)
        {
      ...
      if ((Output != null) && (Output.Count != 0))
      {
        ...
        foreach (TransportOutput valOutput in Output)
        {
      ...
      {
        writer.WritePropertyName("requestedLocation");
        RequestedLocation.SerializeJson(writer, options);
      }

      if (CurrentLocation != null)
      {
        writer.WritePropertyName("currentLocation");
        CurrentLocation.SerializeJson(writer, options);
      }

      if (History != null)
      {
        writer.WritePropertyName("history");
        History.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "completionTime":
          CompletionTime = reader.GetString();
          break;

        case "_completionTime":
          _CompletionTime = new fhirCsR5.Models.Element();
          _CompletionTime.DeserializeJson(ref reader, options);
          break;

        case "currentLocation":
          CurrentLocation = new fhirCsR5.Models.Reference();
          CurrentLocation.DeserializeJson(ref reader, options);
          break;
        ...
        case "history":
          History = new fhirCsR5.Models.Reference();
          History.DeserializeJson(ref reader, options);
          break;
        ...
        case "input":
          ...
          Input = new List<TransportInput>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.TransportInput objInput = new fhirCsR5.Models.TransportInput();
        ...
        case "output":
          ...
          Output = new List<TransportOutput>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.TransportOutput objOutput = new fhirCsR5.Models.TransportOutput();
        ...
        case "requestedLocation":
          RequestedLocation = new fhirCsR5.Models.Reference();
          RequestedLocation.DeserializeJson(ref reader, options);
          break;
        ...
        case "restriction":
          Restriction = new fhirCsR5.Models.TransportRestriction();
  ...
  /// <summary>
  /// Code Values for the Transport.intent field
  /// </summary>
  public static class TransportIntentCodes {
  ...
  /// <summary>
  /// Code Values for the Transport.priority field
  /// </summary>
  public static class TransportPriorityCodes {
  ...
  /// <summary>
  /// Code Values for the Transport.status field
  /// </summary>
