...
namespace fhirCsR3.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<Slot>))]
  public class Slot : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_overbooked":
          _Overbooked = new fhirCsR3.Models.Element();
          _Overbooked.DeserializeJson(ref reader, options);
          break;

        case "schedule":
          Schedule = new fhirCsR3.Models.Reference();
