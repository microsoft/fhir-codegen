...
namespace Fhir.R4.Models
{
  ...
  public class TestReportSetupAction : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "assert":
          Assert = new Fhir.R4.Models.TestReportSetupActionAssert();
          Assert.DeserializeJson(ref reader, options);
          break;

        case "operation":
          Operation = new Fhir.R4.Models.TestReportSetupActionOperation();
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "action":
          ...
          {
            Fhir.R4.Models.TestReportSetupAction objAction = new Fhir.R4.Models.TestReportSetupAction();
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "action":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.TestReportTestAction objAction = new Fhir.R4.Models.TestReportTestAction();
            objAction.DeserializeJson(ref reader, options);
            Action.Add(objAction);
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "action":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.TestReportTeardownAction objAction = new Fhir.R4.Models.TestReportTeardownAction();
            objAction.DeserializeJson(ref reader, options);
            Action.Add(objAction);
