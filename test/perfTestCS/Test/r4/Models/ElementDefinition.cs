  ...
  public class ElementDefinition : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (_DefaultValueBase64Binary != null)
      {
        ...
        _DefaultValueBase64Binary.SerializeJson(writer, options);
      }
      ...
      if (_FixedBase64Binary != null)
      {
        ...
        _FixedBase64Binary.SerializeJson(writer, options);
      }
      ...
      if (_PatternBase64Binary != null)
      {
        ...
        _PatternBase64Binary.SerializeJson(writer, options);
      }
