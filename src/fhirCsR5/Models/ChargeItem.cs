    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_factorOverride":
          _FactorOverride = new fhirCsR5.Models.Element();
        ...
        case "_overrideReason":
          _OverrideReason = new fhirCsR5.Models.Element();
        ...
        case "priceOverride":
          PriceOverride = new fhirCsR5.Models.Money();
        ...
        case "service":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Reference objService = new fhirCsR5.Models.Reference();
