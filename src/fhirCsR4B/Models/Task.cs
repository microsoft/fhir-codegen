...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<TaskRestriction>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<TaskInput>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<TaskOutput>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<Task>))]
  public class Task : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "businessStatus":
          BusinessStatus = new fhirCsR4B.Models.CodeableConcept();
        ...
        case "executionPeriod":
          ExecutionPeriod = new fhirCsR4B.Models.Period();
        ...
        case "for":
          For = new fhirCsR4B.Models.Reference();
        ...
        case "input":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.TaskInput objInput = new fhirCsR4B.Models.TaskInput();
        ...
        case "_instantiatesCanonical":
          _InstantiatesCanonical = new fhirCsR4B.Models.Element();
        ...
        case "_lastModified":
          _LastModified = new fhirCsR4B.Models.Element();
        ...
        case "output":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.TaskOutput objOutput = new fhirCsR4B.Models.TaskOutput();
        ...
        case "reasonCode":
          ReasonCode = new fhirCsR4B.Models.CodeableConcept();
          ReasonCode.DeserializeJson(ref reader, options);
          break;

        case "reasonReference":
          ReasonReference = new fhirCsR4B.Models.Reference();
        ...
        case "restriction":
          Restriction = new fhirCsR4B.Models.TaskRestriction();
