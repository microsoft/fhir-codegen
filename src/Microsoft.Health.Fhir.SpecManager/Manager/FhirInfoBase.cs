// <copyright file="FhirInfoBase.cs" company="Microsoft Corporation">
...
/// <summary>A base class for FHIR information.</summary>
public abstract class FhirInfoBase : IFhirInfo
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="FhirInfoBase"/> class.
    /// </summary>
    public FhirInfoBase()
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="FhirInfoBase"/> class. Require major version
    /// (release #) to validate it is supported.
    /// </summary>
    /// <param name="source"> Source for the.</param>
    /// <param name="options">Options for controlling the operation.</param>
    public FhirInfoBase(FhirInfoBase source, PackageCopyOptions options)
        : this()
    {
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    public enum SearchMagicParameter
    {
    ...
    /// <returns>True if it succeeds, false if it fails.</returns>
    public virtual bool ShouldProcessResource(string resourceName)
    {
        return true;
    }
    ...
    /// <param name="resourceName">Name of the resource.</param>
    /// <returns>True if it succeeds, false if it fails.</returns>
    public virtual bool ShouldIgnoreResource(string resourceName)
    {
        return false;
    }
    ...
    public virtual object ParseResource(string json)
    {
    ...
    public virtual void ProcessResource(object resource)
    {
        throw new NotImplementedException();
    }
    ...
    /// <returns>True if it succeeds, false if it fails.</returns>
    public virtual bool ConverterHasIssues(out int errorCount, out int warningCount)
    {
        errorCount = -1;
        warningCount = -1;
        return false;
    ...
    public virtual void DisplayConverterIssues()
    {
    }
