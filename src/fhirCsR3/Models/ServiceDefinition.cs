...
namespace fhirCsR3.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<ServiceDefinition>))]
  public class ServiceDefinition : DomainResource,  IFhirJsonSerializable {
    /// <summary>
    /// Resource Type Name
    /// </summary>
    public override string ResourceType => "ServiceDefinition";
    /// <summary>
    ...
    /// </summary>
    public Reference OperationDefinition { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WritePropertyName("operationDefinition");
        OperationDefinition.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "operationDefinition":
          OperationDefinition = new fhirCsR3.Models.Reference();
          OperationDefinition.DeserializeJson(ref reader, options);
          break;
        ...
        case "trigger":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.TriggerDefinition objTrigger = new fhirCsR3.Models.TriggerDefinition();
  ...
  /// <summary>
  /// Code Values for the ServiceDefinition.status field
  /// </summary>
  public static class ServiceDefinitionStatusCodes {
