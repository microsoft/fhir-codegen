...
namespace fhirCsR3.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<SupplyDeliverySuppliedItem>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<SupplyDelivery>))]
  public class SupplyDelivery : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "suppliedItem":
          SuppliedItem = new fhirCsR3.Models.SupplyDeliverySuppliedItem();
          SuppliedItem.DeserializeJson(ref reader, options);
          break;

        case "supplier":
          Supplier = new fhirCsR3.Models.Reference();
