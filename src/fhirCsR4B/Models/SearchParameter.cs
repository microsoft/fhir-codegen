...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<SearchParameterComponent>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<SearchParameter>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_base":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Element obj_Base = new fhirCsR4B.Models.Element();
        ...
        case "_chain":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Element obj_Chain = new fhirCsR4B.Models.Element();
        ...
        case "_comparator":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Element obj_Comparator = new fhirCsR4B.Models.Element();
        ...
        case "component":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.SearchParameterComponent objComponent = new fhirCsR4B.Models.SearchParameterComponent();
        ...
        case "_derivedFrom":
          _DerivedFrom = new fhirCsR4B.Models.Element();
        ...
        case "_multipleAnd":
          _MultipleAnd = new fhirCsR4B.Models.Element();
        ...
        case "_multipleOr":
          _MultipleOr = new fhirCsR4B.Models.Element();
        ...
        case "_target":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.Element obj_Target = new fhirCsR4B.Models.Element();
        ...
        case "_xpathUsage":
          _XpathUsage = new fhirCsR4B.Models.Element();
