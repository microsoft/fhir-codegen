  ...
  public class ServiceRequest : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(ref Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((LocationCode != null) && (LocationCode.Count != 0))
      {
        ...
        {
          valLocationCode.SerializeJson(ref writer, options, true);
        }
      ...
      if ((LocationReference != null) && (LocationReference.Count != 0))
      {
        ...
        {
          valLocationReference.SerializeJson(ref writer, options, true);
        }
      ...
      if ((OrderDetail != null) && (OrderDetail.Count != 0))
      {
        ...
        {
          valOrderDetail.SerializeJson(ref writer, options, true);
        }
      ...
      if (PerformerType != null)
      {
        ...
        PerformerType.SerializeJson(ref writer, options);
      }
      ...
      if (QuantityQuantity != null)
      {
        ...
        QuantityQuantity.SerializeJson(ref writer, options);
      }

      if (QuantityRatio != null)
      {
        writer.WritePropertyName("quantityRatio");
        QuantityRatio.SerializeJson(ref writer, options);
      }

      if (QuantityRange != null)
      {
        writer.WritePropertyName("quantityRange");
        QuantityRange.SerializeJson(ref writer, options);
      }
      ...
      if ((Replaces != null) && (Replaces.Count != 0))
      {
        ...
        {
          valReplaces.SerializeJson(ref writer, options, true);
        }
      ...
      if (Requisition != null)
      {
        ...
        Requisition.SerializeJson(ref writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "asNeededCodeableConcept":
          AsNeededCodeableConcept = new Fhir.R4.Models.CodeableConcept();
        ...
        case "locationCode":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.CodeableConcept objLocationCode = new Fhir.R4.Models.CodeableConcept();
        ...
        case "locationReference":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.Reference objLocationReference = new Fhir.R4.Models.Reference();
        ...
        case "orderDetail":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.CodeableConcept objOrderDetail = new Fhir.R4.Models.CodeableConcept();
        ...
        case "quantityQuantity":
          QuantityQuantity = new Fhir.R4.Models.Quantity();
          QuantityQuantity.DeserializeJson(ref reader, options);
          break;

        case "quantityRatio":
          QuantityRatio = new Fhir.R4.Models.Ratio();
          QuantityRatio.DeserializeJson(ref reader, options);
          break;

        case "quantityRange":
          QuantityRange = new Fhir.R4.Models.Range();
        ...
        case "requisition":
          Requisition = new Fhir.R4.Models.Identifier();
