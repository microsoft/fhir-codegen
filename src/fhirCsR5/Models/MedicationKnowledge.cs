...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<MedicationKnowledgeStorageGuidelineEnvironmentalSetting>))]
  public class MedicationKnowledgeStorageGuidelineEnvironmentalSetting : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<MedicationKnowledgeStorageGuideline>))]
  public class MedicationKnowledgeStorageGuideline : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
    /// Describes a setting/value on the environment for the adequate storage of the medication and other substances.  Environment settings may involve temperature, humidity, or exposure to light.
    /// </summary>
    public List<MedicationKnowledgeStorageGuidelineEnvironmentalSetting> EnvironmentalSetting { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WritePropertyName("stabilityDuration");
        StabilityDuration.SerializeJson(writer, options);
      }

      if ((EnvironmentalSetting != null) && (EnvironmentalSetting.Count != 0))
      {
        writer.WritePropertyName("environmentalSetting");
        writer.WriteStartArray();

        foreach (MedicationKnowledgeStorageGuidelineEnvironmentalSetting valEnvironmentalSetting in EnvironmentalSetting)
        {
          valEnvironmentalSetting.SerializeJson(writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "environmentalSetting":
          ...
          EnvironmentalSetting = new List<MedicationKnowledgeStorageGuidelineEnvironmentalSetting>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.MedicationKnowledgeStorageGuidelineEnvironmentalSetting objEnvironmentalSetting = new fhirCsR5.Models.MedicationKnowledgeStorageGuidelineEnvironmentalSetting();
            objEnvironmentalSetting.DeserializeJson(ref reader, options);
            EnvironmentalSetting.Add(objEnvironmentalSetting);
          ...
          if (EnvironmentalSetting.Count == 0)
          {
            EnvironmentalSetting = null;
          }
        ...
        case "stabilityDuration":
          StabilityDuration = new fhirCsR5.Models.Duration();
          StabilityDuration.DeserializeJson(ref reader, options);
          break;
  ...
  public class MedicationKnowledge : DomainResource,  IFhirJsonSerializable {
    ...
    /// Information on how the medication should be stored, for example, refrigeration temperatures and length of stability at a given temperature.
    /// </summary>
    public List<MedicationKnowledgeStorageGuideline> StorageGuideline { get; set; }
    /// <summary>
    /// Serialize to a JSON object
    /// </summary>
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((StorageGuideline != null) && (StorageGuideline.Count != 0))
      {
        writer.WritePropertyName("storageGuideline");
        writer.WriteStartArray();

        foreach (MedicationKnowledgeStorageGuideline valStorageGuideline in StorageGuideline)
        {
          valStorageGuideline.SerializeJson(writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "storageGuideline":
          ...
          StorageGuideline = new List<MedicationKnowledgeStorageGuideline>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.MedicationKnowledgeStorageGuideline objStorageGuideline = new fhirCsR5.Models.MedicationKnowledgeStorageGuideline();
            objStorageGuideline.DeserializeJson(ref reader, options);
            StorageGuideline.Add(objStorageGuideline);
          ...
          if (StorageGuideline.Count == 0)
          {
            StorageGuideline = null;
          }
