...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ListEntry>))]
  public class ListEntry : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_deleted":
          _Deleted = new fhirCsR5.Models.Element();
          _Deleted.DeserializeJson(ref reader, options);
          break;

        case "flag":
          Flag = new fhirCsR5.Models.CodeableConcept();
          Flag.DeserializeJson(ref reader, options);
          break;

        case "item":
          Item = new fhirCsR5.Models.Reference();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<List>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "entry":
          ...
          {
            fhirCsR5.Models.ListEntry objEntry = new fhirCsR5.Models.ListEntry();
