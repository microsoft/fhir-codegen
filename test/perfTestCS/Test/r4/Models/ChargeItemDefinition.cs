    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "applicability":
          ...
          {
            Fhir.R4.Models.ChargeItemDefinitionApplicability objApplicability = new Fhir.R4.Models.ChargeItemDefinitionApplicability();
        ...
        case "priceComponent":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.ChargeItemDefinitionPropertyGroupPriceComponent objPriceComponent = new Fhir.R4.Models.ChargeItemDefinitionPropertyGroupPriceComponent();
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_derivedFromUri":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.Element obj_DerivedFromUri = new Fhir.R4.Models.Element();
        ...
        case "instance":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.Reference objInstance = new Fhir.R4.Models.Reference();
        ...
        case "_partOf":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.Element obj_PartOf = new Fhir.R4.Models.Element();
        ...
        case "propertyGroup":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.ChargeItemDefinitionPropertyGroup objPropertyGroup = new Fhir.R4.Models.ChargeItemDefinitionPropertyGroup();
