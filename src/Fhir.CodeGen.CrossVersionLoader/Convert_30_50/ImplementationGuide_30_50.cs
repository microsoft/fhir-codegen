...
public class ImplementationGuide_30_50 : ICrossVersionProcessor<ImplementationGuide>, ICrossVersionExtractor<ImplementationGuide>
{
	private Converter_30_50 _converter;
	internal ImplementationGuide_30_50(Converter_30_50 converter)
	{
	...
	public void Process(ISourceNode node, ImplementationGuide current)
	{
		switch (node.Name)
		{
			...
			case "global":
				current.Global.Add(Extract30ImplementationGuideGlobalComponent(node));
				break;
	...
	private ImplementationGuide.DependencyComponent Extract30ImplementationGuideDependencyComponent(ISourceNode parent)
	{
	...
	*/
	...
	private ImplementationGuide.PackageComponent Extract30ImplementationGuidePackageComponent(ISourceNode parent)
	{
		...
		foreach (ISourceNode node in parent.Children())
		{
			switch (node.Name)
			{
				...
				case "resource":
					current.Resource.Add(Extract30ImplementationGuideResourceComponent(node));
					break;
	...
	private ImplementationGuide.ResourceComponent Extract30ImplementationGuideResourceComponent(ISourceNode parent)
	{
	...
	*/
	...
	private ImplementationGuide.GlobalComponent Extract30ImplementationGuideGlobalComponent(ISourceNode parent)
	{
	...
	private ImplementationGuide.PageComponent Extract30ImplementationGuidePageComponent(ISourceNode parent)
	{
		...
		foreach (ISourceNode node in parent.Children())
		{
			switch (node.Name)
			{
				...
				case "page":
					current.Page.Add(Extract30ImplementationGuidePageComponent(node));
					break;
