...
namespace fhirCsR5.Models
{
  ...
  /// <summary>
  /// Code Values for the TerminologyCapabilities.codeSystem.content field
  /// </summary>
  public static class TerminologyCapabilitiesCodeSystemContentCodes {
  ...
  public static class TerminologyCapabilitiesCodeSearchCodes {
    public const string IN_COMPOSE = "in-compose";
    public const string IN_EXPANSION = "in-expansion";
    public const string IN_COMPOSE_OR_EXPANSION = "in-compose-or-expansion";
    public static HashSet<string> Values = new HashSet<string>() {
      "in-compose",
      "in-expansion",
