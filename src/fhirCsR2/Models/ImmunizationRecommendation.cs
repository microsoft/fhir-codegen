...
namespace fhirCsR2.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR2.Serialization.JsonStreamComponentConverter<ImmunizationRecommendationRecommendationDateCriterion>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR2.Serialization.JsonStreamComponentConverter<ImmunizationRecommendationRecommendationProtocol>))]
  public class ImmunizationRecommendationRecommendationProtocol : BackboneElement,  IFhirJsonSerializable {
    ...
    /// <summary>
    /// Extension container element for DoseSequence
    /// </summary>
    public Element _DoseSequence { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WriteNumber("doseSequence", (int)DoseSequence!);
      }

      if (_DoseSequence != null)
      {
        writer.WritePropertyName("_doseSequence");
        _DoseSequence.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "doseSequence":
          DoseSequence = reader.GetInt32();
          break;

        case "_doseSequence":
          _DoseSequence = new fhirCsR2.Models.Element();
          _DoseSequence.DeserializeJson(ref reader, options);
          break;
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR2.Serialization.JsonStreamComponentConverter<ImmunizationRecommendationRecommendation>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "dateCriterion":
          ...
          {
            fhirCsR2.Models.ImmunizationRecommendationRecommendationDateCriterion objDateCriterion = new fhirCsR2.Models.ImmunizationRecommendationRecommendationDateCriterion();
        ...
        case "forecastStatus":
          ForecastStatus = new fhirCsR2.Models.CodeableConcept();
          ForecastStatus.DeserializeJson(ref reader, options);
          break;

        case "protocol":
          Protocol = new fhirCsR2.Models.ImmunizationRecommendationRecommendationProtocol();
        ...
        case "supportingImmunization":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR2.Models.Reference objSupportingImmunization = new fhirCsR2.Models.Reference();
        ...
        case "supportingPatientInformation":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR2.Models.Reference objSupportingPatientInformation = new fhirCsR2.Models.Reference();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR2.Serialization.JsonStreamComponentConverter<ImmunizationRecommendation>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "recommendation":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR2.Models.ImmunizationRecommendationRecommendation objRecommendation = new fhirCsR2.Models.ImmunizationRecommendationRecommendation();
