...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<EncounterAdmission>))]
  public class EncounterAdmission : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  public class Encounter : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (Admission != null)
      {
        ...
        Admission.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "admission":
          Admission = new fhirCsR5.Models.EncounterAdmission();
          Admission.DeserializeJson(ref reader, options);
          break;
