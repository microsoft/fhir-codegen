...
/// FHIR resource meta.
/// </summary>
public record class FhirMeta : FhirBase, ICloneable
{
    /// <summary>
    /// Initializes a new instance of the <see cref="FhirMeta"/> class.
    /// </summary>
    public FhirMeta() : base() { }
    ...
    [SetsRequiredMembers]
    protected FhirMeta(FhirMeta other)
        : base(other)
    {
