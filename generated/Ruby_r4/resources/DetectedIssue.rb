module FHIR
  ...
  class DetectedIssue < FHIR::Model
    ...
    METADATA = {
      ...
      'code' => {
        'valid_codes'=>{
          'http://terminology.hl7.org/CodeSystem/v3-ActCode'=>[ 'FOOD', 'TPROD', 'DRG', 'NHP', 'NONRX', 'PREVINEF', 'DACT', 'TIME', 'ALRTENDLATE', 'ALRTSTRTLATE', 'ENDLATE', 'STRTLATE', 'ALLDONE', 'FULFIL', 'NOTACTN', 'NOTEQUIV', 'NOTEQUIVGEN', 'NOTEQUIVTHER', 'TIMING', 'INTERVAL', 'MINFREQ', 'HELD', 'TOOLATE', 'TOOSOON', 'HISTORIC', 'PATPREF', 'PATPREFALT' ]
        },
        'type'=>'CodeableConcept',
        'path'=>'DetectedIssue.code',
        'min'=>0,
        'max'=>1,
        'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/detectedissue-category'}
      },
      ##
      # high | moderate | low
      ...
      'severity' => {
        'valid_codes'=>{
          'http://hl7.org/fhir/detectedissue-severity'=>[ 'high', 'moderate', 'low' ]
        },
        'type'=>'code',
        'path'=>'DetectedIssue.severity',
        'min'=>0,
        'max'=>1,
        'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/detectedissue-severity'}
      },
      ##
      # Associated patient
    ...
    class Mitigation < FHIR::Model
      ...
      METADATA = {
        ...
        'modifierExtension' => {
          'type'=>'Extension',
          'path'=>'Mitigation.modifierExtension',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
        ...
        'action' => {
          'valid_codes'=>{
            'http://terminology.hl7.org/CodeSystem/v3-ActCode'=>[ 'EMAUTH', '21', '1', '19', '2', '22', '23', '3', '4', '5', '6', '7', '14', '15', '16', '17', '18', '20', '8', '10', '11', '12', '13', '9' ]
          },
          'type'=>'CodeableConcept',
          'path'=>'Mitigation.action',
          'min'=>1,
          'max'=>1,
          'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/detectedissue-mitigation-action'}
        },
        ##
        # Date committed
    ...
    # The provider or device that identified the issue
    # Individual or device responsible for the issue being raised.  For example, a decision support application or a pharmacist conducting a medication review.
    attr_accessor :author                         # 0-1 Reference(http://hl7.org/fhir/StructureDefinition/Practitioner|http://hl7.org/fhir/StructureDefinition/PractitionerRole|http://hl7.org/fhir/StructureDefinition/Device)
    ##
    # Problem resource
    # Indicates the resource representing the current activity or proposed activity that is potentially problematic.
    # There's an implicit constraint on the number of implicated resources based on DetectedIssue.type; e.g. For drug-drug, there would be more than one.  For timing, there would typically only be one.
    attr_accessor :implicated                     # 0-* [ Reference(http://hl7.org/fhir/StructureDefinition/Resource) ]
    ##
    # Supporting evidence or manifestations that provide the basis for identifying the detected issue such as a GuidanceResponse or MeasureReport.
