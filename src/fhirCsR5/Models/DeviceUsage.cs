...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<DeviceUsageAdherence>))]
  public class DeviceUsageAdherence : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
    /// Type of adherence.
    /// </summary>
  ...
  public class DeviceUsage : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "adherence":
          Adherence = new fhirCsR5.Models.DeviceUsageAdherence();
