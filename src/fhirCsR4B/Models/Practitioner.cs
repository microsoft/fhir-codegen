...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<PractitionerQualification>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<Practitioner>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "qualification":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.PractitionerQualification objQualification = new fhirCsR4B.Models.PractitionerQualification();
