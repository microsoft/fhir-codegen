...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ChargeItemDefinitionApplicability>))]
  public class ChargeItemDefinitionApplicability : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (RelatedArtifact != null)
      {
        ...
        RelatedArtifact.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "relatedArtifact":
          RelatedArtifact = new fhirCsR5.Models.RelatedArtifact();
          RelatedArtifact.DeserializeJson(ref reader, options);
          break;
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ChargeItemDefinitionPropertyGroup>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "applicability":
          ...
          {
            fhirCsR5.Models.ChargeItemDefinitionApplicability objApplicability = new fhirCsR5.Models.ChargeItemDefinitionApplicability();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ChargeItemDefinition>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "instance":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Reference objInstance = new fhirCsR5.Models.Reference();
        ...
        case "_partOf":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Element obj_PartOf = new fhirCsR5.Models.Element();
        ...
        case "propertyGroup":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.ChargeItemDefinitionPropertyGroup objPropertyGroup = new fhirCsR5.Models.ChargeItemDefinitionPropertyGroup();
