  ...
  class SubstancePolymer < FHIR::Model
    ...
    class MonomerSet < FHIR::Model
      ...
      METADATA = {
        ...
        'modifierExtension' => {
          'type'=>'Extension',
          'path'=>'MonomerSet.modifierExtension',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
        ...
        # Todo.
        'startingMaterial' => {
          'type'=>'SubstancePolymer::MonomerSet::StartingMaterial',
          'path'=>'MonomerSet.startingMaterial',
          'min'=>0,
          'max'=>Float::INFINITY
        }
      }
      ...
      class StartingMaterial < FHIR::Model
        ...
        METADATA = {
          ...
          'extension' => {
            'type'=>'Extension',
            'path'=>'StartingMaterial.extension',
            'min'=>0,
            'max'=>Float::INFINITY
          },
          ##
          ...
          'modifierExtension' => {
            'type'=>'Extension',
            'path'=>'StartingMaterial.modifierExtension',
            'min'=>0,
            'max'=>Float::INFINITY
          },
          ##
          ...
          'material' => {
            'type'=>'CodeableConcept',
            'path'=>'StartingMaterial.material',
            'min'=>0,
            'max'=>1
          },
          ##
          ...
          'isDefining' => {
            'type'=>'boolean',
            'path'=>'StartingMaterial.isDefining',
            'min'=>0,
            'max'=>1
          },
          ##
    ...
    class Repeat < FHIR::Model
      ...
      METADATA = {
        ...
        'averageMolecularFormula' => {
          'type'=>'string',
          'path'=>'Repeat.averageMolecularFormula',
          'min'=>0,
          'max'=>1
        },
        ##
        ...
        'repeatUnitAmountType' => {
          'type'=>'CodeableConcept',
          'path'=>'Repeat.repeatUnitAmountType',
          'min'=>0,
          'max'=>1
        },
        ##
        # Todo.
        'repeatUnit' => {
          'type'=>'SubstancePolymer::Repeat::RepeatUnit',
          'path'=>'Repeat.repeatUnit',
          'min'=>0,
          'max'=>Float::INFINITY
        }
      }
      ...
      class RepeatUnit < FHIR::Model
        ...
        METADATA = {
          ...
          'modifierExtension' => {
            'type'=>'Extension',
            'path'=>'RepeatUnit.modifierExtension',
            'min'=>0,
            'max'=>Float::INFINITY
          },
          ##
          ...
          'orientationOfPolymerisation' => {
            'type'=>'CodeableConcept',
            'path'=>'RepeatUnit.orientationOfPolymerisation',
            'min'=>0,
            'max'=>1
          },
          ##
          ...
          'degreeOfPolymerisation' => {
            'type'=>'SubstancePolymer::Repeat::RepeatUnit::DegreeOfPolymerisation',
            'path'=>'RepeatUnit.degreeOfPolymerisation',
            'min'=>0,
            'max'=>Float::INFINITY
          },
          ##
          ...
          'structuralRepresentation' => {
            'type'=>'SubstancePolymer::Repeat::RepeatUnit::StructuralRepresentation',
            'path'=>'RepeatUnit.structuralRepresentation',
            'min'=>0,
            'max'=>Float::INFINITY
          }
        }
        ...
        class DegreeOfPolymerisation < FHIR::Model
          ...
          METADATA = {
            ...
            'id' => {
              'type'=>'string',
              'path'=>'DegreeOfPolymerisation.id',
              'min'=>0,
              'max'=>1
            },
            ##
            ...
            'extension' => {
              'type'=>'Extension',
              'path'=>'DegreeOfPolymerisation.extension',
              'min'=>0,
              'max'=>Float::INFINITY
            },
            ##
            ...
            'modifierExtension' => {
              'type'=>'Extension',
              'path'=>'DegreeOfPolymerisation.modifierExtension',
              'min'=>0,
              'max'=>Float::INFINITY
            },
            ##
            ...
            'degree' => {
              'type'=>'CodeableConcept',
              'path'=>'DegreeOfPolymerisation.degree',
              'min'=>0,
              'max'=>1
            },
            ##
            ...
            'amount' => {
              'type'=>'SubstanceAmount',
              'path'=>'DegreeOfPolymerisation.amount',
              'min'=>0,
              'max'=>1
            }
          }
        ...
        class StructuralRepresentation < FHIR::Model
          ...
          METADATA = {
            ...
            'id' => {
              'type'=>'string',
              'path'=>'StructuralRepresentation.id',
              'min'=>0,
              'max'=>1
            },
            ##
            ...
            'extension' => {
              'type'=>'Extension',
              'path'=>'StructuralRepresentation.extension',
              'min'=>0,
              'max'=>Float::INFINITY
            },
            ##
            ...
            'modifierExtension' => {
              'type'=>'Extension',
              'path'=>'StructuralRepresentation.modifierExtension',
              'min'=>0,
              'max'=>Float::INFINITY
            },
            ##
            ...
            'type' => {
              'type'=>'CodeableConcept',
              'path'=>'StructuralRepresentation.type',
              'min'=>0,
              'max'=>1
            },
            ##
            ...
            'representation' => {
              'type'=>'string',
              'path'=>'StructuralRepresentation.representation',
              'min'=>0,
              'max'=>1
            },
            ##
            ...
            'attachment' => {
              'type'=>'Attachment',
              'path'=>'StructuralRepresentation.attachment',
              'min'=>0,
              'max'=>1
            }
          }
