...
namespace fhirCsR2.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR2.Serialization.JsonStreamComponentConverter<SampledData>))]
  public class SampledData : Element,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_data":
          _Data = new fhirCsR2.Models.Element();
        ...
        case "_lowerLimit":
          _LowerLimit = new fhirCsR2.Models.Element();
          _LowerLimit.DeserializeJson(ref reader, options);
          break;

        case "origin":
          Origin = new fhirCsR2.Models.Quantity();
        ...
        case "_upperLimit":
          _UpperLimit = new fhirCsR2.Models.Element();
