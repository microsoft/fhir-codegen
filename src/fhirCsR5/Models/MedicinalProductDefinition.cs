...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<MedicinalProductDefinitionNamePart>))]
  public class MedicinalProductDefinitionNamePart : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<MedicinalProductDefinitionNameUsage>))]
  public class MedicinalProductDefinitionNameUsage : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  public class MedicinalProductDefinitionName : BackboneElement,  IFhirJsonSerializable {
    ...
    /// Coding words or phrases of the name.
    /// </summary>
    public List<MedicinalProductDefinitionNamePart> Part { get; set; }
    /// <summary>
    ...
    /// Country and jurisdiction where the name applies, and associated language.
    /// </summary>
    public List<MedicinalProductDefinitionNameUsage> Usage { get; set; }
    /// <summary>
    /// Serialize to a JSON object
    /// </summary>
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((Part != null) && (Part.Count != 0))
      {
        ...
        foreach (MedicinalProductDefinitionNamePart valPart in Part)
        {
      ...
      if ((Usage != null) && (Usage.Count != 0))
      {
        ...
        foreach (MedicinalProductDefinitionNameUsage valUsage in Usage)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "part":
          ...
          Part = new List<MedicinalProductDefinitionNamePart>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.MedicinalProductDefinitionNamePart objPart = new fhirCsR5.Models.MedicinalProductDefinitionNamePart();
        ...
        case "usage":
          ...
          Usage = new List<MedicinalProductDefinitionNameUsage>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.MedicinalProductDefinitionNameUsage objUsage = new fhirCsR5.Models.MedicinalProductDefinitionNameUsage();
  ...
  public class MedicinalProductDefinition : DomainResource,  IFhirJsonSerializable {
    ...
    /// </summary>
    public List<Reference> ComprisedOf { get; set; }
    /// <summary>
    /// A product specific contact, person (in a role), or an organization.
    /// </summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((ComprisedOf != null) && (ComprisedOf.Count != 0))
      {
        writer.WritePropertyName("comprisedOf");
        writer.WriteStartArray();

        foreach (Reference valComprisedOf in ComprisedOf)
        {
          valComprisedOf.SerializeJson(writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "comprisedOf":
          ...
          ComprisedOf = new List<Reference>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Reference objComprisedOf = new fhirCsR5.Models.Reference();
            objComprisedOf.DeserializeJson(ref reader, options);
            ComprisedOf.Add(objComprisedOf);
