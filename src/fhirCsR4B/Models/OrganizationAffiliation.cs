...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<OrganizationAffiliation>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "participatingOrganization":
          ParticipatingOrganization = new fhirCsR4B.Models.Reference();
