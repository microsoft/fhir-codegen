...
namespace fhirCsR3.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<HealthcareServiceAvailableTime>))]
  public class HealthcareServiceAvailableTime : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_allDay":
          _AllDay = new fhirCsR3.Models.Element();
        ...
        case "_availableEndTime":
          _AvailableEndTime = new fhirCsR3.Models.Element();
        ...
        case "_availableStartTime":
          _AvailableStartTime = new fhirCsR3.Models.Element();
        ...
        case "_daysOfWeek":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.Element obj_DaysOfWeek = new fhirCsR3.Models.Element();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<HealthcareServiceNotAvailable>))]
  public class HealthcareServiceNotAvailable : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "during":
          During = new fhirCsR3.Models.Period();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<HealthcareService>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_appointmentRequired":
          _AppointmentRequired = new fhirCsR3.Models.Element();
        ...
        case "_availabilityExceptions":
          _AvailabilityExceptions = new fhirCsR3.Models.Element();
        ...
        case "availableTime":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.HealthcareServiceAvailableTime objAvailableTime = new fhirCsR3.Models.HealthcareServiceAvailableTime();
        ...
        case "characteristic":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.CodeableConcept objCharacteristic = new fhirCsR3.Models.CodeableConcept();
        ...
        case "coverageArea":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.Reference objCoverageArea = new fhirCsR3.Models.Reference();
        ...
        case "eligibility":
          Eligibility = new fhirCsR3.Models.CodeableConcept();
        ...
        case "_eligibilityNote":
          _EligibilityNote = new fhirCsR3.Models.Element();
        ...
        case "_extraDetails":
          _ExtraDetails = new fhirCsR3.Models.Element();
        ...
        case "location":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.Reference objLocation = new fhirCsR3.Models.Reference();
        ...
        case "notAvailable":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.HealthcareServiceNotAvailable objNotAvailable = new fhirCsR3.Models.HealthcareServiceNotAvailable();
        ...
        case "_programName":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.Element obj_ProgramName = new fhirCsR3.Models.Element();
        ...
        case "providedBy":
          ProvidedBy = new fhirCsR3.Models.Reference();
        ...
        case "referralMethod":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.CodeableConcept objReferralMethod = new fhirCsR3.Models.CodeableConcept();
        ...
        case "serviceProvisionCode":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.CodeableConcept objServiceProvisionCode = new fhirCsR3.Models.CodeableConcept();
