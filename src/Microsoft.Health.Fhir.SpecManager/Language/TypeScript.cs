...
namespace Microsoft.Health.Fhir.SpecManager.Language
{
    ...
    public sealed class TypeScript : ILanguage
    {
            ...
            bool isResource)
        {
            ...
            {
                exportName = complex.NameForExport(NamingConvention.PascalCase);
            ...
            {
                exportName = complex.NameForExport(NamingConvention.PascalCase, true);
                _writer.WriteLineIndented($"export interface {exportName} {{");
            }
            else
            {
                exportName = complex.NameForExport(NamingConvention.PascalCase, true);
                string typeName = complex.TypeForExport(NamingConvention.PascalCase, _primitiveTypeMap, false);
