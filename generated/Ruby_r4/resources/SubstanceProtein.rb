    ...
    class Subunit < FHIR::Model
      ...
      METADATA = {
        ...
        'nTerminalModificationId' => {
          'type'=>'Identifier',
          'path'=>'Subunit.nTerminalModificationId',
          'min'=>0,
          'max'=>1
        },
        ##
        ...
        'nTerminalModification' => {
          'type'=>'string',
          'path'=>'Subunit.nTerminalModification',
          'min'=>0,
          'max'=>1
        },
        ##
        ...
        'cTerminalModificationId' => {
          'type'=>'Identifier',
          'path'=>'Subunit.cTerminalModificationId',
          'min'=>0,
          'max'=>1
        },
        ##
        ...
        'cTerminalModification' => {
          'type'=>'string',
          'path'=>'Subunit.cTerminalModification',
          'min'=>0,
          'max'=>1
        }
      }
