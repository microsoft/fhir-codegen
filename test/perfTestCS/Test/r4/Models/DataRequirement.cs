    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "codeFilter":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.DataRequirementCodeFilter objCodeFilter = new Fhir.R4.Models.DataRequirementCodeFilter();
        ...
        case "dateFilter":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.DataRequirementDateFilter objDateFilter = new Fhir.R4.Models.DataRequirementDateFilter();
        ...
        case "_mustSupport":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.Element obj_MustSupport = new Fhir.R4.Models.Element();
        ...
        case "sort":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            Fhir.R4.Models.DataRequirementSort objSort = new Fhir.R4.Models.DataRequirementSort();
