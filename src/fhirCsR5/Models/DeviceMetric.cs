...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<DeviceMetricCalibration>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<DeviceMetric>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "calibration":
          ...
          {
            fhirCsR5.Models.DeviceMetricCalibration objCalibration = new fhirCsR5.Models.DeviceMetricCalibration();
        ...
        case "measurementPeriod":
          MeasurementPeriod = new fhirCsR5.Models.Timing();
        ...
        case "_operationalStatus":
          _OperationalStatus = new fhirCsR5.Models.Element();
