...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<Endpoint>))]
  public class Endpoint : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((ConnectionType != null) && (ConnectionType.Count != 0))
      {
        ...
        foreach (CodeableConcept valConnectionType in ConnectionType)
        {
          valConnectionType.SerializeJson(writer, options, true);
        }
      ...
      if ((EnvironmentType != null) && (EnvironmentType.Count != 0))
      {
        writer.WritePropertyName("environmentType");
        writer.WriteStartArray();

        foreach (CodeableConcept valEnvironmentType in EnvironmentType)
        {
          valEnvironmentType.SerializeJson(writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "connectionType":
          ...
          {
            fhirCsR5.Models.CodeableConcept objConnectionType = new fhirCsR5.Models.CodeableConcept();
            objConnectionType.DeserializeJson(ref reader, options);
            ConnectionType.Add(objConnectionType);
        ...
        case "environmentType":
          ...
          EnvironmentType = new List<CodeableConcept>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.CodeableConcept objEnvironmentType = new fhirCsR5.Models.CodeableConcept();
            objEnvironmentType.DeserializeJson(ref reader, options);
            EnvironmentType.Add(objEnvironmentType);
        ...
        case "_payloadMimeType":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Element obj_PayloadMimeType = new fhirCsR5.Models.Element();
        ...
        case "payloadType":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.CodeableConcept objPayloadType = new fhirCsR5.Models.CodeableConcept();
