...
namespace fhirCsR5.Models
{
  ...
  public class ClinicalUseDefinitionContraindicationOtherTherapy : BackboneElement,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if (Treatment != null)
      {
        ...
        Treatment.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "treatment":
          Treatment = new fhirCsR5.Models.CodeableReference();
          Treatment.DeserializeJson(ref reader, options);
          break;
  ...
  public class ClinicalUseDefinitionIndication : BackboneElement,  IFhirJsonSerializable {
    ...
    /// <summary>
    /// Extension container element for DurationString
    /// </summary>
    public Element _DurationString { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WritePropertyName("durationRange");
        DurationRange.SerializeJson(writer, options);
      }

      if (!string.IsNullOrEmpty(DurationString))
      {
        writer.WriteString("durationString", (string)DurationString!);
      }

      if (_DurationString != null)
      {
        writer.WritePropertyName("_durationString");
        _DurationString.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "durationRange":
          DurationRange = new fhirCsR5.Models.Range();
          DurationRange.DeserializeJson(ref reader, options);
          break;

        case "durationString":
          DurationString = reader.GetString();
          break;

        case "_durationString":
          _DurationString = new fhirCsR5.Models.Element();
          _DurationString.DeserializeJson(ref reader, options);
          break;
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "management":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.CodeableConcept objManagement = new fhirCsR5.Models.CodeableConcept();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<ClinicalUseDefinitionWarning>))]
  ...
  public class ClinicalUseDefinition : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "warning":
          Warning = new fhirCsR5.Models.ClinicalUseDefinitionWarning();
