  ...
  class SubstanceReferenceInformation < FHIR::Model
    ...
    class GeneElement < FHIR::Model
      ...
      METADATA = {
        ...
        'modifierExtension' => {
          'type'=>'Extension',
          'path'=>'GeneElement.modifierExtension',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
    ...
    class Classification < FHIR::Model
      ...
      METADATA = {
        ...
        'modifierExtension' => {
          'type'=>'Extension',
          'path'=>'Classification.modifierExtension',
          'min'=>0,
          'max'=>Float::INFINITY
        },
        ##
