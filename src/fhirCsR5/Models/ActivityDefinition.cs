...
namespace fhirCsR5.Models
{
  ...
  public class ActivityDefinition : DomainResource,  IFhirJsonSerializable {
    ...
    /// </summary>
    public List<string> ObservationRequirement { get; set; }
    /// <summary>
    /// Extension container element for ObservationRequirement
    /// </summary>
    public List<Element> _ObservationRequirement { get; set; }
    /// <summary>
    /// Defines the observations that are expected to be produced by the action.
    /// </summary>
    public List<string> ObservationResultRequirement { get; set; }
    /// <summary>
    /// Extension container element for ObservationResultRequirement
    /// </summary>
    public List<Element> _ObservationResultRequirement { get; set; }
    /// <summary>
    /// Indicates who should participate in performing the action described.
    /// </summary>
    ...
    /// </summary>
    public List<string> SpecimenRequirement { get; set; }
    /// <summary>
    /// Extension container element for SpecimenRequirement
    /// </summary>
    public List<Element> _SpecimenRequirement { get; set; }
    /// <summary>
    /// Allows filtering of activity definitions that are appropriate for use versus not.
    /// </summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((SpecimenRequirement != null) && (SpecimenRequirement.Count != 0))
      {
        ...
        foreach (string valSpecimenRequirement in SpecimenRequirement)
        {
          writer.WriteStringValue(valSpecimenRequirement);
        }

        writer.WriteEndArray();
      }

      if ((_SpecimenRequirement != null) && (_SpecimenRequirement.Count != 0))
      {
        writer.WritePropertyName("_specimenRequirement");
        writer.WriteStartArray();

        foreach (Element val_SpecimenRequirement in _SpecimenRequirement)
        {
          val_SpecimenRequirement.SerializeJson(writer, options, true);
        }
      ...
      if ((ObservationRequirement != null) && (ObservationRequirement.Count != 0))
      {
        ...
        foreach (string valObservationRequirement in ObservationRequirement)
        {
          writer.WriteStringValue(valObservationRequirement);
        }

        writer.WriteEndArray();
      }

      if ((_ObservationRequirement != null) && (_ObservationRequirement.Count != 0))
      {
        writer.WritePropertyName("_observationRequirement");
        writer.WriteStartArray();

        foreach (Element val_ObservationRequirement in _ObservationRequirement)
        {
          val_ObservationRequirement.SerializeJson(writer, options, true);
        }
      ...
      if ((ObservationResultRequirement != null) && (ObservationResultRequirement.Count != 0))
      {
        ...
        foreach (string valObservationResultRequirement in ObservationResultRequirement)
        {
          writer.WriteStringValue(valObservationResultRequirement);
        }

        writer.WriteEndArray();
      }

      if ((_ObservationResultRequirement != null) && (_ObservationResultRequirement.Count != 0))
      {
        writer.WritePropertyName("_observationResultRequirement");
        writer.WriteStartArray();

        foreach (Element val_ObservationResultRequirement in _ObservationResultRequirement)
        {
          val_ObservationResultRequirement.SerializeJson(writer, options, true);
        }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "observationRequirement":
          ...
          ObservationRequirement = new List<string>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            ObservationRequirement.Add(reader.GetString());
        ...
        case "_observationRequirement":
          ...
          _ObservationRequirement = new List<Element>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Element obj_ObservationRequirement = new fhirCsR5.Models.Element();
            obj_ObservationRequirement.DeserializeJson(ref reader, options);
            _ObservationRequirement.Add(obj_ObservationRequirement);
          ...
          if (_ObservationRequirement.Count == 0)
          {
            _ObservationRequirement = null;
          }
        ...
        case "observationResultRequirement":
          ...
          ObservationResultRequirement = new List<string>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            ObservationResultRequirement.Add(reader.GetString());
        ...
        case "_observationResultRequirement":
          ...
          _ObservationResultRequirement = new List<Element>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Element obj_ObservationResultRequirement = new fhirCsR5.Models.Element();
            obj_ObservationResultRequirement.DeserializeJson(ref reader, options);
            _ObservationResultRequirement.Add(obj_ObservationResultRequirement);
          ...
          if (_ObservationResultRequirement.Count == 0)
          {
            _ObservationResultRequirement = null;
          }
        ...
        case "specimenRequirement":
          ...
          SpecimenRequirement = new List<string>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            SpecimenRequirement.Add(reader.GetString());
        ...
        case "_specimenRequirement":
          ...
          _SpecimenRequirement = new List<Element>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Element obj_SpecimenRequirement = new fhirCsR5.Models.Element();
            obj_SpecimenRequirement.DeserializeJson(ref reader, options);
            _SpecimenRequirement.Add(obj_SpecimenRequirement);
          ...
          if (_SpecimenRequirement.Count == 0)
          {
            _SpecimenRequirement = null;
          }
