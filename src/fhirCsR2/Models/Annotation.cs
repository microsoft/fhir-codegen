...
namespace fhirCsR2.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR2.Serialization.JsonStreamComponentConverter<Annotation>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "authorReference":
          AuthorReference = new fhirCsR2.Models.Reference();
        ...
        case "_authorString":
          _AuthorString = new fhirCsR2.Models.Element();
