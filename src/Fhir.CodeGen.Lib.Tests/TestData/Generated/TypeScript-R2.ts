// <auto-generated/>
// Contents of: (hl7.fhir.r2.core, 1.0.2)
...
export interface ElementDefinitionType extends Element {
   ...
   */
  aggregation?: ('contained'|'referenced')[] | undefined;
...
export interface Composition extends DomainResource {
   ...
   */
  confidentiality?: ('_Confidentiality'|'_ConfidentialityByAccessKind'|'_ConfidentialityByInfoType'|'_ConfidentialityModifiers') | undefined;
...
export interface ConceptMapElementTarget extends BackboneElement {
   ...
   */
  equivalence: ('equivalent'|'wider'|'subsumes'|'narrower'|'specializes'|'inexact'|'unmatched');
...
export interface DataElement extends DomainResource {
   ...
   */
  stringency?: ('comparable'|'flexible') | undefined;
...
export interface ImplementationGuidePage extends BackboneElement {
   ...
   */
  kind: ('page'|'example'|'list'|'include'|'directory'|'toc'|'resource');
  _kind?: Element | undefined;
  /**
...
export interface OrderResponse extends DomainResource {
   ...
   */
  orderStatus: ('pending'|'review'|'rejected'|'error'|'accepted'|'cancelled'|'aborted'|'completed');
