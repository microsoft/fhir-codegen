...
namespace fhirCsR5.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR5.Serialization.JsonStreamComponentConverter<DocumentReferenceContentProfile>))]
  public class DocumentReferenceContentProfile : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
    /// Code|uri|canonical.
    /// </summary>
  ...
  public class DocumentReferenceContent : BackboneElement,  IFhirJsonSerializable {
    ...
    /// For FHIR content, .profile should indicate the structureDefinition profile canonical URI(s) that the content complies with.
    /// </summary>
    public List<DocumentReferenceContentProfile> Profile { get; set; }
    /// <summary>
    /// Serialize to a JSON object
    /// </summary>
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((Profile != null) && (Profile.Count != 0))
      {
        ...
        foreach (DocumentReferenceContentProfile valProfile in Profile)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "profile":
          ...
          Profile = new List<DocumentReferenceContentProfile>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.DocumentReferenceContentProfile objProfile = new fhirCsR5.Models.DocumentReferenceContentProfile();
  ...
  public class DocumentReference : DomainResource,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((Context != null) && (Context.Count != 0))
      {
        ...
        foreach (Reference valContext in Context)
        {
      ...
      if ((Event != null) && (Event.Count != 0))
      {
        ...
        foreach (CodeableReference valEvent in Event)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "context":
          ...
          Context = new List<Reference>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.Reference objContext = new fhirCsR5.Models.Reference();
        ...
        case "event":
          ...
          Event = new List<CodeableReference>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR5.Models.CodeableReference objEvent = new fhirCsR5.Models.CodeableReference();
