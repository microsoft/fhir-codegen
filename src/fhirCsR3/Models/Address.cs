...
namespace fhirCsR3.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR3.Serialization.JsonStreamComponentConverter<Address>))]
  public class Address : Element,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "_city":
          _City = new fhirCsR3.Models.Element();
        ...
        case "_country":
          _Country = new fhirCsR3.Models.Element();
        ...
        case "_district":
          _District = new fhirCsR3.Models.Element();
        ...
        case "_line":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR3.Models.Element obj_Line = new fhirCsR3.Models.Element();
        ...
        case "_postalCode":
          _PostalCode = new fhirCsR3.Models.Element();
